...
| Runtime bridge live-auto | `entry_wait6579_score66_69_recovery_gate_v1`, `scale_in_bucket_runtime_policy_v1`, complete greenfield lifecycle bundle | discovery `live_auto_apply_ready`, Tier2 parsed, env mapping, runtime hook, post-apply attribution | 다음 PREOPEN | targeted live auto env 후보 |
