...
- `time-based-operations-runbook.md`: 장전, 장중, 장후, 23:05 EOD 데이터 갱신 cron 확인 절차.
...
- `time-based-operations-runbook.md`: 시간대별 cron, 산출물, 확인 절차, 운영 금지선. `20:10` postclose chain, `23:05` update_kospi 데이터 갱신 확인 절차를 포함한다.
