# Code Improvement Workorder - 2026-08-25
...
- pattern_lab_automation: `/home/ubuntu/KORStockScan/data/report/scalping_pattern_lab_automation/scalping_pattern_lab_automation_2026-08-25.json`
- swing_improvement_automation: `-`
- swing_pattern_lab_automation: `-`
- swing_strategy_discovery_ev: `-`
- swing_lifecycle_decision_matrix: `-`
- swing_lifecycle_bucket_discovery: `-`
- threshold_cycle_ev: `/home/ubuntu/KORStockScan/data/report/threshold_cycle_ev/threshold_cycle_ev_2026-08-25.json`
- lifecycle_decision_matrix: `/home/ubuntu/KORStockScan/data/report/lifecycle_decision_matrix/lifecycle_decision_matrix_2026-08-25.json`
- threshold_cycle_calibration: `/home/ubuntu/KORStockScan/data/report/threshold_cycle_calibration/threshold_cycle_calibration_2026-08-25_postclose.json`
- pipeline_event_verbosity: `/home/ubuntu/KORStockScan/data/report/pipeline_event_verbosity/pipeline_event_verbosity_2026-08-25.json`
- observation_source_quality_audit: `/home/ubuntu/KORStockScan/data/report/observation_source_quality_audit/observation_source_quality_audit_2026-08-25.json`
- ai_decision_action_outcome_calibration: `/home/ubuntu/KORStockScan/data/report/ai_decision_action_outcome_calibration/ai_decision_action_outcome_calibration_2026-08-25.json`
- codebase_performance_workorder: `-`
- pattern_lab_currentness_audit: `/home/ubuntu/KORStockScan/data/report/pattern_lab_currentness_audit/pattern_lab_currentness_audit_2026-08-25.json`
- pattern_lab_ai_review: `/home/ubuntu/KORStockScan/data/report/pattern_lab_ai_review/pattern_lab_ai_review_2026-08-25.json`
...
- lifecycle_holding_exit_bucket_source_order_count: `19`
...
- operator_workload_summary: `{'implementation_required_count': 0, 'existing_family_attribution_count': 63, 'visibility_only_count': 5, 'other_selected_count': 0, 'root_cause_open_count': 7, 'selected_total_count': 68, 'category_count_reconciled': True, 'runtime_effect_true_count': 0}`
- source_decision_counts: `{'attach_existing_family': 79, 'design_family_candidate': 3, 'reject': 1}`
- selected_decision_counts: `{'attach_existing_family': 68}`
- selected_route_counts: `{'existing_family': 63, 'source_quality_raw_row_exclusion_revalidated_closed': 1, 'ai_review_coverage_review': 1, 'positive_source_only_review': 1, 'source_dimension_rollup': 1, 'join_gap_enrichment': 1}`
- selected_implement_now_route_count: `0`
- selected_runtime_effect_false_count: `68`
...
- root_cause_closure_status_counts: `{'handoff_closed_root_cause_open': 7, 'implementation_done': 1, 'root_cause_closed': 55}`
...
- non_selected_decision_counts: `{'attach_existing_family': 11, 'design_family_candidate': 3, 'reject': 1}`
- non_selected_longstanding_non_implement_disposition_counts: `{'implemented_with_provenance': 10, 'review_required': 3}`
...
- evidence: `ai_confirmed_unique=82`, `budget_pass_unique=95`, `latency_pass_unique=49`, `submitted_unique=15`, `submitted_to_ai_pct=18.3`, `submitted_to_budget_pct=15.8`, `blocker:blocked_strength_momentum:below_window_buy_value=417`, `blocker:latency_block:latency_state_danger=368`, `blocker:blocked_overbought:-=284`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=132`, `upstream:wait65_79_ev_candidate:score_70.0=48`, `upstream:first_ai_wait:-=32`, `latency:latency_block:latency_state_danger=368`, `latency:latency_block:tp1_direct_recheck_expired=4`
- parity_contract: -
...
- implementation_provenance: `{"allowed_runtime_apply": false, "artifact_regeneration_required": false, "broker_order_submit_allowed": false, "forbidden_uses": ["intraday_threshold_mutation", "broker_guard_bypass", "provider_route_change", "bot_restart_trigger", "telegram_pre_submit_buy_alert"], "implementation_type": "source_only_report_provenance_handoff", "ldm_quote_freshness_attribution_present": true, "observation_axis_status": {"BROKER_RECEIPT": "no_current_signal", "BUDGET_PASS_COLLAPSE": "observed", "ECONOMIC_PARTICIPATION": "observed", "ENTRY_AI_AUTHORITY_REVALIDATION": "observed", "LATENCY_PRE_SUBMIT": "observed", "PRICE_REVALIDATION": "no_current_signal", "SIM_REAL_AUTHORITY": "observed", "SOURCE_TAXONOMY_LEAKAGE": "no_current_signal", "UPSTREAM_GATE": "observed"}, "observation_breakdown": {"allowed_runtime_apply": false, "axes": {"BROKER_RECEIPT": {"evidence": {"broker_submit_failure_unique": 0, "latency_pass_unique": 49, "order_bundle_submitted_unique": 15, "submitted_to_budget_unique_pct": 15.8}, "next_repair_action": "join post-submit broker receipt and fill provenance only when a broker submission or explicit submit failure exists", "observed_count": 0, "status": "no_current_signal"}, "BUDGET_PASS_COLLAPSE": {"evidence": {"ai_confirmed_unique": 82, "budget_ai_lineage": {"ai_attempt_result_unavailable_parent_not_expected_event_count": 12, "ai_trace_count": 346, "ai_trace_source_stage_counts": {"ai_confirmed": 308, "early_accel_strong_bundle_recheck_corrected": 18, "early_accel_strong_bundle_recheck_failed": 20}, "allowed_runtime_apply": false, "budget_or_block_event_count": 756, "exact_parent_trace_unresolved_event_count": 0, "lineage_contract_coverage_pct": 100.0, "lineage_contract_event_count": 756, "lineage_contract_missing_event_count": 0, "lineage_exact_trusted_count": 48, "lineage_field_present_count": 52, "lineage_join_coverage_denominator": "events_with_a_trusted_ai_result_expected; excludes_pre_ai_and_explicit_attempt_result_unavailable", "lineage_join_coverage_pct": 92.31, "lineage_join_eligible_event_count": 52, "lineage_joined_event_count": 48, "lineage_untrusted_or_stale_event_count": 4, "lineage_untrusted_or_stale_reason_counts": {"source_stale": 4}, "linked_budget_block_trace_count": 4, "linked_budget_pass_trace_count": 37, "linked_stage_counts": {"blocked_zero_qty": 4, "budget_pass": 44}, "parent_attempt_without_trusted_result_event_count": 12, "parent_trace_missing_when_expected_event_count": 0, "parent_trace_missing_without_attempt_event_count": 0, "pipeline_stage_order_contract": "latest_watching_ai_to_budget_precheck_to_final_authority_revalidation", "pre_ai_parent_not_expected_event_count": 692, "raw_ai_budget_census_is_causal": false, "raw_event_lineage_join_coverage_pct": 6.35, "runtime_effect": false, "status": "explicit_ai_trace_budget_block_observed"}, "budget_pass_unique": 95, "budget_to_ai_unique_pct": 115.9, "legacy_stage_census_gap": 0, "legacy_stage_census_gap_is_causal": false}, "next_repair_action": "treat pre-AI budget events as expected no-parent observations; repair only missing lineage contracts or stale/untrusted post-AI parents, and keep causal EV attribution limited to exact joins", "observed_count": 4, "status": "observed"}, "ECONOMIC_PARTICIPATION": {"evidence": {"allowed_runtime_apply": false, "bundle_count": 15, "by_venue": {"KRX": {"bundle_count": 15, "full_submitted_bundle_count": 0, "partial_residual_bundle_count": 0, "probe_only_bundle_count": 15, "requested_notional_krw": 1419350, "requested_qty": 15, "submitted_notional_krw": 1419350, "submitted_notional_to_requested_notional_pct": 100.0, "submitted_qty": 15, "submitted_qty_to_requested_qty_pct": 100.0}}, "decision_authority": "submit_drought_attribution_only", "forbidden_uses": ["broker_order_submit", "intraday_threshold_mutation", "quantity_cap_release", "live_auto_promotion", "bot_restart_trigger"], "full_submitted_bundle_count": 0, "metric_role": "funnel_count", "observed_bundle_count": 15, "partial_residual_bundle_count": 0, "primary_decision_metric": "submitted_notional_to_requested_notional_pct", "probe_only_bundle_count": 15, "requested_notional_krw": 1419350, "requested_qty": 15, "rows": [{"attempt_key": "attempt:SCANPROM-356860-1787617334799", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 34750, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "356860", "submitted_notional_krw": 34750, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-000720-1787617923295", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 115100, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "000720", "submitted_notional_krw": 115100, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-036930-1787619012873", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 165700, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "036930", "submitted_notional_krw": 165700, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-000720-1787621295037", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 116200, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "000720", "submitted_notional_krw": 116200, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-052690-1787621464704", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 99900, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "052690", "submitted_notional_krw": 99900, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-059090-1787623069394", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 18660, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "059090", "submitted_notional_krw": 18660, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-005380-1787623400167", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 415000, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "005380", "submitted_notional_krw": 415000, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-000720-1787627053982", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 118200, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "000720", "submitted_notional_krw": 118200, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-003350-1787627053982", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 13520, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "003350", "submitted_notional_krw": 13520, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-080580-1787634740297", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 18860, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "080580", "submitted_notional_krw": 18860, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-080580-1787635069926", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 19100, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "080580", "submitted_notional_krw": 19100, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-356860-1787635960118", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 38250, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "356860", "submitted_notional_krw": 38250, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-484810-1787636761044", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 15410, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "484810", "submitted_notional_krw": 15410, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-035420-1787636843102", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 220000, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "035420", "submitted_notional_krw": 220000, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "attempt:SCANPROM-225570-1787638202996", "bundle_state": "probe_only", "effective_venue": "KRX", "probe_submission_source": "single_share_order_bundle", "requested_notional_krw": 10700, "requested_qty": 1, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "225570", "submitted_notional_krw": 10700, "submitted_qty": 1, "venue_source_quality": "pass"}], "runtime_effect": false, "sample_floor": "1_explicit_venue_split_probe_or_bounded_single_share_order_bundle", "source_quality_blocked_bundle_count": 0, "source_quality_gate": "explicit_conflict_free_venue_and_positive_requested_submitted_qty_price", "source_quality_valid_bundle_count": 15, "submitted_notional_krw": 1419350, "submitted_notional_to_requested_notional_pct": 100.0, "submitted_qty": 15, "submitted_qty_to_requested_qty_pct": 100.0, "window_policy": "same_session_split_probe_or_bounded_single_share_lifecycle"}, "next_repair_action": "join venue-proven submitted probe receipts to fill and terminal outcomes; submission participation alone is not execution EV", "observed_count": 15, "status": "observed"}, "ENTRY_AI_AUTHORITY_REVALIDATION": {"evidence": {"entry_ai_authority_guard_events": 93, "entry_ai_authority_guard_top": [{"count": 55, "label": "pre_submit_entry_ai_authority_guard_block:fresh_ai_drop_real_buy_veto"}, {"count": 31, "label": "pre_submit_entry_ai_authority_guard_block:fresh_ai_wait_observation_only_probe_veto"}, {"count": 7, "label": "pre_submit_entry_ai_authority_guard_block:entry_ai_result_stale_or_untrusted"}], "entry_ai_authority_guard_unique": 40, "latency_pass_unique": 49, "order_bundle_submitted_unique": 15}, "next_repair_action": "join exact AI authority reason, executable BBO, and target/adverse first-hit outcomes before proposing a bounded one-share probe", "observed_count": 40, "status": "observed"}, "LATENCY_PRE_SUBMIT": {"evidence": {"latency_blocker_top": [{"count": 368, "label": "latency_block:latency_state_danger"}, {"count": 4, "label": "latency_block:tp1_direct_recheck_expired"}], "latency_root_cause_counts": {"observer_unhealthy": 2, "quote_freshness_input_snapshot_noop": 207, "quote_stale": 160, "spread_microstructure_guard": 372, "spread_or_slippage_guard": 249}, "quote_freshness_attribution": {"decision_authority": "submit_drought_quote_freshness_attribution_only", "forbidden_uses": ["broker_order_submit", "adm_ldm_training_input", "general_threshold_ev_input", "live_auto_promotion"], "latency_pass_recovered_count": 32, "latency_pass_recovered_downstream_counts": {"budget_pass_no_submit_event": 6, "entry_ai_authority_revalidation": 22, "order_bundle_submitted": 3, "upstream_block_after_latency_recovery": 1}, "latency_pass_recovered_downstream_stage_counts": {"blocked_vpw": 1, "budget_pass": 6, "order_bundle_submitted": 3, "pre_submit_entry_ai_authority_guard_block": 22}, "order_bundle_submitted_after_refresh_count": 3, "post_restart_window_policy": "event_provenance_only", "refresh_applied_count": 72, "refresh_attempted_count": 89, "refresh_block_subreason_counts": {"observer_quote_refresh_failed_invalid": 1, "ws_snapshot_refresh_failed_input_snapshot_fresh": 207, "ws_snapshot_refresh_failed_invalid": 1, "ws_snapshot_refresh_failed_stale": 2}, "refresh_subreason_counts": {"observer_quote_refresh_failed_invalid": 1, "ws_snapshot_refresh_failed_input_snapshot_fresh": 207, "ws_snapshot_refresh_failed_invalid": 1, "ws_snapshot_refresh_failed_stale": 2}, "runtime_effect": false, "still_latency_blocked_after_refresh_count": 44}, "unknown_latency_reason_count": 0, "unknown_latency_workorder_required": false}, "next_repair_action": "close unknown latency labels or route quote freshness gaps to LDM attribution", "observed_count": 372, "status": "observed"}, "PRICE_REVALIDATION": {"evidence": {"latency_pass_unique": 49, "order_bundle_submitted_unique": 15, "price_guard_events": 6, "price_guard_top": [{"count": 4, "label": "entry_ai_price_canary_fallback:skip_low_confidence"}, {"count": 1, "label": "entry_ai_price_canary_skip_order:orderbook_micro indicates bearish state with negative OFI and adverse regime"}, {"count": 1, "label": "entry_ai_price_canary_fallback:pre_submit_price_guard"}], "price_guard_unique": 6}, "next_repair_action": "join executable BBO and target/adverse first-hit outcomes to price revalidation blocks before proposing bounded exploration", "observed_count": 6, "status": "no_current_signal"}, "SIM_REAL_AUTHORITY": {"evidence": {"actual_order_submitted_authority": "not_granted_by_report", "broker_order_submit_allowed": false}, "next_repair_action": "keep attribution source-only until explicit runtime approval artifact exists", "observed_count": 1, "status": "observed"}, "SOURCE_TAXONOMY_LEAKAGE": {"evidence": {"blocker_top": [{"count": 417, "label": "blocked_strength_momentum:below_window_buy_value"}, {"count": 368, "label": "latency_block:latency_state_danger"}, {"count": 284, "label": "blocked_overbought:-"}, {"count": 169, "label": "blocked_strength_momentum:below_strength_base"}, {"count": 169, "label": "blocked_strength_momentum:insufficient_history"}, {"count": 155, "label": "blocked_liquidity:-"}, {"count": 146, "label": "blocked_vpw:-"}, {"count": 132, "label": "blocked_ai_score:ai_score_50_buy_hold_override"}, {"count": 112, "label": "blocked_zero_qty:-"}, {"count": 55, "label": "pre_submit_entry_ai_authority_guard_block:fresh_ai_drop_real_buy_veto"}], "taxonomy_leakage_labels": []}, "next_repair_action": "separate swing/source taxonomy from entry-submit blocker labels", "observed_count": 0, "status": "no_current_signal"}, "UPSTREAM_GATE": {"evidence": {"ai_action_event_counts": {"DROP": 149, "NOT_EVALUATED": 1, "WAIT": 158}, "ai_action_unique_counts": {"DROP": 149, "NOT_EVALUATED": 1, "WAIT": 158}, "ai_terminal_reason_top": [{"count": 98, "label": "ai_terminal:entry_policy_no_buy_score_prior"}, {"count": 32, "label": "ai_terminal:first_ai_wait_big_bite_not_confirmed"}], "budget_to_ai_unique_pct": 115.9, "upstream_blocker_top": [{"count": 132, "label": "blocked_ai_score:ai_score_50_buy_hold_override"}, {"count": 48, "label": "wait65_79_ev_candidate:score_70.0"}, {"count": 32, "label": "first_ai_wait:-"}, {"count": 22, "label": "blocked_ai_score:score_70.0"}, {"count": 19, "label": "blocked_ai_score:score_4.0"}, {"count": 18, "label": "blocked_ai_score:score_0.0"}, {"count": 12, "label": "blocked_ai_score:score_7.0"}, {"count": 7, "label": "blocked_ai_score:score_6.0"}, {"count": 6, "label": "blocked_ai_score:score_3.0"}, {"count": 4, "label": "blocked_ai_score:score_8.0"}]}, "next_repair_action": "join upstream action/reason cohorts to executable BBO and first-hit outcomes; AI semantic tuning remains separately owned", "observed_count": 174, "status": "observed"}}, "axis_order": ["UPSTREAM_GATE", "BUDGET_PASS_COLLAPSE", "LATENCY_PRE_SUBMIT", "PRICE_REVALIDATION", "ENTRY_AI_AUTHORITY_REVALIDATION", "BROKER_RECEIPT", "ECONOMIC_PARTICIPATION", "SIM_REAL_AUTHORITY", "SOURCE_TAXONOMY_LEAKAGE"], "broker_order_submit_allowed": false, "causal_bottleneck_axes": ["UPSTREAM_GATE", "BUDGET_PASS_COLLAPSE", "LATENCY_PRE_SUBMIT", "ENTRY_AI_AUTHORITY_REVALIDATION", "ECONOMIC_PARTICIPATION"], "decision_authority": "submit_drought_attribution_only", "forbidden_uses": ["broker_order_submit", "runtime_apply_candidate", "intraday_threshold_mutation", "provider_route_change", "bot_restart_trigger", "live_auto_promotion"], "metric_role": "funnel_count", "no_current_signal_axes": ["PRICE_REVALIDATION", "BROKER_RECEIPT", "SOURCE_TAXONOMY_LEAKAGE"], "observation_only_axes": ["SIM_REAL_AUTHORITY"], "primary_decision_metric": "causal_bottleneck_axis_observed_count", "runtime_effect": false, "sample_floor": "one_explicit_attempt_per_axis", "source_quality_gate": "lossless_attempt_key_and_explicit_stage_provenance", "window_policy": "same_session_unique_attempt_submit_funnel"}, "quote_freshness_attribution_inconsistent": false, "quote_freshness_latency_pass_recovered_count": 32, "quote_freshness_refresh_applied_count": 72, "quote_freshness_refresh_attempted_count": 89, "required_downstream": ["code_improvement_workorder", "lifecycle_decision_matrix.submit_bucket_attribution", "threshold_cycle_ev_report", "runtime_approval_summary", "postclose_verifier"], "root_cause_closure_status_hint": "root_cause_closed", "root_cause_counts": {"observer_unhealthy": 2, "quote_freshness_input_snapshot_noop": 207, "quote_stale": 160, "spread_microstructure_guard": 372, "spread_or_slippage_guard": 249}, "root_cause_signal": "SUBMIT_DROUGHT_CRITICAL", "runtime_effect": false, "source_report_type": "buy_funnel_sentinel", "weak_contract_matches": ["BROKER_RECEIPT", "BUDGET_PASS_COLLAPSE", "ECONOMIC_PARTICIPATION", "ENTRY_AI_AUTHORITY_REVALIDATION", "FILL_QUALITY", "LATENCY_PRE_SUBMIT", "SIM_REAL_AUTHORITY", "TELEGRAM_POST_SUBMIT_ONLY", "UPSTREAM_GATE"]}`
...
- evidence: `status=pass`, `event_count=262393`, `warning_stage_count=0`, `warning_stages=`, `high_volume_no_source_field_stage_count=0`, `unknown_token_stage_count=0`, `review_warning_count=0`, `decision_authority=source_quality_only`, `runtime_effect=false`, `raw_row_exclusion_manifest=/home/ubuntu/KORStockScan/data/source_quality/raw_row_exclusion/2026-08-25_20260825T201953691557+0900/manifest.json`, `excluded_row_count=69`, `stage_counts={"blocked_ai_score": 43, "early_accel_strong_bundle_recheck_allowed": 1, "early_accel_strong_bundle_recheck_corrected": 1, "early_accel_strong_bundle_recheck_evaluated": 1, "scalp_entry_action_decision_snapshot": 23}`, `field_gap_counts={"invalid_fields:minute_candle_window_fresh_contract": 26, "zero_fields:distance_from_day_high_pct": 43}`, `exclusion_reasons={"insufficient_history": 5, "invalid_label": 26, "not_evaluated_context": 22, "source_quality_blocker": 43, "unknown_token": 34, "zero_context_sensitive": 43}`, `first_timestamp=2026-08-25T08:08:15.252529`, `last_timestamp=2026-08-25T19:46:03.124090`, `forbidden_uses=EV/rolling/MTD/cumulative tuning/live-auto promotion/runtime approval for excluded rows`, `required_action=fix producer provenance/source-quality cause or mark reviewed_not_available/waiting_sample_only explicitly`, `current_scan_hard_blocking_excluded_row_count=0`, `post_exclusion_hard_blocking_excluded_row_count=0`, `raw_row_exclusion_revalidation_required=false`, `revalidation_disposition=closed_preserved_manifest_audit_evidence`, `producer_hint:stage=blocked_ai_score count=43 pipeline=ENTRY_PIPELINE subsystem=scalping_entry_or_sim_producer top_reasons=source_quality_blocker,zero_context_sensitive,unknown_token`, `producer_hint:stage=scalp_entry_action_decision_snapshot count=23 pipeline=ENTRY_PIPELINE subsystem=scalping_entry_or_sim_producer top_reasons=invalid_label,unknown_token,not_evaluated_context,insufficient_history`, `producer_hint:stage=early_accel_strong_bundle_recheck_allowed count=1 pipeline=ENTRY_PIPELINE subsystem=scalping_entry_or_sim_producer top_reasons=invalid_label,not_evaluated_context`, `producer_hint:stage=early_accel_strong_bundle_recheck_corrected count=1 pipeline=ENTRY_PIPELINE subsystem=scalping_entry_or_sim_producer top_reasons=invalid_label`, `producer_hint:stage=early_accel_strong_bundle_recheck_evaluated count=1 pipeline=ENTRY_PIPELINE subsystem=scalping_entry_or_sim_producer top_reasons=invalid_label,not_evaluated_context`, `sample_row:line_no=1553 stage=scalp_entry_action_decision_snapshot record_id=35220 reasons=invalid_label,not_evaluated_context,unknown_token gap_fields={"invalid_fields": ["minute_candle_window_fresh_contract"]}`, `sample_row:line_no=13990 stage=scalp_entry_action_decision_snapshot record_id=35265 reasons=invalid_label,not_evaluated_context,unknown_token gap_fields={"invalid_fields": ["minute_candle_window_fresh_contract"]}`, `sample_row:line_no=26345 stage=blocked_ai_score record_id=35279 reasons=source_quality_blocker,zero_context_sensitive gap_fields={"zero_fields": ["distance_from_day_high_pct"]}`, `sample_row:line_no=34032 stage=blocked_ai_score record_id=35368 reasons=source_quality_blocker,unknown_token,zero_context_sensitive gap_fields={"zero_fields": ["distance_from_day_high_pct"]}`, `sample_row:line_no=34275 stage=blocked_ai_score record_id=35371 reasons=source_quality_blocker,unknown_token,zero_context_sensitive gap_fields={"zero_fields": ["distance_from_day_high_pct"]}`, `sample_row:line_no=34442 stage=blocked_ai_score record_id=35372 reasons=source_quality_blocker,unknown_token,zero_context_sensitive gap_fields={"zero_fields": ["distance_from_day_high_pct"]}`, `sample_row:line_no=35272 stage=blocked_ai_score record_id=35372 reasons=source_quality_blocker,zero_context_sensitive gap_fields={"zero_fields": ["distance_from_day_high_pct"]}`, `sample_row:line_no=36104 stage=blocked_ai_score record_id=35372 reasons=source_quality_blocker,zero_context_sensitive gap_fields={"zero_fields": ["distance_from_day_high_pct"]}`
- parity_contract: -
...
- evidence: `ai_confirmed_unique=82`, `budget_pass_unique=95`, `latency_pass_unique=49`, `submitted_unique=15`, `submitted_to_ai_pct=18.3`, `submitted_to_budget_pct=15.8`, `blocker:blocked_strength_momentum:below_window_buy_value=417`, `blocker:latency_block:latency_state_danger=368`, `blocker:blocked_overbought:-=284`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=132`, `upstream:wait65_79_ev_candidate:score_70.0=48`, `upstream:first_ai_wait:-=32`, `latency:latency_block:latency_state_danger=368`, `latency:latency_block:tp1_direct_recheck_expired=4`, `weak_contract_gap=broker_receipt_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=82`, `budget_pass_unique=95`, `latency_pass_unique=49`, `submitted_unique=15`, `submitted_to_ai_pct=18.3`, `submitted_to_budget_pct=15.8`, `blocker:blocked_strength_momentum:below_window_buy_value=417`, `blocker:latency_block:latency_state_danger=368`, `blocker:blocked_overbought:-=284`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=132`, `upstream:wait65_79_ev_candidate:score_70.0=48`, `upstream:first_ai_wait:-=32`, `latency:latency_block:latency_state_danger=368`, `latency:latency_block:tp1_direct_recheck_expired=4`, `weak_contract_gap=fill_quality_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=82`, `budget_pass_unique=95`, `latency_pass_unique=49`, `submitted_unique=15`, `submitted_to_ai_pct=18.3`, `submitted_to_budget_pct=15.8`, `blocker:blocked_strength_momentum:below_window_buy_value=417`, `blocker:latency_block:latency_state_danger=368`, `blocker:blocked_overbought:-=284`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=132`, `upstream:wait65_79_ev_candidate:score_70.0=48`, `upstream:first_ai_wait:-=32`, `latency:latency_block:latency_state_danger=368`, `latency:latency_block:tp1_direct_recheck_expired=4`, `weak_contract_gap=post_submit_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=82`, `budget_pass_unique=95`, `latency_pass_unique=49`, `submitted_unique=15`, `submitted_to_ai_pct=18.3`, `submitted_to_budget_pct=15.8`, `blocker:blocked_strength_momentum:below_window_buy_value=417`, `blocker:latency_block:latency_state_danger=368`, `blocker:blocked_overbought:-=284`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=132`, `upstream:wait65_79_ev_candidate:score_70.0=48`, `upstream:first_ai_wait:-=32`, `latency:latency_block:latency_state_danger=368`, `latency:latency_block:tp1_direct_recheck_expired=4`, `weak_contract_gap=source_taxonomy_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`, `taxonomy_leakage_labels=[]`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=82`, `budget_pass_unique=95`, `latency_pass_unique=49`, `submitted_unique=15`, `submitted_to_ai_pct=18.3`, `submitted_to_budget_pct=15.8`, `blocker:blocked_strength_momentum:below_window_buy_value=417`, `blocker:latency_block:latency_state_danger=368`, `blocker:blocked_overbought:-=284`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=132`, `upstream:wait65_79_ev_candidate:score_70.0=48`, `upstream:first_ai_wait:-=32`, `latency:latency_block:latency_state_danger=368`, `latency:latency_block:tp1_direct_recheck_expired=4`, `weak_contract_gap=telegram_post_submit_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
### 11. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_11_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_9a776aeb`
...
### 12. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_12_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_da44f074`
...
### 13. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_13_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_2ad7fdfe`
...
### 15. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_15_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_9a776aeb`
...
### 19. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_19_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_b5237a42`
...
### 21. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_20_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_68631b1f`
...
### 22. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_2_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_9a776aeb`
...
### 23. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_3_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_3aa900fc`

- title: LDM lifecycle flow bucket follow-up: lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_sca:b335290775
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `lifecycle_decision_matrix_lifecycle_flow_bucket_attribution`
- lifecycle_stage: `lifecycle_flow`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_3`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_sca:b335290775`, `reason=incomplete_lifecycle_flow`, `join_gap_reasons=['missing_holding', 'missing_exit']`, `required_producer_consumer_candidates=['entry producer', 'submit observation', 'holding flow', 'exit/post-sell feedback', 'bridge key normalizer']`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 26. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_6_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_9a776aeb`
...
### 27. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_7_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_9a776aeb`
...
### 28. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_8_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_042316e2`
...
- implementation_status: `implemented`
- root_cause_closure_status: `root_cause_closed`
- implementation_provenance: `{"recommended_resolution": "entry_label_not_applicable", "source_field_coverage": {"exit_rule": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 648, "source_fields": ["labels.exit_rule"]}}, "unknown_dimension_counts": {"exit_rule": 1}, "unknown_reason_counts": {"entry_label_not_applicable": 1}}`
- repeat_unresolved_escalation: `-`
...
### 33. `order_lifecycle_exit_bucket_combo_exit_result_source_scalp_sim_partial_sell_order_assumed_filled_rule_scalp_sim_panic_73281913`
...
### 34. `order_lifecycle_exit_bucket_combo_exit_result_source_scalp_sim_partial_sell_order_assumed_filled_rule_scalp_sim_panic_823fe278`
...
### 35. `order_lifecycle_exit_bucket_combo_exit_result_source_sim_post_sell_evaluation_rule_scalp_preset_hard_stop_pct_outcome_b0c5da6a`

- title: LDM exit bucket source-quality follow-up: combo_exit_result=source=sim_post_sell_evaluation|rule=scalp_preset_hard_stop_pct|outcome=NEUTRAL|profit=profit_lt_neg070
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `lifecycle_decision_matrix_exit_bucket_attribution`
- lifecycle_stage: `exit`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep exit stage buckets visible as child evidence while parent lifecycle flow owns promotion EV.
- evidence: `workorder_id=exit_bucket_source_quality_3`, `bucket_type=combo_exit_result`, `bucket_key=source=sim_post_sell_evaluation|rule=scalp_preset_hard_stop_pct|outcome=NEUTRAL|profit=profit_lt_neg070`, `reason=exit_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`, `recommended_route=candidate_tighten_or_exclude`, `runtime_effect=false`, `allowed_runtime_apply=false`, `stage_only_live_promotion_forbidden=true`
- parity_contract: -
- next_postclose_metric: exit_bucket_attribution bucket/workorder counts, identity join rate, and complete lifecycle flow count remain visible in downstream reports.
- files_likely_touched: -
- acceptance_tests: -
- implementation_status: `implemented`
- root_cause_closure_status: `root_cause_closed`
- implementation_provenance: `{"ai_inference_proposal": {"allowed_runtime_apply": false, "bucket_key": "source=sim_post_sell_evaluation|rule=scalp_preset_hard_stop_pct|outcome=NEUTRAL|profit=profit_lt_neg070", "bucket_type": "combo_exit_result", "decision_point": "exit_bucket_classification", "deterministic_decision": "candidate_tighten_or_exclude", "model": "gpt-5.4-mini", "proposal_type": "ai_inference_parallel_review_required", "reason": "parallel_ai_inference_for_deterministic_bucket_decision", "reasoning_effort": "medium", "review_contract": {"ai_has_promotion_authority": false, "model": "gpt-5.4", "reasoning_effort": "low", "runtime_effect": false}, "runtime_effect": false, "source_quality_gate": "pass"}, "recommended_resolution": "none", "source_field_coverage": {}, "unknown_reason_counts": {}}`
- repeat_unresolved_escalation: `-`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep exit stage buckets visible as child evidence while parent lifecycle flow owns promotion EV.
- evidence: `workorder_id=exit_bucket_source_quality_4`, `bucket_type=combo_exit_result`, `bucket_key=source=sim_post_sell_evaluation|rule=scalp_soft_stop_pct|outcome=MISSED_UPSIDE|profit=profit_lt_neg070`, `reason=exit_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`, `recommended_route=candidate_tighten_or_exclude`, `runtime_effect=false`, `allowed_runtime_apply=false`, `stage_only_live_promotion_forbidden=true`
- parity_contract: -
- next_postclose_metric: exit_bucket_attribution bucket/workorder counts, identity join rate, and complete lifecycle flow count remain visible in downstream reports.
- files_likely_touched: -
- acceptance_tests: -
...
### 37. `order_lifecycle_exit_bucket_exit_outcome_good_exit`
...
### 39. `order_lifecycle_exit_bucket_exit_outcome_neutral`
...
### 40. `order_lifecycle_exit_bucket_exit_outcome_outcome_not_applicable_partial_exit`
...
### 41. `order_lifecycle_exit_bucket_exit_rule_scalp_sim_panic_lifecycle_partial_exit`
...
### 42. `order_lifecycle_exit_bucket_exit_rule_scalp_trailing_take_profit`
...
### 46. `order_lifecycle_holding_bucket_held_bucket_held_not_applicable_at_start`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep holding stage buckets visible as child evidence while parent lifecycle flow owns promotion EV.
- evidence: `workorder_id=holding_bucket_source_quality_4`, `bucket_type=held_bucket`, `bucket_key=held_not_applicable_at_start`, `reason=holding_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`, `recommended_route=candidate_tighten_or_exclude`, `runtime_effect=false`, `allowed_runtime_apply=false`, `stage_only_live_promotion_forbidden=true`
- parity_contract: -
- next_postclose_metric: holding_bucket_attribution bucket/workorder counts, identity join rate, and complete lifecycle flow count remain visible in downstream reports.
- files_likely_touched: -
- acceptance_tests: -
...
### 47. `order_lifecycle_holding_bucket_holding_action_holding_action_not_applicable_at_start`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep holding stage buckets visible as child evidence while parent lifecycle flow owns promotion EV.
- evidence: `workorder_id=holding_bucket_source_quality_5`, `bucket_type=holding_action`, `bucket_key=holding_action_not_applicable_at_start`, `reason=holding_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`, `recommended_route=candidate_tighten_or_exclude`, `runtime_effect=false`, `allowed_runtime_apply=false`, `stage_only_live_promotion_forbidden=true`
- parity_contract: -
- next_postclose_metric: holding_bucket_attribution bucket/workorder counts, identity join rate, and complete lifecycle flow count remain visible in downstream reports.
- files_likely_touched: -
- acceptance_tests: -
...
- repeat_unresolved_escalation: `-`
- longstanding_non_implement_review: `{"history_window_days": 10, "previous_decision": "attach_existing_family", "previous_implementation_status": "implemented", "previous_route": "existing_family", "repeat_count": 4, "repeat_key": "order_lifecycle_holding_bucket_holding_action_holding_action_not_applicable_at_start", "repeat_signature": "sig:lifecycle_decision_matrix_holding_bucket_attribution|lifecycle_decision_matrix|holding|holding_bucket_source_quality_child_evidence|lifecycle_decision_matrix_runtime|ldm_holding_bucket_source_quality_follow_up_holding_action_holding_action_not_ap", "review_disposition": "implemented_with_provenance"}`
- longstanding_non_implement_action: `-`
- structural_blocker_escalation: `-`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 48. `order_lifecycle_holding_bucket_holding_action_wait`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep holding stage buckets visible as child evidence while parent lifecycle flow owns promotion EV.
- evidence: `workorder_id=holding_bucket_source_quality_6`, `bucket_type=holding_action`, `bucket_key=WAIT`, `reason=holding_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`, `recommended_route=candidate_tighten_or_exclude`, `runtime_effect=false`, `allowed_runtime_apply=false`, `stage_only_live_promotion_forbidden=true`
- parity_contract: -
- next_postclose_metric: holding_bucket_attribution bucket/workorder counts, identity join rate, and complete lifecycle flow count remain visible in downstream reports.
- files_likely_touched: -
- acceptance_tests: -
...
- repeat_unresolved_escalation: `-`
- longstanding_non_implement_review: `{"history_window_days": 10, "previous_decision": "attach_existing_family", "previous_implementation_status": "implemented", "previous_route": "existing_family", "repeat_count": 6, "repeat_key": "order_lifecycle_holding_bucket_holding_action_wait", "repeat_signature": "sig:lifecycle_decision_matrix_holding_bucket_attribution|lifecycle_decision_matrix|holding|holding_bucket_source_quality_child_evidence|lifecycle_decision_matrix_runtime|ldm_holding_bucket_source_quality_follow_up_holding_action_wait", "review_disposition": "implemented_with_provenance"}`
- longstanding_non_implement_action: `-`
- structural_blocker_escalation: `-`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 49. `order_lifecycle_holding_bucket_holding_source_stage_scalp_sim_holding_started`
...
- repeat_unresolved_escalation: `-`
- longstanding_non_implement_review: `{"history_window_days": 10, "previous_decision": "attach_existing_family", "previous_implementation_status": "implemented", "previous_route": "existing_family", "repeat_count": 6, "repeat_key": "order_lifecycle_holding_bucket_holding_source_stage_scalp_sim_holding_started", "repeat_signature": "sig:lifecycle_decision_matrix_holding_bucket_attribution|lifecycle_decision_matrix|holding|holding_bucket_source_quality_child_evidence|lifecycle_decision_matrix_runtime|ldm_holding_bucket_source_quality_follow_up_holding_source_stage_scalp_sim_holdi", "review_disposition": "implemented_with_provenance"}`
- longstanding_non_implement_action: `-`
- structural_blocker_escalation: `-`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 50. `order_lifecycle_holding_bucket_profit_band_profit_lt_neg070`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep holding stage buckets visible as child evidence while parent lifecycle flow owns promotion EV.
- evidence: `workorder_id=holding_bucket_source_quality_8`, `bucket_type=profit_band`, `bucket_key=profit_lt_neg070`, `reason=holding_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`, `recommended_route=candidate_tighten_or_exclude`, `runtime_effect=false`, `allowed_runtime_apply=false`, `stage_only_live_promotion_forbidden=true`
- parity_contract: -
- next_postclose_metric: holding_bucket_attribution bucket/workorder counts, identity join rate, and complete lifecycle flow count remain visible in downstream reports.
- files_likely_touched: -
- acceptance_tests: -
...
- repeat_unresolved_escalation: `-`
- longstanding_non_implement_review: `{"history_window_days": 10, "previous_decision": "attach_existing_family", "previous_implementation_status": "implemented", "previous_route": "existing_family", "repeat_count": 6, "repeat_key": "order_lifecycle_holding_bucket_profit_band_profit_lt_neg070", "repeat_signature": "sig:lifecycle_decision_matrix_holding_bucket_attribution|lifecycle_decision_matrix|holding|holding_bucket_source_quality_child_evidence|lifecycle_decision_matrix_runtime|ldm_holding_bucket_source_quality_follow_up_profit_band_profit_lt_neg070", "review_disposition": "implemented_with_provenance"}`
- longstanding_non_implement_action: `-`
- structural_blocker_escalation: `-`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 51. `order_lifecycle_holding_bucket_profit_band_profit_neg010_pos080`

- title: LDM holding bucket source-quality follow-up: profit_band=profit_neg010_pos080
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `lifecycle_decision_matrix_holding_bucket_attribution`
- lifecycle_stage: `holding`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep holding stage buckets visible as child evidence while parent lifecycle flow owns promotion EV.
- evidence: `workorder_id=holding_bucket_source_quality_9`, `bucket_type=profit_band`, `bucket_key=profit_neg010_pos080`, `reason=holding_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`, `recommended_route=candidate_tighten_or_exclude`, `runtime_effect=false`, `allowed_runtime_apply=false`, `stage_only_live_promotion_forbidden=true`
- parity_contract: -
- next_postclose_metric: holding_bucket_attribution bucket/workorder counts, identity join rate, and complete lifecycle flow count remain visible in downstream reports.
- files_likely_touched: -
- acceptance_tests: -
- implementation_status: `implemented`
- root_cause_closure_status: `root_cause_closed`
- implementation_provenance: `{"ai_inference_proposal": {"allowed_runtime_apply": false, "bucket_key": "profit_neg010_pos080", "bucket_type": "profit_band", "decision_point": "holding_bucket_classification", "deterministic_decision": "candidate_tighten_or_exclude", "model": "gpt-5.4-mini", "proposal_type": "ai_inference_parallel_review_required", "reason": "parallel_ai_inference_for_deterministic_bucket_decision", "reasoning_effort": "medium", "review_contract": {"ai_has_promotion_authority": false, "model": "gpt-5.4", "reasoning_effort": "low", "runtime_effect": false}, "runtime_effect": false, "source_quality_gate": "pass"}, "recommended_resolution": "none", "source_field_coverage": {}, "unknown_reason_counts": {}}`
- repeat_unresolved_escalation: `-`
- longstanding_non_implement_review: `{"history_window_days": 10, "previous_decision": "attach_existing_family", "previous_implementation_status": "implemented", "previous_route": "existing_family", "repeat_count": 4, "repeat_key": "order_lifecycle_holding_bucket_profit_band_profit_neg010_pos080", "repeat_signature": "sig:lifecycle_decision_matrix_holding_bucket_attribution|lifecycle_decision_matrix|holding|holding_bucket_source_quality_child_evidence|lifecycle_decision_matrix_runtime|ldm_holding_bucket_source_quality_follow_up_profit_band_profit_neg010_pos080", "review_disposition": "implemented_with_provenance"}`
- longstanding_non_implement_action: `-`
- structural_blocker_escalation: `-`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 52. `order_conversion_lane_submit_drought_submit_drought_upstream_gate`
...
- repeat_unresolved_escalation: `-`
- longstanding_non_implement_review: `{"history_window_days": 10, "previous_decision": "attach_existing_family", "previous_implementation_status": "implemented", "previous_route": "existing_family", "repeat_count": 5, "repeat_key": "order_conversion_lane_submit_drought_submit_drought_upstream_gate", "repeat_signature": "sig:conversion_lane|sim_to_real_conversion_lineage|conversion|conversion_submit_drought_blocker|sim_to_real_conversion_lane|conversion_lane_blocker_follow_up_submit_drought_submit_drought_upstream_gate", "review_disposition": "implemented_with_provenance"}`
- longstanding_non_implement_action: `-`
- structural_blocker_escalation: `-`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
- evidence: `quiet_gap_count=390`, `rollup_required_count=390`, `sim_live_connected_quiet_gap_count=0`, `quiet_gap_type_counts={'positive_source_only_keep_collecting': 389, 'ai_review_parsed_low_coverage': 1}`, `ai_review_coverage={'status': 'parsed', 'shard_count': 5, 'parsed_shard_count': 1, 'reviewed_candidate_count': 1, 'low_coverage': True}`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
...
- evidence: `rollup_only_gap_count=33`, `unknown_source_dimensions=3`, `recommended_resolution_counts={'explicit_lifecycle_flow_source_only_blocker': 30, 'entry_label_not_applicable': 1, 'join_labels_before_bucket_decision': 2}`, `missing_dimension_key_counts={'entry': 8, 'exit': 58, 'holding': 60, 'submit': 38}`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
...
### 57. `order_conversion_lane_key_lineage_active_seed_622146bd0836773e`

- title: Conversion lane blocker follow-up: key_lineage active_seed_622146bd0836773e
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `conversion_lane`
- lifecycle_stage: `conversion`
...
### 58. `order_conversion_lane_key_lineage_rising_missed_prior_64343a939842b82c`

- title: Conversion lane blocker follow-up: key_lineage rising_missed_prior_64343a939842b82c
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `conversion_lane`
- lifecycle_stage: `conversion`
...
- tuning_axis_effect: `False`
- expected_ev_effect: reduce remaining blocker count before bounded real canary can be requested
- evidence: `conversion_candidate_id=rising_missed_prior_64343a939842b82c`, `blocker_class=key_lineage`, `conversion_impact_rank=5`, `next_repair_action=key_lineage_preopen_missing`, `acceptance_test=same source key is continuous producer->catalog->PREOPEN->runtime->postclose or closes natural_match_0`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: -
- files_likely_touched: `src/engine/automation/key_lineage_ledger.py`, `src/engine/automation/conversion_lane.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`, `src/engine/build_code_improvement_workorder.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_conversion_lane_key_lineage.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
### 59. `order_lifecycle_entry_bucket_chosen_action_no_buy_ai`
...
### 60. `order_lifecycle_entry_bucket_combo_entry_spot_score_score_lt60_source_scalp_entry_action_decision_snapshot_stale_stal_26669969`

- title: LDM entry bucket attribution follow-up: combo_entry_spot=score=score_lt60|source=scalp_entry_action_decision_snapshot|stale=stale_not_available|liquidity=liquidity_not_available|overbought=overbought_not_available|time=time_1200_1400
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `lifecycle_decision_matrix_entry_bucket_attribution`
- lifecycle_stage: `entry`
...
### 63. `order_lifecycle_entry_bucket_score_band_score_lt60`
...
### 64. `order_lifecycle_entry_bucket_source_stage_scalp_entry_action_decision_snapshot`
...
### 65. `order_lifecycle_entry_bucket_stale_bucket_stale_not_available`
...
### 66. `order_lifecycle_entry_bucket_time_bucket_time_1200_1400`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep entry bucket EV attribution, source-quality gaps, and threshold-cycle approval candidates connected without mutating intraday thresholds or broker submission.
- evidence: `workorder_id=entry_bucket_unknown_source_quality_10`, `bucket_type=time_bucket`, `bucket_key=time_1200_1400`, `reason=unknown_bucket_source_quality_blocker`, `recommended_route=source_quality_workorder`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_entry_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_decision_matrix.entry_bucket_attribution should reduce unknown buckets, keep runtime_approval_candidates visible in threshold EV/runtime summary, and regenerate this workorder when source-quality confirmation is still needed.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/scalp_entry_action_decision_matrix.py`, `src/engine/daily_threshold_cycle_report.py`, `src/engine/runtime_approval_summary.py`, `docs/report-based-automation-traceability.md`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM entry bucket candidates/workorders are not propagated`
...
### 67. `order_conversion_lane_submit_drought_submit_drought_budget_pass_collapse`
...
- tuning_axis_effect: `False`
- expected_ev_effect: reduce remaining blocker count before bounded real canary can be requested
- evidence: `conversion_candidate_id=submit_drought:BUDGET_PASS_COLLAPSE`, `blocker_class=submit_drought`, `conversion_impact_rank=6`, `next_repair_action=treat pre-AI budget events as expected no-parent observations; repair only missing lineage contracts or stale/untrusted post-AI parents, and keep causal EV attribution limited to exact joins`, `acceptance_test=each ai-confirmed to budget-pass drop has an explicit account/order/quantity/cooldown or eligibility reason; no hard guard is relaxed`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: -
- files_likely_touched: `src/engine/automation/key_lineage_ledger.py`, `src/engine/automation/conversion_lane.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`, `src/engine/build_code_improvement_workorder.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_conversion_lane_key_lineage.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
### 68. `order_conversion_lane_env_mapping_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_6b8d2a8c`
...
### N3. `order_rising_missed_scout_loss_filter`
...
### N4. `order_rising_missed_scout_post_sell_bridge`
...
### N7. `order_rising_missed_classifier_prior_bridge`
...
### N8. `order_panic_sell_defense_lifecycle_transition_pack`
...
### N9. `order_partial_only_표류_전용_timeout_report_only`
...
### N11. `order_동일_종목_split_entry_soft_stop_재진입_cooldown_report_only`
...
### N12. `order_no_acute_observability_alert`
...
### N13. `order_liquidity_gate_miss_ev_recovery`
...
- 구현 결과는 `2026-08-26` 이후 postclose `threshold_cycle`, `scalping_pattern_lab_automation`, `threshold_cycle_ev`가 자동으로 다시 읽는다.
