...
- generated_at: `2026-05-28T13:36:50+09:00`
- generation_id: `2026-05-28-7d667cbcfcda`
- source_hash: `7d667cbcfcda1e9263546e7083e63bf2f4c21213945d3faea0e20b858ee6e656`
...
- previous_generation_id: `2026-05-28-d15cd1d5bc48`
- previous_source_hash: `d15cd1d5bc482bb7fa5259caccd47a6163041d4c24c0613195f9d184b17bff5d`
- new_order_ids: `[]`
- removed_order_ids: `[]`
...
- swing_lifecycle_matrix_source_order_count: `16`
- swing_lifecycle_bucket_discovery_source_order_count: `32`
...
- selected_order_count: `92`
- non_selected_order_count: `39`
- source_decision_counts: `{'implement_now': 8, 'attach_existing_family': 103, 'design_family_candidate': 7, 'defer_evidence': 10, 'reject': 3}`
- selected_decision_counts: `{'implement_now': 8, 'attach_existing_family': 84}`
- selected_route_counts: `{'implement_now': 8, 'existing_family': 84}`
- selected_implement_now_route_count: `8`
- selected_runtime_effect_false_count: `92`
- selected_unimplemented_runtime_effect_false_count: `8`
- selected_unimplemented_route_counts: `{'implement_now': 8}`
...
- `duplicate_order_id=order_swing_lifecycle_bucket_discovery_swing_bucket_selection_discovery_arm_attribution_breakout_confirm_entry_confiden source=swing_lifecycle_bucket_discovery stage=source_quality`
- `duplicate_order_id=order_swing_lifecycle_bucket_discovery_swing_bucket_selection_discovery_arm_attribution_breakout_confirm_entry_confiden source=swing_lifecycle_bucket_discovery stage=source_quality`
- `duplicate_order_id=order_swing_lifecycle_bucket_discovery_swing_bucket_selection_discovery_arm_attribution_pullback_limit_entry_risk_cappe source=swing_lifecycle_bucket_discovery stage=source_quality`
- `duplicate_order_id=order_swing_lifecycle_bucket_discovery_swing_bucket_selection_discovery_arm_attribution_pullback_limit_entry_risk_cappe source=swing_lifecycle_bucket_discovery stage=source_quality`
- `duplicate_order_id=order_swing_lifecycle_bucket_discovery_swing_bucket_selection_discovery_arm_attribution_breakout_confirm_entry_risk_cap source=swing_lifecycle_bucket_discovery stage=source_quality`
- `duplicate_order_id=order_swing_lifecycle_bucket_discovery_swing_bucket_selection_discovery_arm_attribution_breakout_confirm_entry_risk_cap source=swing_lifecycle_bucket_discovery stage=source_quality`
- `duplicate_order_id=order_swing_lifecycle_bucket_discovery_swing_bucket_selection_discovery_arm_attribution_breakout_confirm_entry_risk_cap source=swing_lifecycle_bucket_discovery stage=source_quality`
- `duplicate_order_id=order_swing_lifecycle_bucket_discovery_swing_bucket_selection_discovery_arm_attribution_pullback_limit_entry_risk_cappe source=swing_lifecycle_bucket_discovery stage=source_quality`
...
### 1. `order_producer_gap_discovery_producer_gap_missed_fill_recovery_counterfactual_missing`
...
- files_likely_touched: `src/producers/missed_fill_recovery_counterfactual_producer.py`, `src/reports/producer_gap_discovery.py`, `data/report/lifecycle_decision_matrix/lifecycle_decision_matrix_2026-05-28.json`
- acceptance_tests: `Submit-fill gap rows are emitted by a dedicated producer bucket.`, `No broker/order or decision-override authority is introduced.`, `The producer contract includes all required source-only fields.`
...
### 2. `order_producer_gap_discovery_producer_gap_sim_entry_selection_gap_missing`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Improve source-quality adjusted EV attribution by making the missing producer observable.
- evidence: `sim_rows=1119`, `entry_time_field_rate=0.0000`, `gap=sim entry/selection rows are present but entry provenance is insufficient for bucket producer coverage`, `required_producer=sim_entry_selection_bucket_producer`, `ai_priority=high`, `ai_route=implement_now`
- parity_contract: -
- next_postclose_metric: producer_gap_discovery.producer_gap_sim_entry_selection_gap_missing
- files_likely_touched: `src/producers/sim_entry_selection_bucket_producer.py`, `src/reports/producer_gap_discovery.py`, `data/post_sell/sim_post_sell_candidates_2026-05-28.jsonl`
- acceptance_tests: `Entry-selection rows are grouped under a dedicated producer bucket.`, `No entry override or broker-submit authority is exposed.`, `The producer contract contains the required source-only fields.`
- implementation_status: `-`
- implementation_provenance: `-`
- automation_reentry: After implementation, rerun producer_gap_discovery, code improvement workorder, threshold EV, runtime summary, and postclose verifier.
...
### 3. `order_pattern_lab_ai_review_scalping_lifecycle_bucket_discovery`

- title: Pattern Lab AI review follow-up: scalping_lifecycle_bucket_discovery
- decision: `implement_now`
...
### 4. `order_pattern_lab_ai_review_scalping_pattern_lab_automation`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Improve pattern lab feedback quality without runtime mutation.
- evidence: `review_id=scalping_pattern_lab_automation`, `domain=scalping`, `final_state=automation_handoff_gap`, `final_decision=surface_workorder`, `auditor_pass=True`, `explicit_gap_type=automation_handoff_gap`, `source_paths=['/home/ubuntu/KORStockScan/data/report/scalping_pattern_lab_automation/scalping_pattern_lab_automation_2026-05-28.json', '/home/ubuntu/KORStockScan/data/report/pattern_lab_currentness_audit/pattern_lab_currentness_audit_2026-05-28.json', '/home/ubuntu/KORStockScan/data/report/lifecycle_decision_matrix/lifecycle_decision_matrix_2026-05-28.json', '/home/ubuntu/KORStockScan/data/report/lifecycle_bucket_discovery/lifecycle_bucket_discovery_2026-05-28.json']`
- parity_contract: -
- next_postclose_metric: pattern_lab_ai_review.scalping_pattern_lab_automation
- files_likely_touched: `src/engine/pattern_lab_ai_review.py`, `src/engine/pattern_lab_currentness_audit.py`, `analysis/gemini_scalping_pattern_lab`, `analysis/claude_scalping_pattern_lab`, `analysis/deepseek_swing_pattern_lab`
- acceptance_tests: `PYTHONPATH=. .venv/bin/pytest -q src/tests/test_pattern_lab_ai_review.py src/tests/test_pattern_lab_currentness_audit.py`
- implementation_status: `-`
- implementation_provenance: `-`
...
### 5. `order_pattern_lab_ai_review_swing_lifecycle_bucket_discovery`

- title: Pattern Lab AI review follow-up: swing_lifecycle_bucket_discovery
- decision: `implement_now`
- decision_reason: pattern lab audit/review/observability order is report/source-quality instrumentation only and must remain runtime_effect=false
- source_report_type: `pattern_lab_ai_review`
- lifecycle_stage: `pattern_lab_ai_review`
...
### 6. `order_pattern_lab_ai_review_swing_pattern_lab_automation`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Improve pattern lab feedback quality without runtime mutation.
- evidence: `review_id=swing_pattern_lab_automation`, `domain=swing`, `final_state=automation_handoff_gap`, `final_decision=surface_workorder`, `auditor_pass=True`, `explicit_gap_type=automation_handoff_gap`, `source_paths=['/home/ubuntu/KORStockScan/data/report/swing_pattern_lab_automation/swing_pattern_lab_automation_2026-05-28.json', '/home/ubuntu/KORStockScan/data/report/pattern_lab_currentness_audit/pattern_lab_currentness_audit_2026-05-28.json', '/home/ubuntu/KORStockScan/data/report/swing_lifecycle_decision_matrix/swing_lifecycle_decision_matrix_2026-05-28.json', '/home/ubuntu/KORStockScan/data/report/swing_lifecycle_bucket_discovery/swing_lifecycle_bucket_discovery_2026-05-28.json', '/home/ubuntu/KORStockScan/data/report/swing_strategy_discovery_ev/swing_strategy_discovery_ev_2026-05-28.json']`
- parity_contract: -
...
### 7. `order_pattern_lab_currentness_audit_scalping_ldm_threshold_reentry_sources`
...
### 8. `order_pattern_lab_currentness_audit_swing_ldm_threshold_reentry_sources`
...
### 9. `order_entry_submit_drought_auto_resolution`
...
- evidence: `ai_confirmed_unique=105`, `budget_pass_unique=55`, `latency_pass_unique=20`, `submitted_unique=0`, `submitted_to_ai_pct=0.0`, `submitted_to_budget_pct=0.0`, `blocker:latency_block:latency_state_danger=15392`, `blocker:blocked_swing_score_vpw:-=10296`, `blocker:blocked_gatekeeper_reject:눌림 대기=3098`, `upstream:blocked_ai_score:score_62.0=736`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=382`, `upstream:blocked_ai_score:score_60.0=133`, `latency:latency_block:latency_state_danger=15392`
- parity_contract: -
...
### 11. `order_entry_broker_receipt_contract_gap_review`
...
- evidence: `ai_confirmed_unique=105`, `budget_pass_unique=55`, `latency_pass_unique=20`, `submitted_unique=0`, `submitted_to_ai_pct=0.0`, `submitted_to_budget_pct=0.0`, `blocker:latency_block:latency_state_danger=15392`, `blocker:blocked_swing_score_vpw:-=10296`, `blocker:blocked_gatekeeper_reject:눌림 대기=3098`, `upstream:blocked_ai_score:score_62.0=736`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=382`, `upstream:blocked_ai_score:score_60.0=133`, `latency:latency_block:latency_state_danger=15392`, `weak_contract_gap=broker_receipt_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
...
### 12. `order_entry_fill_quality_contract_gap_review`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=105`, `budget_pass_unique=55`, `latency_pass_unique=20`, `submitted_unique=0`, `submitted_to_ai_pct=0.0`, `submitted_to_budget_pct=0.0`, `blocker:latency_block:latency_state_danger=15392`, `blocker:blocked_swing_score_vpw:-=10296`, `blocker:blocked_gatekeeper_reject:눌림 대기=3098`, `upstream:blocked_ai_score:score_62.0=736`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=382`, `upstream:blocked_ai_score:score_60.0=133`, `latency:latency_block:latency_state_danger=15392`, `weak_contract_gap=fill_quality_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
### 13. `order_entry_post_submit_contract_gap_review`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=105`, `budget_pass_unique=55`, `latency_pass_unique=20`, `submitted_unique=0`, `submitted_to_ai_pct=0.0`, `submitted_to_budget_pct=0.0`, `blocker:latency_block:latency_state_danger=15392`, `blocker:blocked_swing_score_vpw:-=10296`, `blocker:blocked_gatekeeper_reject:눌림 대기=3098`, `upstream:blocked_ai_score:score_62.0=736`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=382`, `upstream:blocked_ai_score:score_60.0=133`, `latency:latency_block:latency_state_danger=15392`, `weak_contract_gap=post_submit_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
### 14. `order_entry_source_taxonomy_contract_gap_review`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=105`, `budget_pass_unique=55`, `latency_pass_unique=20`, `submitted_unique=0`, `submitted_to_ai_pct=0.0`, `submitted_to_budget_pct=0.0`, `blocker:latency_block:latency_state_danger=15392`, `blocker:blocked_swing_score_vpw:-=10296`, `blocker:blocked_gatekeeper_reject:눌림 대기=3098`, `upstream:blocked_ai_score:score_62.0=736`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=382`, `upstream:blocked_ai_score:score_60.0=133`, `latency:latency_block:latency_state_danger=15392`, `weak_contract_gap=source_taxonomy_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`, `taxonomy_leakage_labels=['blocked_swing_score_vpw:-', 'blocked_swing_gap:-']`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
### 15. `order_entry_telegram_post_submit_contract_gap_review`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=105`, `budget_pass_unique=55`, `latency_pass_unique=20`, `submitted_unique=0`, `submitted_to_ai_pct=0.0`, `submitted_to_budget_pct=0.0`, `blocker:latency_block:latency_state_danger=15392`, `blocker:blocked_swing_score_vpw:-=10296`, `blocker:blocked_gatekeeper_reject:눌림 대기=3098`, `upstream:blocked_ai_score:score_62.0=736`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=382`, `upstream:blocked_ai_score:score_60.0=133`, `latency:latency_block:latency_state_danger=15392`, `weak_contract_gap=telegram_post_submit_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
### 16. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_10_lifecycle_flow_combo_lifecycle_flow_entry_entry_missing_submit_submit_c_264969e0`
...
### 17. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_11_lifecycle_flow_combo_lifecycle_flow_entry_entry_missing_submit_submit_c_264969e0`
...
### 18. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_12_lifecycle_flow_combo_lifecycle_flow_entry_entry_missing_submit_submit_c_264969e0`
...
### 19. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_13_lifecycle_flow_combo_lifecycle_flow_entry_entry_missing_submit_submit_c_264969e0`
...
### 20. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_14_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_78f88b94`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_15`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_blo:fcd588ff6c`, `reason=incomplete_lifecycle_flow`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_16`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_blo:fcd588ff6c`, `reason=incomplete_lifecycle_flow`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 23. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_17_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_70c74920`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_17`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_60_62_source_bl:83c74e766d`, `reason=incomplete_lifecycle_flow`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 24. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_18_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_05850e2c`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_18`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_blo:5afa7ecf4e`, `reason=incomplete_lifecycle_flow`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 25. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_19_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_70c74920`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_19`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_60_62_source_bl:83c74e766d`, `reason=incomplete_lifecycle_flow`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 26. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_1_lifecycle_flow_combo_lifecycle_flow_entry_entry_missing_submit_submit_c_264969e0`
...
### 27. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_20_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_70c74920`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_20`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_60_62_source_bl:83c74e766d`, `reason=incomplete_lifecycle_flow`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 28. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_2_lifecycle_flow_combo_lifecycle_flow_entry_entry_missing_submit_submit_c_264969e0`
...
### 29. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_3_lifecycle_flow_combo_lifecycle_flow_entry_entry_missing_submit_submit_c_6d30a10b`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_3`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_s:fdddb9a443`, `reason=incomplete_lifecycle_flow`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 30. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_4_lifecycle_flow_combo_lifecycle_flow_entry_entry_missing_submit_submit_c_264969e0`
...
### 31. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_5_lifecycle_flow_combo_lifecycle_flow_entry_entry_missing_submit_submit_c_264969e0`
...
### 32. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_6_lifecycle_flow_combo_lifecycle_flow_entry_entry_missing_submit_submit_c_264969e0`
...
### 33. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_7_lifecycle_flow_combo_lifecycle_flow_entry_entry_missing_submit_submit_c_264969e0`
...
### 34. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_8_lifecycle_flow_combo_lifecycle_flow_entry_entry_missing_submit_submit_c_264969e0`
...
### 35. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_9_lifecycle_flow_combo_lifecycle_flow_entry_entry_missing_submit_submit_c_264969e0`
...
### 36. `order_stage_hook_workorder_discovery_stage_hook_holding_flow_runner_debounce_guard`
...
- evidence: `strict_match_count=99`, `ambiguous_match_count=0`, `top_symbols=001740,001820,002220,005380,005680,005950,006660,007390`, `estimated_uplift_pct_sum=448.5900`, `gap=sim-only early stop/loss followed by later runner is not isolated as a dedicated producer`, `required_microstructure_features=ws_orderbook_churn,ofi_qi_persistence,large_trade_absorption,spread_flicker,top_depth_replenishment,holding_flow_cache_freshness`, `required_producer=runner_regime_counterfactual_producer`, `readiness_tier=implementation_workorder_ready`
- parity_contract: -
- next_postclose_metric: -
- files_likely_touched: `data/report/producer_gap_discovery/producer_gap_discovery_2026-05-28.json`, `data/report/stage_hooks/*.json`, `tests/stage_hooks/test_holding_flow_runner_debounce_guard*`
- acceptance_tests: `hook_input_output_contract_test passes on runner-regime samples.`, `forbidden_use_authority_test blocks all runtime and broker-order authority.`, `disabled_initial_runtime_state_test confirms the hook is inert at apply time.`, `Matched runner cases reproduce the source-quality EV signal without real-order dependence.`
- implementation_status: `implemented`
...
### 37. `order_stage_hook_workorder_discovery_stage_hook_plateau_breakdown_exit_arbitration_probe`
...
- target_subsystem: `exit arbitration`
- route: `existing_family`
- mapped_family: `-`
- threshold_family: `-`
...
- tuning_axis_effect: `False`
- expected_ev_effect: none_direct_until_separate_runtime_apply_candidate
- evidence: `strict_match_count=127`, `ambiguous_match_count=0`, `top_symbols=000990,001740,001820,002220,005680,006660,009150,009420`, `estimated_giveback_pct_sum=596.5400`, `gap=sim-only prior modest win followed by late stop/giveback is not isolated as a dedicated producer`, `required_producer=plateau_breakdown_exit_counterfactual_producer`, `readiness_tier=implementation_workorder_ready`
- parity_contract: -
- next_postclose_metric: -
- files_likely_touched: `data/report/producer_gap_discovery/producer_gap_discovery_2026-05-28.json`, `data/report/stage_hooks/*.json`, `tests/stage_hooks/test_plateau_breakdown_exit_arbitration_probe*`
- acceptance_tests: `hook_input_output_contract_test validates exit plateau-breakdown rows.`, `forbidden_use_authority_test blocks exit overrides and runtime changes.`, `disabled_initial_runtime_state_test confirms no live trading side effects.`, `Counterfactual producer reproduces the giveback pattern from sim/probe EV only.`
- implementation_status: `implemented`
...
### 38. `order_lifecycle_entry_bucket_chosen_action_action_unknown`
...
- implementation_status: `implemented`
- implementation_provenance: `{"recommended_resolution": "emit_or_backfill_source_field", "source_field_coverage": {"chosen_action": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 236, "source_fields": ["runtime_features.chosen_action"]}}, "unknown_reason_counts": {"missing_source_field": 1}}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 39. `order_lifecycle_entry_bucket_combo_entry_spot_score_score_66_69_source_wait6579_ev_cohort_stale_fresh_or_unflagged_liquidity_l`
...
### 40. `order_lifecycle_entry_bucket_combo_entry_spot_score_score_70p_source_wait6579_ev_cohort_stale_fresh_or_unflagged_liquidity_liq`
...
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM entry bucket candidates/workorders are not propagated`
- implementation_status: `implemented`
- implementation_provenance: `{"recommended_resolution": "emit_or_backfill_source_field", "source_field_coverage": {"exit_rule": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 486, "source_fields": ["labels.exit_rule"]}}, "unknown_reason_counts": {"missing_source_field": 1}}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 42. `order_lifecycle_entry_bucket_liquidity_bucket_liquidity_unknown`
...
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM entry bucket candidates/workorders are not propagated`
- implementation_status: `implemented`
- implementation_provenance: `{"recommended_resolution": "keep_collecting_post_instrumentation", "source_field_coverage": {"liquidity_bucket": {"coverage_rate": 0.528, "present_count": 264, "sample_count": 500, "source_fields": ["runtime_features.liquidity_bucket"]}}, "unknown_reason_counts": {"pre_instrumentation": 1}}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 43. `order_lifecycle_entry_bucket_overbought_bucket_overbought_unknown`
...
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM entry bucket candidates/workorders are not propagated`
- implementation_status: `implemented`
- implementation_provenance: `{"recommended_resolution": "keep_collecting_post_instrumentation", "source_field_coverage": {"overbought_bucket": {"coverage_rate": 0.3723, "present_count": 140, "sample_count": 376, "source_fields": ["runtime_features.overbought_bucket"]}}, "unknown_reason_counts": {"pre_instrumentation": 1}}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 44. `order_producer_gap_discovery_producer_gap_scale_in_counterfactual_gap_missing`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Improve source-quality adjusted EV attribution by making the missing producer observable.
- evidence: `matched_scale_in_gap_rows=1158`, `source_labels=lifecycle_decision_matrix,swing_lifecycle_bucket_discovery,swing_lifecycle_decision_matrix`, `gap=scale-in blocked/fill/unfill outcome comparison lacks a dedicated source producer`, `ai_priority=high`, `ai_route=implement_now`
- parity_contract: -
- next_postclose_metric: producer_gap_discovery.producer_gap_scale_in_counterfactual_gap_missing
- files_likely_touched: `src/producers/scale_in_counterfactual_producer.py`, `src/reports/producer_gap_discovery.py`, `data/report/swing_lifecycle_decision_matrix/swing_lifecycle_decision_matrix_2026-05-28.json`
- acceptance_tests: `Scale-in gap rows are isolated into a dedicated producer bucket.`, `No entry, exit, or cap authority is exposed.`, `The output is source-only and reproducible across windows.`
- implementation_status: `implemented`
- implementation_provenance: `{"allowed_runtime_apply": false, "implementation_type": "source_only_producer_gap_source_bundle", "join_keys": ["code", "entry_time", "scale_in_arm"], "missing_fields": [], "pattern_type": "scale_in_counterfactual_gap", "runtime_effect": false, "sample_count": 27, "section_id": "scale_in_counterfactual_gap", "source_paths": ["/home/ubuntu/KORStockScan/data/report/lifecycle_bucket_discovery/lifecycle_bucket_discovery_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_audit/swing_lifecycle_audit_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_decision_matrix/swing_lifecycle_decision_matrix_2026-05-28.json"], "source_quality_status": "implemented", "source_report_type": "producer_gap_source_bundle"}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 45. `order_producer_gap_discovery_producer_gap_sim_exit_plateau_breakdown_gap_missing`
...
- files_likely_touched: `src/producers/plateau_breakdown_exit_counterfactual_producer.py`, `src/reports/producer_gap_discovery.py`, `data/report/swing_lifecycle_bucket_discovery/swing_lifecycle_bucket_discovery_2026-05-28.json`
- acceptance_tests: `Plateau/breakdown rows are split into dedicated producer outputs.`, `No hard-stop or broker-order authority is introduced.`, `The source-only contract is preserved end to end.`
...
### 46. `order_producer_gap_discovery_producer_gap_sim_holding_runner_gap_missing`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Improve source-quality adjusted EV attribution by making the missing producer observable.
- evidence: `strict_match_count=99`, `ambiguous_match_count=0`, `top_symbols=001740,001820,002220,005380,005680,005950,006660,007390`, `estimated_uplift_pct_sum=448.5900`, `gap=sim-only early stop/loss followed by later runner is not isolated as a dedicated producer`, `required_microstructure_features=ws_orderbook_churn,ofi_qi_persistence,large_trade_absorption,spread_flicker,top_depth_replenishment,holding_flow_cache_freshness`, `required_producer=runner_regime_counterfactual_producer`, `ai_priority=high`, `ai_route=implement_now`
- parity_contract: -
- next_postclose_metric: producer_gap_discovery.producer_gap_sim_holding_runner_gap_missing
- files_likely_touched: `src/producers/runner_regime_counterfactual_producer.py`, `src/reports/producer_gap_discovery.py`, `data/post_sell/sim_post_sell_evaluations_2026-05-28.jsonl`
- acceptance_tests: `Runner outcomes can be partitioned by the added dimension without changing runtime rules.`, `The metric contract remains source-only and contains the required fields.`, `No stop/exit override language appears in the producer surface.`
- implementation_status: `implemented`
- implementation_provenance: `{"allowed_runtime_apply": false, "implementation_type": "source_only_producer_gap_source_bundle", "join_keys": ["sim_record_id", "code", "held_sec"], "missing_fields": [], "pattern_type": "sim_holding_runner_counterfactual", "runtime_effect": false, "sample_count": 1443, "section_id": "sim_holding_runner_counterfactual", "source_paths": ["/home/ubuntu/KORStockScan/data/report/lifecycle_bucket_discovery/lifecycle_bucket_discovery_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/lifecycle_decision_matrix/lifecycle_decision_matrix_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_audit/swing_lifecycle_audit_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_bucket_discovery/swing_lifecycle_bucket_discovery_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_decision_matrix/swing_lifecycle_decision_matrix_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_strategy_discovery_ev/swing_strategy_discovery_ev_2026-05-28.json"], "source_quality_status": "implemented", "source_report_type": "producer_gap_source_bundle"}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 47. `order_producer_gap_discovery_producer_gap_sim_scale_in_counterfactual_gap_missing`
...
- files_likely_touched: `src/producers/sim_scale_in_would_add_counterfactual_producer.py`, `src/reports/producer_gap_discovery.py`, `data/post_sell/sim_post_sell_evaluations_2026-05-28.jsonl`
- acceptance_tests: `Scale-in would-add rows are emitted by a dedicated producer.`, `No runtime apply or broker-order authority is present.`, `The producer contract includes the required source-only fields.`
- implementation_status: `implemented`
...
### 48. `order_producer_gap_discovery_producer_gap_sim_stop_recovery_gap_missing`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Improve source-quality adjusted EV attribution by making the missing producer observable.
- evidence: `sim_stop_or_loss_rows=1166`, `gap=sim stop/recovery variants need a sim-first source producer independent of real exits`, `required_producer=sim_stop_recovery_counterfactual_producer`, `ai_priority=high`, `ai_route=implement_now`
- parity_contract: -
- next_postclose_metric: producer_gap_discovery.producer_gap_sim_stop_recovery_gap_missing
- files_likely_touched: `src/producers/sim_stop_recovery_counterfactual_producer.py`, `src/reports/producer_gap_discovery.py`, `data/post_sell/sim_post_sell_candidates_2026-05-28.jsonl`
- acceptance_tests: `Stop/recovery variants are produced without real-order dependence.`, `No forbidden uses appear in the contract.`, `The producer output remains source-only and deterministic.`
- implementation_status: `implemented`
- implementation_provenance: `{"allowed_runtime_apply": false, "implementation_type": "source_only_producer_gap_source_bundle", "join_keys": ["sim_record_id", "code", "exit_reason"], "missing_fields": [], "pattern_type": "sim_stop_recovery_counterfactual", "runtime_effect": false, "sample_count": 2448, "section_id": "sim_stop_recovery_counterfactual", "source_paths": ["/home/ubuntu/KORStockScan/data/report/lifecycle_bucket_discovery/lifecycle_bucket_discovery_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/lifecycle_decision_matrix/lifecycle_decision_matrix_2026-05-28.json", "/home/ubuntu/KORStockScan/data/post_sell/sim_post_sell_candidates_2026-05-28.jsonl", "/home/ubuntu/KORStockScan/data/post_sell/sim_post_sell_evaluations_2026-05-28.jsonl", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_audit/swing_lifecycle_audit_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_bucket_discovery/swing_lifecycle_bucket_discovery_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_decision_matrix/swing_lifecycle_decision_matrix_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_strategy_discovery_ev/swing_strategy_discovery_ev_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/time_window_regime_counterfactual/time_window_regime_counterfactual_2026-05-28.json"], "source_quality_status": "implemented", "source_report_type": "producer_gap_source_bundle"}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 49. `order_producer_gap_discovery_producer_gap_stop_recovery_counterfactual_missing`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Improve source-quality adjusted EV attribution by making the missing producer observable.
- evidence: `matched_stop_exit_rows=106`, `symbols=000270,000660,000880,001740,001820,003670,005380,005490`, `gap=post-stop recovery is not isolated as a dedicated producer input`, `ai_priority=high`, `ai_route=implement_now`
- parity_contract: -
- next_postclose_metric: producer_gap_discovery.producer_gap_stop_recovery_counterfactual_missing
- files_likely_touched: `src/producers/stop_recovery_counterfactual_producer.py`, `src/reports/producer_gap_discovery.py`, `data/report/producer_gap_source_bundle/producer_gap_source_bundle_2026-05-28.json`
- acceptance_tests: `Matched stop-exit rows are partitioned into a dedicated stop-recovery producer output.`, `No forbidden use appears in the producer contract or downstream reporting.`, `Source-quality-adjusted EV and diagnostic win rate are produced without runtime apply authority.`
- implementation_status: `implemented`
- implementation_provenance: `{"allowed_runtime_apply": false, "implementation_type": "source_only_producer_gap_source_bundle", "join_keys": ["code", "sell_time", "exit_reason"], "missing_fields": [], "pattern_type": "stop_recovery_counterfactual", "runtime_effect": false, "sample_count": 570, "section_id": "stop_recovery_counterfactual", "source_paths": ["/home/ubuntu/KORStockScan/data/report/lifecycle_bucket_discovery/lifecycle_bucket_discovery_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/lifecycle_decision_matrix/lifecycle_decision_matrix_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_audit/swing_lifecycle_audit_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_bucket_discovery/swing_lifecycle_bucket_discovery_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_decision_matrix/swing_lifecycle_decision_matrix_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_strategy_discovery_ev/swing_strategy_discovery_ev_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/time_window_regime_counterfactual/time_window_regime_counterfactual_2026-05-28.json"], "source_quality_status": "implemented", "source_report_type": "producer_gap_source_bundle"}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 50. `order_producer_gap_discovery_producer_gap_swing_sim_probe_label_gap_missing`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Improve source-quality adjusted EV attribution by making the missing producer observable.
- evidence: `matched_swing_label_or_source_gap_rows=6420`, `source_labels=swing_lifecycle_audit,swing_lifecycle_bucket_discovery,swing_lifecycle_decision_matrix,swing_strategy_discovery_ev`, `gap=swing sim/probe label and EV handoff defects need a dedicated source producer`, `ai_priority=high`, `ai_route=implement_now`
- parity_contract: -
- next_postclose_metric: producer_gap_discovery.producer_gap_swing_sim_probe_label_gap_missing
- files_likely_touched: `src/producers/swing_lifecycle_label_handoff_producer.py`, `src/reports/producer_gap_discovery.py`, `data/report/swing_lifecycle_audit/swing_lifecycle_audit_2026-05-28.json`
- acceptance_tests: `Swing audit/matrix rows expose the label-gap dimension without changing runtime behavior.`, `Source-only evidence remains the primary basis for the producer output.`, `Existing swing artifacts remain the canonical family boundary.`
- implementation_status: `implemented`
- implementation_provenance: `{"allowed_runtime_apply": false, "implementation_type": "source_only_producer_gap_source_bundle", "join_keys": ["code", "date", "source_probe_id"], "missing_fields": [], "pattern_type": "swing_sim_probe_label_gap", "runtime_effect": false, "sample_count": 113, "section_id": "swing_sim_probe_label_gap", "source_paths": ["/home/ubuntu/KORStockScan/data/report/swing_lifecycle_audit/swing_lifecycle_audit_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_decision_matrix/swing_lifecycle_decision_matrix_2026-05-28.json"], "source_quality_status": "implemented", "source_report_type": "producer_gap_source_bundle"}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 51. `order_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_low_missing_held_missing_kospi_regime_stop_loss`
...
### 52. `order_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_2h_1d_kospi_trailing_start_take_profit`
...
### 53. `order_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_held_missing_kospi_trailing_start_take_profit`
...
### 54. `order_swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_confidence_weighted_trailing_after_mfe_computer_programmi`
...
### 55. `order_swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_confidence_weighted_trailing_after_mfe_insurance_보험_생명보험_`
...
### 57. `order_swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_confidence_weighted_trailing_after_mfe_manufacture_of_oth`

- title: Swing LDM source field follow-up: breakout_confirm_entry|confidence_weighted|trailing_after_mfe|Manufacture of Other Chemical Products|-|DIAGNOSTIC
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented_source_quality_contract_waiting_sample; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `swing_lifecycle_decision_matrix`
- lifecycle_stage: `selection`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Close Swing LDM bucket source-quality gaps while preserving sim-only authority.
- evidence: `section=discovery_arm_attribution`, `bucket_type=discovery_arm_attribution`, `bucket_key=breakout_confirm_entry|confidence_weighted|trailing_after_mfe|Manufacture of Other Chemical Products|-|DIAGNOSTIC`, `reason=source_quality_or_instrumentation_gap`, `implementation_status=implemented_source_quality_contract_waiting_sample`, `decision_authority=swing_ldm_source_only`, `actual_order_submitted=false`
- parity_contract: -
- next_postclose_metric: Swing LDM bucket should move from code_patch_required to source_only_keep_collecting or sim_auto_approved.
- files_likely_touched: `src/engine/swing_lifecycle_decision_matrix.py`, `src/engine/swing_lifecycle_bucket_discovery.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/pytest -q src/tests/test_swing_lifecycle_decision_matrix.py src/tests/test_swing_lifecycle_bucket_discovery.py`
...
- title: Swing LDM source field follow-up: breakout_confirm_entry|confidence_weighted|trailing_after_mfe|Manufacture of Parts and Accessories for Motor Vehicles(New Products)|그린카_하이브리드카/전기차,자동차_전장화 수혜,자동차_차량용 반도체|DIAGNOSTIC
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented_source_quality_contract_waiting_sample; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `swing_lifecycle_decision_matrix`
- lifecycle_stage: `selection`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Close Swing LDM bucket source-quality gaps while preserving sim-only authority.
- evidence: `section=discovery_arm_attribution`, `bucket_type=discovery_arm_attribution`, `bucket_key=breakout_confirm_entry|confidence_weighted|trailing_after_mfe|Manufacture of Parts and Accessories for Motor Vehicles(New Products)|그린카_하이브리드카/전기차,자동차_전장화 수혜,자동차_차량용 반도체|DIAGNOSTIC`, `reason=source_quality_or_instrumentation_gap`, `implementation_status=implemented_source_quality_contract_waiting_sample`, `decision_authority=swing_ldm_source_only`, `actual_order_submitted=false`
- parity_contract: -
- next_postclose_metric: Swing LDM bucket should move from code_patch_required to source_only_keep_collecting or sim_auto_approved.
- files_likely_touched: `src/engine/swing_lifecycle_decision_matrix.py`, `src/engine/swing_lifecycle_bucket_discovery.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/pytest -q src/tests/test_swing_lifecycle_decision_matrix.py src/tests/test_swing_lifecycle_bucket_discovery.py`
...
### 59. `order_swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_risk_capped_mae_stop_time_stop_manufacture_of_basic_chemi`
...
### 60. `order_swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_risk_capped_mae_stop_time_stop_manufacture_of_electronic_`

- title: Swing LDM source field follow-up: breakout_confirm_entry|risk_capped|mae_stop_time_stop|Manufacture of Electronic Components|LCD_부품,LED,무선충전기관련주|DIAGNOSTIC
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented_source_quality_contract_waiting_sample; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `swing_lifecycle_decision_matrix`
- lifecycle_stage: `selection`
...
### 61. `order_swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_risk_capped_mae_stop_time_stop_manufacture_of_medicaments`

- title: Swing LDM source field follow-up: breakout_confirm_entry|risk_capped|mae_stop_time_stop|Manufacture of Medicaments|-|DIAGNOSTIC
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented_source_quality_contract_waiting_sample; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `swing_lifecycle_decision_matrix`
- lifecycle_stage: `selection`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Close Swing LDM bucket source-quality gaps while preserving sim-only authority.
- evidence: `section=discovery_arm_attribution`, `bucket_type=discovery_arm_attribution`, `bucket_key=breakout_confirm_entry|risk_capped|mae_stop_time_stop|Manufacture of Medicaments|-|DIAGNOSTIC`, `reason=source_quality_or_instrumentation_gap`, `implementation_status=implemented_source_quality_contract_waiting_sample`, `decision_authority=swing_ldm_source_only`, `actual_order_submitted=false`
- parity_contract: -
- next_postclose_metric: Swing LDM bucket should move from code_patch_required to source_only_keep_collecting or sim_auto_approved.
- files_likely_touched: `src/engine/swing_lifecycle_decision_matrix.py`, `src/engine/swing_lifecycle_bucket_discovery.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/pytest -q src/tests/test_swing_lifecycle_decision_matrix.py src/tests/test_swing_lifecycle_bucket_discovery.py`
...
### 62. `order_swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_risk_capped_mae_stop_time_stop_real_estate_activities_wit`
...
### 63. `order_swing_ldm_selection_discovery_arm_attribution_pullback_limit_entry_risk_capped_mae_stop_time_stop_manufacture_of_electronic_co`
...
### 64. `order_swing_ldm_selection_discovery_arm_attribution_pullback_limit_entry_risk_capped_mae_stop_time_stop_manufacture_of_medicaments_d`
...
### 65. `order_swing_ldm_selection_discovery_arm_attribution_pullback_limit_entry_risk_capped_mae_stop_time_stop_manufacture_of_other_chemica`
...
### 66. `order_swing_ldm_selection_discovery_arm_attribution_pullback_limit_entry_risk_capped_mae_stop_time_stop_other_financial_intermediati`
...
### 67. `order_swing_lifecycle_bucket_discovery_swing_bucket_holding_exit_holding_exit_bucket_attribution_mfe_low_missing_held_m`
...
### 68. `order_swing_lifecycle_bucket_discovery_swing_bucket_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_2h_1d_`
...
### 69. `order_swing_lifecycle_bucket_discovery_swing_bucket_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_held_m`
...
- title: Swing lifecycle bucket discovery handoff follow-up: swing_bucket_selection_discovery_arm_attribution_breakout_confirm_entry_risk_capped_mae_stop_time_stop_real_estate_a_cdf9bfddc19d
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented_source_quality_contract_waiting_sample; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `swing_lifecycle_bucket_discovery`
- lifecycle_stage: `source_quality`
...
### 73. `order_swing_lifecycle_bucket_discovery_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_low_missing_held_miss`
...
### 74. `order_swing_lifecycle_bucket_discovery_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_2h_1d_kos`
...
### 75. `order_swing_lifecycle_bucket_discovery_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_held_miss`
...
### 76. `order_swing_lifecycle_bucket_discovery_swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_confidence_`
...
### 77. `order_swing_lifecycle_bucket_discovery_swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_risk_capped`
...
### 78. `order_swing_lifecycle_bucket_discovery_swing_ldm_selection_discovery_arm_attribution_pullback_limit_entry_risk_capped_m`
...
### 79. `order_lifecycle_scale_in_bucket_ai_score_band_score_63_65`
...
### 80. `order_lifecycle_scale_in_bucket_ai_score_band_score_66_69`
...
### 81. `order_lifecycle_scale_in_bucket_ai_score_band_score_70p`
...
### 82. `order_lifecycle_scale_in_bucket_ai_score_band_score_lt60`
...
### 83. `order_lifecycle_scale_in_bucket_ai_score_source_ai_source_unknown`
...
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM scale-in bucket candidates/workorders are not propagated`
- implementation_status: `implemented`
- implementation_provenance: `{"recommended_resolution": "emit_or_backfill_source_field", "source_field_coverage": {"ai_score_source": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 20128, "source_fields": ["runtime_features.ai_score_source"]}}, "unknown_reason_counts": {"missing_source_field": 1}}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 84. `order_lifecycle_scale_in_bucket_arm_arm_unknown`
...
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM scale-in bucket candidates/workorders are not propagated`
- implementation_status: `implemented`
- implementation_provenance: `{"recommended_resolution": "emit_or_backfill_source_field", "source_field_coverage": {"arm": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 8882, "source_fields": ["runtime_features.scale_in_arm", "runtime_features.add_type"]}}, "unknown_reason_counts": {"missing_source_field": 1}}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 85. `order_lifecycle_scale_in_bucket_arm_avg_down`
...
### 86. `order_lifecycle_scale_in_bucket_arm_pyramid`
...
### 87. `order_lifecycle_scale_in_bucket_blocker_namespace_avg_down`
...
### 88. `order_lifecycle_scale_in_bucket_blocker_namespace_blocker_namespace_unknown`
...
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM scale-in bucket candidates/workorders are not propagated`
- implementation_status: `implemented`
- implementation_provenance: `{"recommended_resolution": "emit_or_backfill_source_field", "source_field_coverage": {"blocker_namespace": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 8883, "source_fields": ["runtime_features.scale_in_blocker_namespace"]}}, "unknown_reason_counts": {"missing_source_field": 1}}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 89. `order_lifecycle_entry_bucket_chosen_action_no_buy_ai`
...
### 90. `order_lifecycle_entry_bucket_score_band_score_66_69`
...
### 91. `order_lifecycle_entry_bucket_score_band_score_70p`
...
### 92. `order_lifecycle_entry_bucket_source_stage_wait6579_ev_cohort`
