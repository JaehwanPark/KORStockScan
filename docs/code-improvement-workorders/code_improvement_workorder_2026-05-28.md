...
- generated_at: `2026-05-28T16:41:45+09:00`
...
- swing_lifecycle_bucket_discovery_source_order_count: `18`
...
- source_decision_counts: `{'implement_now': 19, 'attach_existing_family': 113, 'design_family_candidate': 7, 'defer_evidence': 10, 'reject': 3}`
- selected_decision_counts: `{'implement_now': 19, 'attach_existing_family': 93}`
- selected_route_counts: `{'instrumentation_order': 15, 'review_ai_output': 1, 'implement_now': 3, 'existing_family': 93}`
- selected_implement_now_route_count: `3`
- selected_runtime_effect_false_count: `112`
- selected_unimplemented_runtime_effect_false_count: `19`
- selected_unimplemented_route_counts: `{'instrumentation_order': 15, 'review_ai_output': 1, 'implement_now': 3}`
- non_selected_decision_counts: `{'attach_existing_family': 20, 'design_family_candidate': 7, 'defer_evidence': 10, 'reject': 3}`
- gemini_fresh: `True`
- claude_fresh: `True`
...
- `duplicate_order_id=order_swing_lifecycle_bucket_discovery_swing_bucket_holding_exit_holding_exit_bucket_attribution_mfe_low_missing_held_m source=swing_lifecycle_bucket_discovery stage=source_quality`
...
- `duplicate_order_id=order_swing_lifecycle_bucket_discovery_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_low_missing_held_miss source=swing_lifecycle_bucket_discovery stage=holding_exit`
...
### 1. `order_lifecycle_exit_bucket_combo_exit_result_source_scalp_sim_partial_sell_order_assumed_filled_rule_scalp_sim_panic_4b4d95ef`
...
### 2. `order_lifecycle_exit_bucket_combo_exit_result_source_scalp_sim_partial_sell_order_assumed_filled_rule_scalp_sim_panic_54959057`
...
### 6. `order_lifecycle_holding_bucket_combo_holding_flow_source_scalp_sim_holding_started_action_holding_action_unknown_profit_p_6f63e810`
...
### 7. `order_lifecycle_holding_bucket_combo_holding_flow_source_scalp_sim_holding_started_action_holding_action_unknown_profit_p_96e568f2`

- title: LDM holding bucket source-quality follow-up: combo_holding_flow=source=scalp_sim_holding_started|action=holding_action_unknown|profit=profit_pos150_pos300|held=held_unknown
- decision: `implement_now`
- decision_reason: instrumentation/provenance work can improve attribution without direct runtime mutation
- source_report_type: `lifecycle_decision_matrix_holding_bucket_attribution`
- lifecycle_stage: `holding`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep holding stage buckets visible as child evidence while parent lifecycle flow owns promotion EV.
- evidence: `workorder_id=holding_bucket_source_quality_5`, `bucket_type=combo_holding_flow`, `bucket_key=source=scalp_sim_holding_started|action=holding_action_unknown|profit=profit_pos150_pos300|held=held_unknown`, `reason=holding_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`, `recommended_route=source_quality_workorder`, `runtime_effect=false`, `allowed_runtime_apply=false`, `stage_only_live_promotion_forbidden=true`
- parity_contract: -
- next_postclose_metric: holding_bucket_attribution bucket/workorder counts, identity join rate, and complete lifecycle flow count remain visible in downstream reports.
- files_likely_touched: -
- acceptance_tests: -
- implementation_status: `open`
- implementation_provenance: `{"ai_inference_proposal": {"allowed_runtime_apply": false, "bucket_key": "source=scalp_sim_holding_started|action=holding_action_unknown|profit=profit_pos150_pos300|held=held_unknown", "bucket_type": "combo_holding_flow", "decision_point": "holding_bucket_classification", "deterministic_decision": "source_quality_workorder", "model": "gpt-5.4-mini", "proposal_type": "ai_inference_parallel_review_required", "reason": "parallel_ai_inference_for_deterministic_bucket_decision", "reasoning_effort": "medium", "review_contract": {"ai_has_promotion_authority": false, "model": "gpt-5.4", "reasoning_effort": "low", "runtime_effect": false}, "runtime_effect": false, "source_quality_gate": "pass"}, "recommended_resolution": "mark_not_applicable_explicitly", "source_field_coverage": {"action": {"coverage_rate": 1.0, "present_count": 11, "sample_count": 11, "source_fields": ["source_stage", "runtime_features.chosen_action", "runtime_features.ai_action", "runtime_features.profit_rate_live", "runtime_features.held_sec"]}, "held": {"coverage_rate": 1.0, "present_count": 11, "sample_count": 11, "source_fields": ["source_stage", "runtime_features.chosen_action", "runtime_features.ai_action", "runtime_features.profit_rate_live", "runtime_features.held_sec"]}}, "unknown_reason_counts": {"not_applicable": 2}}`
- automation_reentry: After implementation, next postclose report must show source freshness or warning reduction.
...
### 8. `order_lifecycle_holding_bucket_combo_holding_flow_source_scalp_sim_holding_started_action_holding_action_unknown_profit_p_9b5897ca`
...
- acceptance_tests: -
- implementation_status: `open`
- implementation_provenance: `{"ai_inference_proposal": {"allowed_runtime_apply": false, "bucket_key": "source=scalp_sim_holding_started|action=holding_action_unknown|profit=profit_pos080_pos150|held=held_unknown", "bucket_type": "combo_holding_flow", "decision_point": "holding_bucket_classification", "deterministic_decision": "source_quality_workorder", "model": "gpt-5.4-mini", "proposal_type": "ai_inference_parallel_review_required", "reason": "parallel_ai_inference_for_deterministic_bucket_decision", "reasoning_effort": "medium", "review_contract": {"ai_has_promotion_authority": false, "model": "gpt-5.4", "reasoning_effort": "low", "runtime_effect": false}, "runtime_effect": false, "source_quality_gate": "pass"}, "recommended_resolution": "mark_not_applicable_explicitly", "source_field_coverage": {"action": {"coverage_rate": 1.0, "present_count": 9, "sample_count": 9, "source_fields": ["source_stage", "runtime_features.chosen_action", "runtime_features.ai_action", "runtime_features.profit_rate_live", "runtime_features.held_sec"]}, "held": {"coverage_rate": 1.0, "present_count": 9, "sample_count": 9, "source_fields": ["source_stage", "runtime_features.chosen_action", "runtime_features.ai_action", "runtime_features.profit_rate_live", "runtime_features.held_sec"]}}, "unknown_reason_counts": {"not_applicable": 2}}`
- automation_reentry: After implementation, next postclose report must show source freshness or warning reduction.
...
### 9. `order_lifecycle_holding_bucket_combo_holding_flow_source_scalp_sim_holding_started_action_holding_action_unknown_profit_p_c6db79d9`
...
- acceptance_tests: -
- implementation_status: `open`
- implementation_provenance: `{"ai_inference_proposal": {"allowed_runtime_apply": false, "bucket_key": "source=scalp_sim_holding_started|action=holding_action_unknown|profit=profit_lt_neg070|held=held_unknown", "bucket_type": "combo_holding_flow", "decision_point": "holding_bucket_classification", "deterministic_decision": "source_quality_workorder", "model": "gpt-5.4-mini", "proposal_type": "ai_inference_parallel_review_required", "reason": "parallel_ai_inference_for_deterministic_bucket_decision", "reasoning_effort": "medium", "review_contract": {"ai_has_promotion_authority": false, "model": "gpt-5.4", "reasoning_effort": "low", "runtime_effect": false}, "runtime_effect": false, "source_quality_gate": "pass"}, "recommended_resolution": "mark_not_applicable_explicitly", "source_field_coverage": {"action": {"coverage_rate": 1.0, "present_count": 38, "sample_count": 38, "source_fields": ["source_stage", "runtime_features.chosen_action", "runtime_features.ai_action", "runtime_features.profit_rate_live", "runtime_features.held_sec"]}, "held": {"coverage_rate": 1.0, "present_count": 38, "sample_count": 38, "source_fields": ["source_stage", "runtime_features.chosen_action", "runtime_features.ai_action", "runtime_features.profit_rate_live", "runtime_features.held_sec"]}}, "unknown_reason_counts": {"not_applicable": 2}}`
- automation_reentry: After implementation, next postclose report must show source freshness or warning reduction.
...
### 10. `order_lifecycle_holding_bucket_combo_holding_flow_source_scalp_sim_holding_started_action_holding_action_unknown_profit_p_c9a72bc6`
...
- acceptance_tests: -
- implementation_status: `open`
- implementation_provenance: `{"ai_inference_proposal": {"allowed_runtime_apply": false, "bucket_key": "source=scalp_sim_holding_started|action=holding_action_unknown|profit=profit_pos150_pos300_plus|held=held_unknown", "bucket_type": "combo_holding_flow", "decision_point": "holding_bucket_classification", "deterministic_decision": "source_quality_workorder", "model": "gpt-5.4-mini", "proposal_type": "ai_inference_parallel_review_required", "reason": "parallel_ai_inference_for_deterministic_bucket_decision", "reasoning_effort": "medium", "review_contract": {"ai_has_promotion_authority": false, "model": "gpt-5.4", "reasoning_effort": "low", "runtime_effect": false}, "runtime_effect": false, "source_quality_gate": "pass"}, "recommended_resolution": "mark_not_applicable_explicitly", "source_field_coverage": {"action": {"coverage_rate": 1.0, "present_count": 4, "sample_count": 4, "source_fields": ["source_stage", "runtime_features.chosen_action", "runtime_features.ai_action", "runtime_features.profit_rate_live", "runtime_features.held_sec"]}, "held": {"coverage_rate": 1.0, "present_count": 4, "sample_count": 4, "source_fields": ["source_stage", "runtime_features.chosen_action", "runtime_features.ai_action", "runtime_features.profit_rate_live", "runtime_features.held_sec"]}}, "unknown_reason_counts": {"not_applicable": 2}}`
- automation_reentry: After implementation, next postclose report must show source freshness or warning reduction.
...
### 11. `order_lifecycle_holding_bucket_combo_holding_flow_source_scalp_sim_holding_started_action_wait_profit_profit_lt_neg070_he_cfc98129`
...
### 12. `order_lifecycle_holding_bucket_combo_holding_flow_source_scalp_sim_holding_started_action_wait_profit_profit_neg010_pos08_9ba67c14`
...
### 16. `order_pattern_lab_ai_review_ai_review_followup_2026_05_28`
...
### 17. `order_producer_gap_discovery_producer_gap_missed_fill_recovery_counterfactual_missing`
...
- target_subsystem: `scalping/submit`
- route: `implement_now`
- mapped_family: `-`
- threshold_family: `-`
...
- files_likely_touched: `src/report/producer_gap_discovery.py`, `src/report/producers/missed_fill_recovery_counterfactual_producer.py`, `data/report/lifecycle_decision_matrix/lifecycle_decision_matrix_2026-05-28.json`
- acceptance_tests: `Rows with missed-fill recovery map to the new source-only bucket.`, `No order-submit or broker authority is emitted.`, `Forbidden-use list is preserved unchanged.`
- implementation_status: `-`
- implementation_provenance: `-`
...
### 18. `order_producer_gap_discovery_producer_gap_sim_entry_selection_gap_missing`
...
- target_subsystem: `scalping/entry`
- route: `implement_now`
- mapped_family: `-`
- threshold_family: `-`
...
- files_likely_touched: `src/report/producer_gap_discovery.py`, `src/report/producers/sim_entry_selection_producer.py`, `data/report/post_sell/sim_post_sell_candidates_2026-05-28.jsonl`
- acceptance_tests: `Entry rows receive the new provenance dimension.`, `No new runtime authority is introduced.`, `The producer remains source-only and auditable.`
- implementation_status: `-`
- implementation_provenance: `-`
- automation_reentry: After implementation, rerun producer_gap_discovery, code improvement workorder, threshold EV, runtime summary, and postclose verifier.
...
### 19. `order_pattern_lab_ai_review_order_pattern_lab_ai_review_swing_lifecycle_bucket_discovery`

- title: Pattern Lab AI review follow-up: order_pattern_lab_ai_review_swing_lifecycle_bucket_discovery
- decision: `implement_now`
- decision_reason: pattern lab audit/review/observability order is report/source-quality instrumentation only and must remain runtime_effect=false
- source_report_type: `pattern_lab_ai_review`
...
### 26. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_10_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_70c74920`
...
### 27. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_11_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_5c4afb97`

- title: LDM lifecycle flow bucket follow-up: lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_70p_source_bloc:e63a874037
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `lifecycle_decision_matrix_lifecycle_flow_bucket_attribution`
- lifecycle_stage: `lifecycle_flow`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_11`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_70p_source_bloc:e63a874037`, `reason=incomplete_lifecycle_flow`, `join_gap_reasons=['missing_submit', 'missing_holding', 'missing_exit', 'candidate_id_only']`, `required_producer_consumer_candidates=['entry producer', 'submit observation', 'holding flow', 'exit/post-sell feedback', 'bridge key normalizer']`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 28. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_12_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_70c74920`
...
### 29. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_13_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_70c74920`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_13`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_60_62_source_bl:83c74e766d`, `reason=incomplete_lifecycle_flow`, `join_gap_reasons=['missing_submit', 'missing_holding', 'missing_exit', 'candidate_id_only']`, `required_producer_consumer_candidates=['entry producer', 'submit observation', 'holding flow', 'exit/post-sell feedback', 'bridge key normalizer']`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 30. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_14_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_05850e2c`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_14`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_blo:5afa7ecf4e`, `reason=incomplete_lifecycle_flow`, `join_gap_reasons=['missing_submit', 'missing_holding', 'missing_exit', 'candidate_id_only']`, `required_producer_consumer_candidates=['entry producer', 'submit observation', 'holding flow', 'exit/post-sell feedback', 'bridge key normalizer']`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 31. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_15_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_32463a04`
...
### 32. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_16_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_32463a04`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_16`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_blo:fcd588ff6c`, `reason=incomplete_lifecycle_flow`, `join_gap_reasons=['missing_submit', 'missing_holding', 'missing_exit', 'candidate_id_only']`, `required_producer_consumer_candidates=['entry producer', 'submit observation', 'holding flow', 'exit/post-sell feedback', 'bridge key normalizer']`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 33. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_17_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_70c74920`
...
### 34. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_18_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_70c74920`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_18`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_60_62_source_bl:83c74e766d`, `reason=incomplete_lifecycle_flow`, `join_gap_reasons=['missing_submit', 'missing_holding', 'missing_exit', 'candidate_id_only']`, `required_producer_consumer_candidates=['entry producer', 'submit observation', 'holding flow', 'exit/post-sell feedback', 'bridge key normalizer']`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_19`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_blo:fcd588ff6c`, `reason=incomplete_lifecycle_flow`, `join_gap_reasons=['missing_submit', 'missing_holding', 'missing_exit', 'candidate_id_only']`, `required_producer_consumer_candidates=['entry producer', 'submit observation', 'holding flow', 'exit/post-sell feedback', 'bridge key normalizer']`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 36. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_1_lifecycle_flow_combo_lifecycle_flow_entry_entry_missing_submit_submit_c_264969e0`
...
### 37. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_20_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_70c74920`
...
### 38. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_2_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_78f88b94`

- title: LDM lifecycle flow bucket follow-up: lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_60_62_source_ai:5c45db6e34
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `lifecycle_decision_matrix_lifecycle_flow_bucket_attribution`
- lifecycle_stage: `lifecycle_flow`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_2`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_60_62_source_ai:5c45db6e34`, `reason=incomplete_lifecycle_flow`, `join_gap_reasons=['missing_submit', 'missing_holding', 'missing_exit', 'candidate_id_only']`, `required_producer_consumer_candidates=['entry producer', 'submit observation', 'holding flow', 'exit/post-sell feedback', 'bridge key normalizer']`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 39. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_3_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_32463a04`
...
### 40. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_4_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_32463a04`
...
### 41. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_5_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_70c74920`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_5`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_60_62_source_bl:83c74e766d`, `reason=incomplete_lifecycle_flow`, `join_gap_reasons=['missing_submit', 'missing_holding', 'missing_exit', 'candidate_id_only']`, `required_producer_consumer_candidates=['entry producer', 'submit observation', 'holding flow', 'exit/post-sell feedback', 'bridge key normalizer']`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 42. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_6_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_05850e2c`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_6`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_blo:5afa7ecf4e`, `reason=incomplete_lifecycle_flow`, `join_gap_reasons=['missing_submit', 'missing_holding', 'missing_exit', 'candidate_id_only']`, `required_producer_consumer_candidates=['entry producer', 'submit observation', 'holding flow', 'exit/post-sell feedback', 'bridge key normalizer']`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 43. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_7_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_70c74920`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_7`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_60_62_source_bl:83c74e766d`, `reason=incomplete_lifecycle_flow`, `join_gap_reasons=['missing_submit', 'missing_holding', 'missing_exit', 'candidate_id_only']`, `required_producer_consumer_candidates=['entry producer', 'submit observation', 'holding flow', 'exit/post-sell feedback', 'bridge key normalizer']`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 44. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_8_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_70c74920`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_8`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_60_62_source_bl:83c74e766d`, `reason=incomplete_lifecycle_flow`, `join_gap_reasons=['missing_submit', 'missing_holding', 'missing_exit', 'candidate_id_only']`, `required_producer_consumer_candidates=['entry producer', 'submit observation', 'holding flow', 'exit/post-sell feedback', 'bridge key normalizer']`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
### 45. `order_lifecycle_flow_bucket_lifecycle_flow_bucket_incomplete_9_lifecycle_flow_combo_lifecycle_flow_entry_entry_combo_entry_spot_score_70c74920`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_9`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_60_62_source_bl:83c74e766d`, `reason=incomplete_lifecycle_flow`, `join_gap_reasons=['missing_submit', 'missing_holding', 'missing_exit', 'candidate_id_only']`, `required_producer_consumer_candidates=['entry producer', 'submit observation', 'holding flow', 'exit/post-sell feedback', 'bridge key normalizer']`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
- lifecycle_stage: `holding`
- target_subsystem: `holding-stage runtime arbitration / runner regime source producer`
- route: `existing_family`
- mapped_family: `-`
- threshold_family: `-`
...
- files_likely_touched: `data/report/producer_gap_discovery/producer_gap_discovery_2026-05-28.json`, `src/hooks/holding/holding_flow_runner_debounce_guard*`, `tests/hooks/test_holding_flow_runner_debounce_guard*`, `src/producers/runner_regime_counterfactual_producer*`, `src/features/microstructure*`
- acceptance_tests: `strict_match_count remains supported and ambiguous_match_count stays 0.`, `All required microstructure features are present in producer output.`, `hook_input_output_contract_test passes without runtime effect.`, `forbidden_use_authority_test blocks order/provider/threshold mutation.`
- implementation_status: `implemented`
...
- source_report_type: `stage_hook_workorder_discovery`
- lifecycle_stage: `exit`
- target_subsystem: `exit-stage arbitration / plateau-breakdown source producer`
- route: `existing_family`
- mapped_family: `-`
- threshold_family: `-`
...
- parity_contract: -
- next_postclose_metric: -
- files_likely_touched: `data/report/producer_gap_discovery/producer_gap_discovery_2026-05-28.json`, `src/hooks/exit/plateau_breakdown_exit_arbitration_probe*`, `tests/hooks/test_plateau_breakdown_exit_arbitration_probe*`, `src/producers/plateau_breakdown_exit_counterfactual_producer*`
- acceptance_tests: `strict_match_count and ambiguous_match_count checks are preserved.`, `hook_input_output_contract_test passes with review-only labels.`, `disabled_initial_runtime_state_test confirms no runtime effect.`, `forbidden_use_authority_test blocks exit overrides and runtime mutation.`
- implementation_status: `implemented`
...
- implementation_status: `implemented`
- implementation_provenance: `{"recommended_resolution": "emit_or_backfill_source_field", "source_field_coverage": {"chosen_action": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 252, "source_fields": ["runtime_features.chosen_action"]}}, "unknown_reason_counts": {"missing_source_field": 1}}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM entry bucket candidates/workorders are not propagated`
- implementation_status: `implemented`
- implementation_provenance: `{"recommended_resolution": "emit_or_backfill_source_field", "source_field_coverage": {"liquidity": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 21, "source_fields": ["runtime_features.liquidity_bucket"]}, "overbought": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 21, "source_fields": ["runtime_features.overbought_bucket"]}, "time": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 21, "source_fields": ["runtime_features.time_bucket"]}}, "unknown_reason_counts": {"missing_source_field": 3}}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM entry bucket candidates/workorders are not propagated`
- implementation_status: `implemented`
- implementation_provenance: `{"recommended_resolution": "emit_or_backfill_source_field", "source_field_coverage": {"exit_rule": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 534, "source_fields": ["labels.exit_rule"]}}, "unknown_reason_counts": {"missing_source_field": 1}}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM entry bucket candidates/workorders are not propagated`
- implementation_status: `implemented`
- implementation_provenance: `{"recommended_resolution": "keep_collecting_post_instrumentation", "source_field_coverage": {"liquidity_bucket": {"coverage_rate": 0.5418, "present_count": 298, "sample_count": 550, "source_fields": ["runtime_features.liquidity_bucket"]}}, "unknown_reason_counts": {"pre_instrumentation": 1}}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM entry bucket candidates/workorders are not propagated`
- implementation_status: `implemented`
- implementation_provenance: `{"recommended_resolution": "keep_collecting_post_instrumentation", "source_field_coverage": {"overbought_bucket": {"coverage_rate": 0.4014, "present_count": 169, "sample_count": 421, "source_fields": ["runtime_features.overbought_bucket"]}}, "unknown_reason_counts": {"pre_instrumentation": 1}}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 56. `order_lifecycle_exit_bucket_combo_exit_result_source_sim_post_sell_evaluation_rule_scalp_hard_stop_pct_outcome_neutra_d5168c3c`
...
### 57. `order_lifecycle_exit_bucket_combo_exit_result_source_sim_post_sell_evaluation_rule_scalp_soft_stop_pct_outcome_good_e_71b132b9`
...
### 59. `order_producer_gap_discovery_producer_gap_scale_in_counterfactual_gap_missing`
...
- target_subsystem: `cross-domain/scale-in`
- route: `existing_family`
- mapped_family: `-`
- threshold_family: `-`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Improve source-quality adjusted EV attribution by making the missing producer observable.
- evidence: `matched_scale_in_gap_rows=1524`, `source_labels=lifecycle_decision_matrix,swing_lifecycle_bucket_discovery,swing_lifecycle_decision_matrix`, `gap=scale-in blocked/fill/unfill outcome comparison lacks a dedicated source producer`, `ai_priority=high`, `ai_route=implement_now`
- parity_contract: -
- next_postclose_metric: producer_gap_discovery.producer_gap_scale_in_counterfactual_gap_missing
- files_likely_touched: `src/report/producer_gap_discovery.py`, `src/report/producers/scale_in_counterfactual_producer.py`, `data/report/lifecycle_decision_matrix/lifecycle_decision_matrix_2026-05-28.json`
- acceptance_tests: `Scale-in rows land in a dedicated counterfactual bucket.`, `No runtime or broker authority is surfaced.`, `Cross-domain source lineage is preserved.`
- implementation_status: `implemented`
...
### 60. `order_producer_gap_discovery_producer_gap_sim_exit_plateau_breakdown_gap_missing`
...
- source_report_type: `producer_gap_discovery`
- lifecycle_stage: `exit`
- target_subsystem: `scalping/exit`
- route: `existing_family`
- mapped_family: `-`
- threshold_family: `-`
...
- files_likely_touched: `src/report/producer_gap_discovery.py`, `src/report/producers/plateau_breakdown_counterfactual_producer.py`, `data/report/swing_lifecycle_decision_matrix/swing_lifecycle_decision_matrix_2026-05-28.json`
- acceptance_tests: `Plateau breakdown rows are separated from ordinary exits.`, `No hard-stop override appears in output.`, `The producer remains source-only.`
...
### 61. `order_producer_gap_discovery_producer_gap_sim_holding_runner_gap_missing`
...
- source_report_type: `producer_gap_discovery`
- lifecycle_stage: `holding`
- target_subsystem: `scalping/holding`
- route: `existing_family`
- mapped_family: `-`
- threshold_family: `-`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Improve source-quality adjusted EV attribution by making the missing producer observable.
- evidence: `strict_match_count=123`, `ambiguous_match_count=0`, `top_symbols=001740,001820,002220,005380,005680,005950,006660,007390`, `estimated_uplift_pct_sum=588.2600`, `gap=sim-only early stop/loss followed by later runner is not isolated as a dedicated producer`, `required_microstructure_features=ws_orderbook_churn,ofi_qi_persistence,large_trade_absorption,spread_flicker,top_depth_replenishment,holding_flow_cache_freshness`, `required_producer=runner_regime_counterfactual_producer`, `ai_priority=high`, `ai_route=implement_now`
- parity_contract: -
- next_postclose_metric: producer_gap_discovery.producer_gap_sim_holding_runner_gap_missing
- files_likely_touched: `src/report/producer_gap_discovery.py`, `src/report/producers/runner_regime_counterfactual_producer.py`, `data/report/swing_lifecycle_bucket_discovery/swing_lifecycle_bucket_discovery_2026-05-28.json`
- acceptance_tests: `Holding/runner rows can be separated by the new microstructure dimensions.`, `No exit authority or trailing-rule override is emitted.`, `Source-only EV remains the primary metric.`
- implementation_status: `implemented`
- implementation_provenance: `{"allowed_runtime_apply": false, "implementation_type": "source_only_producer_gap_source_bundle", "join_keys": ["sim_record_id", "code", "held_sec"], "missing_fields": [], "pattern_type": "sim_holding_runner_counterfactual", "runtime_effect": false, "sample_count": 2182, "section_id": "sim_holding_runner_counterfactual", "source_paths": ["/home/ubuntu/KORStockScan/data/report/lifecycle_bucket_discovery/lifecycle_bucket_discovery_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/lifecycle_decision_matrix/lifecycle_decision_matrix_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_audit/swing_lifecycle_audit_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_bucket_discovery/swing_lifecycle_bucket_discovery_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_decision_matrix/swing_lifecycle_decision_matrix_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_strategy_discovery_ev/swing_strategy_discovery_ev_2026-05-28.json"], "source_quality_status": "implemented", "source_report_type": "producer_gap_source_bundle"}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 62. `order_producer_gap_discovery_producer_gap_sim_scale_in_counterfactual_gap_missing`
...
- files_likely_touched: `src/report/producer_gap_discovery.py`, `src/report/producers/sim_scale_in_would_add_counterfactual_producer.py`, `data/report/post_sell/sim_post_sell_candidates_2026-05-28.jsonl`
- acceptance_tests: `Scale-in would-add rows are isolated into a dedicated source-only bucket.`, `No broker or order-submit authority is emitted.`, `The evidence source remains sim/probe lifecycle EV.`
- implementation_status: `implemented`
...
### 63. `order_producer_gap_discovery_producer_gap_sim_stop_recovery_gap_missing`
...
- files_likely_touched: `src/report/producer_gap_discovery.py`, `src/report/producers/sim_stop_recovery_counterfactual_producer.py`, `data/report/post_sell/sim_post_sell_evaluations_2026-05-28.jsonl`
- acceptance_tests: `Sim stop/recovery rows map to the new bucket.`, `Real samples do not become primary EV evidence.`, `No runtime apply path is created.`
- implementation_status: `implemented`
- implementation_provenance: `{"allowed_runtime_apply": false, "implementation_type": "source_only_producer_gap_source_bundle", "join_keys": ["sim_record_id", "code", "exit_reason"], "missing_fields": [], "pattern_type": "sim_stop_recovery_counterfactual", "runtime_effect": false, "sample_count": 2773, "section_id": "sim_stop_recovery_counterfactual", "source_paths": ["/home/ubuntu/KORStockScan/data/report/lifecycle_bucket_discovery/lifecycle_bucket_discovery_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/lifecycle_decision_matrix/lifecycle_decision_matrix_2026-05-28.json", "/home/ubuntu/KORStockScan/data/post_sell/post_sell_candidates_2026-05-28.jsonl", "/home/ubuntu/KORStockScan/data/post_sell/sim_post_sell_candidates_2026-05-28.jsonl", "/home/ubuntu/KORStockScan/data/post_sell/sim_post_sell_evaluations_2026-05-28.jsonl", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_audit/swing_lifecycle_audit_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_bucket_discovery/swing_lifecycle_bucket_discovery_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_decision_matrix/swing_lifecycle_decision_matrix_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_strategy_discovery_ev/swing_strategy_discovery_ev_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/time_window_regime_counterfactual/time_window_regime_counterfactual_2026-05-28.json"], "source_quality_status": "implemented", "source_report_type": "producer_gap_source_bundle"}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 64. `order_producer_gap_discovery_producer_gap_stop_recovery_counterfactual_missing`
...
- files_likely_touched: `src/report/producer_gap_discovery.py`, `src/report/producers/stop_recovery_counterfactual_producer.py`, `data/report/producer_gap_source_bundle_2026-05-28.json`
- acceptance_tests: `Producer emits a stop_recovery bucket from sim evidence only.`, `No forbidden-use authority appears in output.`, `Required contract fields are present and populated.`
- implementation_status: `implemented`
- implementation_provenance: `{"allowed_runtime_apply": false, "implementation_type": "source_only_producer_gap_source_bundle", "join_keys": ["code", "sell_time", "exit_reason"], "missing_fields": [], "pattern_type": "stop_recovery_counterfactual", "runtime_effect": false, "sample_count": 571, "section_id": "stop_recovery_counterfactual", "source_paths": ["/home/ubuntu/KORStockScan/data/report/lifecycle_bucket_discovery/lifecycle_bucket_discovery_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/lifecycle_decision_matrix/lifecycle_decision_matrix_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_audit/swing_lifecycle_audit_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_bucket_discovery/swing_lifecycle_bucket_discovery_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_lifecycle_decision_matrix/swing_lifecycle_decision_matrix_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/swing_strategy_discovery_ev/swing_strategy_discovery_ev_2026-05-28.json", "/home/ubuntu/KORStockScan/data/report/time_window_regime_counterfactual/time_window_regime_counterfactual_2026-05-28.json"], "source_quality_status": "implemented", "source_report_type": "producer_gap_source_bundle"}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 65. `order_producer_gap_discovery_producer_gap_swing_sim_probe_label_gap_missing`
...
- target_subsystem: `swing/selection`
- route: `existing_family`
- mapped_family: `-`
- threshold_family: `-`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Improve source-quality adjusted EV attribution by making the missing producer observable.
- evidence: `matched_swing_label_or_source_gap_rows=6333`, `source_labels=swing_lifecycle_audit,swing_lifecycle_bucket_discovery,swing_lifecycle_decision_matrix,swing_strategy_discovery_ev`, `gap=swing sim/probe label and EV handoff defects need a dedicated source producer`, `ai_priority=high`, `ai_route=implement_now`
- parity_contract: -
- next_postclose_metric: producer_gap_discovery.producer_gap_swing_sim_probe_label_gap_missing
- files_likely_touched: `src/report/producer_gap_discovery.py`, `src/report/producers/swing_lifecycle_producer.py`, `data/report/swing_lifecycle_audit/swing_lifecycle_audit_2026-05-28.json`
- acceptance_tests: `Swing label-gap rows are assigned without real-flow authority.`, `Existing swing lifecycle artifacts remain unchanged in meaning.`, `No runtime hooks or exit overrides are introduced.`
- implementation_status: `implemented`
...
### 66. `order_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_low_missing_held_missing_kospi_regime_stop_loss`
...
### 67. `order_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_low_missing_held_missing_kospi_trailing_start_take_profit`
...
### 68. `order_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_2h_1d_kospi_trailing_start_take_profit`
...
### 69. `order_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_held_missing_kospi_trailing_start_take_profit`
...
### 70. `order_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_neg_missing_held_missing_kospi_regime_stop_loss`
...
### 71. `order_swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_confidence_weighted_trailing_after_mfe_computer_programmi`
...
### 72. `order_swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_confidence_weighted_trailing_after_mfe_manufacture_of_ele`
...
### 74. `order_swing_ldm_selection_discovery_arm_attribution_pullback_limit_entry_risk_capped_mae_stop_time_stop_manufacture_of_electronic_co`
...
### 75. `order_swing_lifecycle_bucket_discovery_swing_bucket_holding_exit_holding_exit_bucket_attribution_mfe_low_missing_held_m`
...
### 76. `order_swing_lifecycle_bucket_discovery_swing_bucket_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_2h_1d_`

- title: Swing lifecycle bucket discovery handoff follow-up: swing_bucket_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_2h_1d_kospi_trailing_start_take_profit
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented_source_quality_contract_waiting_sample; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `swing_lifecycle_bucket_discovery`
- lifecycle_stage: `source_quality`
...
### 77. `order_swing_lifecycle_bucket_discovery_swing_bucket_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_held_m`

- title: Swing lifecycle bucket discovery handoff follow-up: swing_bucket_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_held_missing_kospi_trailing_start_take_profit
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented_source_quality_contract_waiting_sample; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `swing_lifecycle_bucket_discovery`
- lifecycle_stage: `source_quality`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep Swing bucket discovery handoff explicit without allowing sim-only output to mutate real runtime.
- evidence: `bucket_id=swing_bucket_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_held_missing_kospi_trailing_start_take_profit`, `canonical_bucket=-`, `legacy_raw_bucket_key=-`, `ai_tier2_taxonomy_decision=-`, `ai_tier2_selected_source=-`, `classification_state=code_patch_required`, `reason=swing_ldm_bucket_contract_or_source_quality_gap`, `source_workorder_id=-`, `parent_bucket_id=swing_bucket_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_held_missing_kospi_trailing_start_take_profit`, `decision_authority=swing_ldm_bucket_discovery_sim_auto`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Swing bucket discovery candidates and workorders should be visible in EV, runtime summary, workorder, and verifier.
- files_likely_touched: `src/engine/swing_lifecycle_bucket_discovery.py`, `src/engine/threshold_cycle_ev_report.py`, `src/engine/runtime_approval_summary.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/pytest -q src/tests/test_swing_lifecycle_bucket_discovery.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
### 78. `order_swing_lifecycle_bucket_discovery_swing_bucket_holding_exit_holding_exit_bucket_attribution_mfe_neg_missing_held_m`

- title: Swing lifecycle bucket discovery handoff follow-up: swing_bucket_holding_exit_holding_exit_bucket_attribution_mfe_neg_missing_held_missing_kospi_regime_stop_loss
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented_source_quality_contract_waiting_sample; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `swing_lifecycle_bucket_discovery`
- lifecycle_stage: `source_quality`
...
### 79. `order_swing_lifecycle_bucket_discovery_swing_bucket_selection_discovery_arm_attribution_breakout_confirm_entry_confiden`

- title: Swing lifecycle bucket discovery handoff follow-up: swing_bucket_selection_discovery_arm_attribution_breakout_confirm_entry_confidence_weighted_trailing_after_mfe_compu_1d97aa773a79
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented_source_quality_contract_waiting_sample; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `swing_lifecycle_bucket_discovery`
- lifecycle_stage: `source_quality`
...
### 80. `order_swing_lifecycle_bucket_discovery_swing_bucket_selection_discovery_arm_attribution_breakout_confirm_entry_risk_cap`
...
- title: Swing lifecycle bucket discovery handoff follow-up: swing_bucket_selection_discovery_arm_attribution_pullback_limit_entry_risk_capped_mae_stop_time_stop_manufacture_of_5563cade5ff6
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented_source_quality_contract_waiting_sample; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `swing_lifecycle_bucket_discovery`
- lifecycle_stage: `source_quality`
...
### 82. `order_swing_lifecycle_bucket_discovery_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_low_missing_held_miss`
...
### 83. `order_swing_lifecycle_bucket_discovery_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_2h_1d_kos`

- title: Swing lifecycle bucket discovery handoff follow-up: swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_2h_1d_kospi_trailing_start_take_profit
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented_source_quality_contract_waiting_sample; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `swing_lifecycle_bucket_discovery`
- lifecycle_stage: `holding_exit`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep Swing bucket discovery handoff explicit without allowing sim-only output to mutate real runtime.
- evidence: `bucket_id=swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_2h_1d_kospi_trailing_start_take_profit`, `canonical_bucket=-`, `legacy_raw_bucket_key=-`, `ai_tier2_taxonomy_decision=-`, `ai_tier2_selected_source=-`, `classification_state=None`, `reason=source_quality_or_instrumentation_gap`, `source_workorder_id=swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_2h_1d_kospi_trailing_start_take_profit`, `parent_bucket_id=-`, `decision_authority=swing_ldm_bucket_discovery_sim_auto`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Swing bucket discovery candidates and workorders should be visible in EV, runtime summary, workorder, and verifier.
- files_likely_touched: `src/engine/swing_lifecycle_bucket_discovery.py`, `src/engine/threshold_cycle_ev_report.py`, `src/engine/runtime_approval_summary.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/pytest -q src/tests/test_swing_lifecycle_bucket_discovery.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
### 84. `order_swing_lifecycle_bucket_discovery_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_held_miss`

- title: Swing lifecycle bucket discovery handoff follow-up: swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_held_missing_kospi_trailing_start_take_profit
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented_source_quality_contract_waiting_sample; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `swing_lifecycle_bucket_discovery`
- lifecycle_stage: `holding_exit`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep Swing bucket discovery handoff explicit without allowing sim-only output to mutate real runtime.
- evidence: `bucket_id=swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_held_missing_kospi_trailing_start_take_profit`, `canonical_bucket=-`, `legacy_raw_bucket_key=-`, `ai_tier2_taxonomy_decision=-`, `ai_tier2_selected_source=-`, `classification_state=None`, `reason=source_quality_or_instrumentation_gap`, `source_workorder_id=swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_mid_missing_held_missing_kospi_trailing_start_take_profit`, `parent_bucket_id=-`, `decision_authority=swing_ldm_bucket_discovery_sim_auto`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Swing bucket discovery candidates and workorders should be visible in EV, runtime summary, workorder, and verifier.
- files_likely_touched: `src/engine/swing_lifecycle_bucket_discovery.py`, `src/engine/threshold_cycle_ev_report.py`, `src/engine/runtime_approval_summary.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/pytest -q src/tests/test_swing_lifecycle_bucket_discovery.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
### 85. `order_swing_lifecycle_bucket_discovery_swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_neg_missing_held_miss`

- title: Swing lifecycle bucket discovery handoff follow-up: swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_neg_missing_held_missing_kospi_regime_stop_loss
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented_source_quality_contract_waiting_sample; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `swing_lifecycle_bucket_discovery`
- lifecycle_stage: `holding_exit`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep Swing bucket discovery handoff explicit without allowing sim-only output to mutate real runtime.
- evidence: `bucket_id=swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_neg_missing_held_missing_kospi_regime_stop_loss`, `canonical_bucket=-`, `legacy_raw_bucket_key=-`, `ai_tier2_taxonomy_decision=-`, `ai_tier2_selected_source=-`, `classification_state=None`, `reason=source_quality_or_instrumentation_gap`, `source_workorder_id=swing_ldm_holding_exit_holding_exit_bucket_attribution_mfe_neg_missing_held_missing_kospi_regime_stop_loss`, `parent_bucket_id=-`, `decision_authority=swing_ldm_bucket_discovery_sim_auto`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Swing bucket discovery candidates and workorders should be visible in EV, runtime summary, workorder, and verifier.
- files_likely_touched: `src/engine/swing_lifecycle_bucket_discovery.py`, `src/engine/threshold_cycle_ev_report.py`, `src/engine/runtime_approval_summary.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/pytest -q src/tests/test_swing_lifecycle_bucket_discovery.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
### 86. `order_swing_lifecycle_bucket_discovery_swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_confidence_`

- title: Swing lifecycle bucket discovery handoff follow-up: swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_confidence_weighted_trailing_after_mfe_computer_programmi
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented_source_quality_contract_waiting_sample; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `swing_lifecycle_bucket_discovery`
- lifecycle_stage: `selection`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep Swing bucket discovery handoff explicit without allowing sim-only output to mutate real runtime.
- evidence: `bucket_id=swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_confidence_weighted_trailing_after_mfe_computer_programmi`, `canonical_bucket=-`, `legacy_raw_bucket_key=-`, `ai_tier2_taxonomy_decision=-`, `ai_tier2_selected_source=-`, `classification_state=None`, `reason=source_quality_or_instrumentation_gap`, `source_workorder_id=swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_confidence_weighted_trailing_after_mfe_computer_programmi`, `parent_bucket_id=-`, `decision_authority=swing_ldm_bucket_discovery_sim_auto`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Swing bucket discovery candidates and workorders should be visible in EV, runtime summary, workorder, and verifier.
- files_likely_touched: `src/engine/swing_lifecycle_bucket_discovery.py`, `src/engine/threshold_cycle_ev_report.py`, `src/engine/runtime_approval_summary.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/pytest -q src/tests/test_swing_lifecycle_bucket_discovery.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
### 87. `order_swing_lifecycle_bucket_discovery_swing_ldm_selection_discovery_arm_attribution_breakout_confirm_entry_risk_capped`
...
### 88. `order_swing_lifecycle_bucket_discovery_swing_ldm_selection_discovery_arm_attribution_pullback_limit_entry_risk_capped_m`

- title: Swing lifecycle bucket discovery handoff follow-up: swing_ldm_selection_discovery_arm_attribution_pullback_limit_entry_risk_capped_mae_stop_time_stop_manufacture_of_electronic_co
- decision: `attach_existing_family`
- decision_reason: instrumentation/report/provenance implementation status is implemented_source_quality_contract_waiting_sample; keep the order as existing-family source evidence instead of re-implementing
- source_report_type: `swing_lifecycle_bucket_discovery`
- lifecycle_stage: `selection`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep Swing bucket discovery handoff explicit without allowing sim-only output to mutate real runtime.
- evidence: `bucket_id=swing_ldm_selection_discovery_arm_attribution_pullback_limit_entry_risk_capped_mae_stop_time_stop_manufacture_of_electronic_co`, `canonical_bucket=-`, `legacy_raw_bucket_key=-`, `ai_tier2_taxonomy_decision=-`, `ai_tier2_selected_source=-`, `classification_state=None`, `reason=source_quality_or_instrumentation_gap`, `source_workorder_id=swing_ldm_selection_discovery_arm_attribution_pullback_limit_entry_risk_capped_mae_stop_time_stop_manufacture_of_electronic_co`, `parent_bucket_id=-`, `decision_authority=swing_ldm_bucket_discovery_sim_auto`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Swing bucket discovery candidates and workorders should be visible in EV, runtime summary, workorder, and verifier.
- files_likely_touched: `src/engine/swing_lifecycle_bucket_discovery.py`, `src/engine/threshold_cycle_ev_report.py`, `src/engine/runtime_approval_summary.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/pytest -q src/tests/test_swing_lifecycle_bucket_discovery.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
### 89. `order_lifecycle_overnight_bucket_combo_overnight_decision_action_action_unknown_status_sell_today_confidence_confidence_unknown_profit_pro`
...
### 90. `order_lifecycle_overnight_bucket_combo_overnight_decision_action_sell_today_status_sell_today_confidence_confidence_070p_profit_profit_pos`
...
### 91. `order_lifecycle_overnight_bucket_confidence_band_confidence_070p`
...
### 92. `order_lifecycle_overnight_bucket_confidence_band_confidence_unknown`
...
### 93. `order_lifecycle_overnight_bucket_held_bucket_held_600_1800s_plus`
...
### 94. `order_lifecycle_overnight_bucket_held_bucket_held_unknown`
...
### 95. `order_lifecycle_overnight_bucket_overnight_action_action_unknown`
...
### 98. `order_lifecycle_overnight_bucket_peak_profit_band_peak_unknown`
...
### 99. `order_lifecycle_scale_in_bucket_ai_score_band_score_63_65`
...
### 100. `order_lifecycle_scale_in_bucket_ai_score_band_score_66_69`
...
### 101. `order_lifecycle_scale_in_bucket_ai_score_band_score_70p`
...
### 102. `order_lifecycle_scale_in_bucket_ai_score_band_score_lt60`
...
### 103. `order_lifecycle_scale_in_bucket_ai_score_source_ai_source_unknown`
...
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM scale-in bucket candidates/workorders are not propagated`
- implementation_status: `implemented`
- implementation_provenance: `{"recommended_resolution": "emit_or_backfill_source_field", "source_field_coverage": {"ai_score_source": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 22523, "source_fields": ["runtime_features.ai_score_source"]}}, "unknown_reason_counts": {"missing_source_field": 1}}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 104. `order_lifecycle_scale_in_bucket_arm_arm_unknown`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Separate AVG_DOWN/PYRAMID attribution and keep scale-in threshold/cap candidates as source-only evidence until rolling confirmation and approval artifact.
- evidence: `workorder_id=scale_in_bucket_source_quality_7`, `bucket_type=arm`, `bucket_key=arm_unknown`, `reason=scale_in_arm_bucket_needs_source_quality_or_threshold_cycle_confirmation`, `recommended_route=candidate_tighten_or_exclude`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_scale_in_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_decision_matrix.scale_in_bucket_attribution candidates/workorders must remain visible in threshold EV/runtime summary, and postclose verifier must fail if dropped.
- files_likely_touched: `src/engine/sniper_state_handlers.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/daily_threshold_cycle_report.py`, `src/engine/runtime_approval_summary.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM scale-in bucket candidates/workorders are not propagated`
- implementation_status: `implemented`
- implementation_provenance: `{"recommended_resolution": "emit_or_backfill_source_field", "source_field_coverage": {"arm": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 9880, "source_fields": ["runtime_features.scale_in_arm", "runtime_features.add_type"]}}, "unknown_reason_counts": {"missing_source_field": 1}}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 105. `order_lifecycle_scale_in_bucket_arm_avg_down`
...
### 106. `order_lifecycle_scale_in_bucket_arm_pyramid`
...
### 107. `order_lifecycle_scale_in_bucket_blocker_namespace_avg_down`
...
### 108. `order_lifecycle_scale_in_bucket_blocker_namespace_blocker_namespace_unknown`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Separate AVG_DOWN/PYRAMID attribution and keep scale-in threshold/cap candidates as source-only evidence until rolling confirmation and approval artifact.
- evidence: `workorder_id=scale_in_bucket_source_quality_9`, `bucket_type=blocker_namespace`, `bucket_key=blocker_namespace_unknown`, `reason=scale_in_arm_bucket_needs_source_quality_or_threshold_cycle_confirmation`, `recommended_route=candidate_tighten_or_exclude`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_scale_in_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_decision_matrix.scale_in_bucket_attribution candidates/workorders must remain visible in threshold EV/runtime summary, and postclose verifier must fail if dropped.
- files_likely_touched: `src/engine/sniper_state_handlers.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/daily_threshold_cycle_report.py`, `src/engine/runtime_approval_summary.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM scale-in bucket candidates/workorders are not propagated`
- implementation_status: `implemented`
- implementation_provenance: `{"recommended_resolution": "emit_or_backfill_source_field", "source_field_coverage": {"blocker_namespace": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 9881, "source_fields": ["runtime_features.scale_in_blocker_namespace"]}}, "unknown_reason_counts": {"missing_source_field": 1}}`
- automation_reentry: Next postclose workorder should preserve implementation_status=implemented and use the source metrics as provenance only.
...
### 109. `order_lifecycle_entry_bucket_chosen_action_no_buy_ai`
...
### 110. `order_lifecycle_entry_bucket_score_band_score_66_69`
...
### 111. `order_lifecycle_entry_bucket_score_band_score_70p`
...
### 112. `order_lifecycle_entry_bucket_source_stage_wait6579_ev_cohort`
...
### N8. `order_latency_guard_miss_ev_recovery`
...
### N22. `order_budget_pass_without_submit`
...
### N26. `order_panic_sell_defense_lifecycle_transition_pack`
...
### N27. `order_overbought_gate_miss_ev_회수_조건_점검`
...
### N30. `order_panic_buying_source_quality_market_breadth_micro_coverage`
...
### N32. `order_partial_only_표류_전용_timeout_report_only`
...
### N33. `order_split_entry_rebase_수량_정합성_report_only_감사`
...
### N34. `order_동일_종목_split_entry_soft_stop_재진입_cooldown_report_only`
...
### N37. `order_perf_dashboard_db_pool_review`
