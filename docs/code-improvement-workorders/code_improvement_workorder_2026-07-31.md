# Code Improvement Workorder - 2026-07-31
...
- pattern_lab_automation: `/home/ubuntu/KORStockScan/data/report/scalping_pattern_lab_automation/scalping_pattern_lab_automation_2026-07-31.json`
- swing_improvement_automation: `-`
- swing_pattern_lab_automation: `-`
- swing_strategy_discovery_ev: `-`
- swing_lifecycle_decision_matrix: `-`
- swing_lifecycle_bucket_discovery: `-`
- threshold_cycle_ev: `/home/ubuntu/KORStockScan/data/report/threshold_cycle_ev/threshold_cycle_ev_2026-07-31.json`
- lifecycle_decision_matrix: `/home/ubuntu/KORStockScan/data/report/lifecycle_decision_matrix/lifecycle_decision_matrix_2026-07-31.json`
- threshold_cycle_calibration: `/home/ubuntu/KORStockScan/data/report/threshold_cycle_calibration/threshold_cycle_calibration_2026-07-31_postclose.json`
- pipeline_event_verbosity: `/home/ubuntu/KORStockScan/data/report/pipeline_event_verbosity/pipeline_event_verbosity_2026-07-31.json`
- observation_source_quality_audit: `/home/ubuntu/KORStockScan/data/report/observation_source_quality_audit/observation_source_quality_audit_2026-07-31.json`
- ai_decision_action_outcome_calibration: `/home/ubuntu/KORStockScan/data/report/ai_decision_action_outcome_calibration/ai_decision_action_outcome_calibration_2026-07-31.json`
- codebase_performance_workorder: `-`
- pattern_lab_currentness_audit: `/home/ubuntu/KORStockScan/data/report/pattern_lab_currentness_audit/pattern_lab_currentness_audit_2026-07-31.json`
- pattern_lab_ai_review: `/home/ubuntu/KORStockScan/data/report/pattern_lab_ai_review/pattern_lab_ai_review_2026-07-31.json`
...
- evidence: `ai_confirmed_unique=136`, `budget_pass_unique=89`, `latency_pass_unique=21`, `submitted_unique=5`, `submitted_to_ai_pct=3.7`, `submitted_to_budget_pct=5.6`, `blocker:blocked_strength_momentum:below_window_buy_value=544`, `blocker:blocked_strength_momentum:insufficient_history=314`, `blocker:blocked_strength_momentum:below_strength_base=277`, `upstream:first_ai_wait:-=153`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=119`, `upstream:blocked_ai_score:score_0.0=86`, `latency:latency_block:latency_state_danger=177`
- parity_contract: -
...
- implementation_provenance: `{"allowed_runtime_apply": false, "artifact_regeneration_required": false, "broker_order_submit_allowed": false, "forbidden_uses": ["intraday_threshold_mutation", "broker_guard_bypass", "provider_route_change", "bot_restart_trigger", "telegram_pre_submit_buy_alert"], "implementation_type": "source_only_report_provenance_handoff", "ldm_quote_freshness_attribution_present": true, "observation_axis_status": {"BROKER_RECEIPT": "observed", "BUDGET_PASS_COLLAPSE": "observed", "ECONOMIC_PARTICIPATION": "observed", "LATENCY_PRE_SUBMIT": "observed", "SIM_REAL_AUTHORITY": "observed", "SOURCE_TAXONOMY_LEAKAGE": "no_current_signal", "UPSTREAM_GATE": "observed"}, "observation_breakdown": {"allowed_runtime_apply": false, "axes": {"BROKER_RECEIPT": {"evidence": {"latency_pass_unique": 21, "order_bundle_submitted_unique": 5, "submitted_to_budget_unique_pct": 5.6}, "next_repair_action": "join post-submit broker receipt and fill provenance when submitted samples exist", "observed_count": 16, "status": "observed"}, "BUDGET_PASS_COLLAPSE": {"evidence": {"ai_confirmed_unique": 136, "budget_pass_unique": 89, "budget_to_ai_unique_pct": 65.4}, "next_repair_action": "preserve budget pass collapse as source attribution before EV approval", "observed_count": 47, "status": "observed"}, "ECONOMIC_PARTICIPATION": {"evidence": {"allowed_runtime_apply": false, "bundle_count": 5, "by_venue": {"KRX": {"bundle_count": 5, "full_submitted_bundle_count": 0, "partial_residual_bundle_count": 0, "probe_only_bundle_count": 5, "requested_notional_krw": 2291800, "requested_qty": 18, "submitted_notional_krw": 674200, "submitted_notional_to_requested_notional_pct": 29.4, "submitted_qty": 5, "submitted_qty_to_requested_qty_pct": 27.8}}, "decision_authority": "submit_drought_attribution_only", "forbidden_uses": ["broker_order_submit", "intraday_threshold_mutation", "quantity_cap_release", "live_auto_promotion", "bot_restart_trigger"], "full_submitted_bundle_count": 0, "metric_role": "funnel_count", "observed_bundle_count": 5, "partial_residual_bundle_count": 0, "primary_decision_metric": "submitted_notional_to_requested_notional_pct", "probe_only_bundle_count": 5, "requested_notional_krw": 2291800, "requested_qty": 18, "rows": [{"attempt_key": "id:25678", "bundle_state": "probe_only", "effective_venue": "KRX", "requested_notional_krw": 438000, "requested_qty": 3, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "000250", "submitted_notional_krw": 146600, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "id:25691", "bundle_state": "probe_only", "effective_venue": "KRX", "requested_notional_krw": 441000, "requested_qty": 3, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "000250", "submitted_notional_krw": 147300, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "id:25439", "bundle_state": "probe_only", "effective_venue": "KRX", "requested_notional_krw": 542000, "requested_qty": 5, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "096770", "submitted_notional_krw": 108800, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "id:25712", "bundle_state": "probe_only", "effective_venue": "KRX", "requested_notional_krw": 548000, "requested_qty": 5, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "096770", "submitted_notional_krw": 109900, "submitted_qty": 1, "venue_source_quality": "pass"}, {"attempt_key": "id:25602", "bundle_state": "probe_only", "effective_venue": "KRX", "requested_notional_krw": 322800, "requested_qty": 2, "residual_submitted_qty": 0, "source_quality_valid": true, "stock_code": "066570", "submitted_notional_krw": 161600, "submitted_qty": 1, "venue_source_quality": "pass"}], "runtime_effect": false, "sample_floor": "1_explicit_venue_probe_bundle", "source_quality_blocked_bundle_count": 0, "source_quality_gate": "explicit_conflict_free_venue_and_positive_requested_submitted_qty_price", "source_quality_valid_bundle_count": 5, "submitted_notional_krw": 674200, "submitted_notional_to_requested_notional_pct": 29.4, "submitted_qty": 5, "submitted_qty_to_requested_qty_pct": 27.8, "window_policy": "same_session_probe_bundle_lifecycle"}, "next_repair_action": "attribute probe-only and residual-submitted quantity/notional by explicit venue before interpreting submit conversion", "observed_count": 5, "status": "observed"}, "LATENCY_PRE_SUBMIT": {"evidence": {"latency_blocker_top": [{"count": 177, "label": "latency_block:latency_state_danger"}], "latency_root_cause_counts": {"quote_freshness_input_snapshot_noop": 135, "quote_stale": 94, "spread_microstructure_guard": 177, "spread_or_slippage_guard": 131}, "quote_freshness_attribution": {"decision_authority": "submit_drought_quote_freshness_attribution_only", "forbidden_uses": ["broker_order_submit", "adm_ldm_training_input", "general_threshold_ev_input", "live_auto_promotion"], "latency_pass_recovered_count": 5, "latency_pass_recovered_downstream_counts": {"order_bundle_submitted": 1, "price_guard_or_revalidation": 4}, "latency_pass_recovered_downstream_stage_counts": {"order_bundle_submitted": 1, "pre_submit_entry_ai_authority_guard_block": 4}, "order_bundle_submitted_after_refresh_count": 1, "post_restart_window_policy": "event_provenance_only", "refresh_applied_count": 30, "refresh_attempted_count": 77, "refresh_block_subreason_counts": {"observer_quote_refresh_failed_spread": 1, "observer_quote_refresh_failed_stale": 3, "ws_snapshot_refresh_failed_input_snapshot_fresh": 135, "ws_snapshot_refresh_failed_stale": 13}, "refresh_subreason_counts": {"observer_quote_refresh_failed_spread": 1, "observer_quote_refresh_failed_stale": 3, "ws_snapshot_refresh_failed_input_snapshot_fresh": 135, "ws_snapshot_refresh_failed_stale": 13}, "runtime_effect": false, "still_latency_blocked_after_refresh_count": 63}, "unknown_latency_reason_count": 0, "unknown_latency_workorder_required": false}, "next_repair_action": "close unknown latency labels or route quote freshness gaps to LDM attribution", "observed_count": 177, "status": "observed"}, "SIM_REAL_AUTHORITY": {"evidence": {"actual_order_submitted_authority": "not_granted_by_report", "broker_order_submit_allowed": false}, "next_repair_action": "keep attribution source-only until explicit runtime approval artifact exists", "observed_count": 1, "status": "observed"}, "SOURCE_TAXONOMY_LEAKAGE": {"evidence": {"blocker_top": [{"count": 544, "label": "blocked_strength_momentum:below_window_buy_value"}, {"count": 314, "label": "blocked_strength_momentum:insufficient_history"}, {"count": 277, "label": "blocked_strength_momentum:below_strength_base"}, {"count": 277, "label": "blocked_overbought:-"}, {"count": 239, "label": "blocked_liquidity:-"}, {"count": 187, "label": "blocked_vpw:-"}, {"count": 177, "label": "latency_block:latency_state_danger"}, {"count": 176, "label": "blocked_zero_qty:-"}, {"count": 153, "label": "first_ai_wait:-"}, {"count": 119, "label": "blocked_ai_score:ai_score_50_buy_hold_override"}], "taxonomy_leakage_labels": []}, "next_repair_action": "separate swing/source taxonomy from entry-submit blocker labels", "observed_count": 0, "status": "no_current_signal"}, "UPSTREAM_GATE": {"evidence": {"budget_to_ai_unique_pct": 65.4, "upstream_blocker_top": [{"count": 153, "label": "first_ai_wait:-"}, {"count": 119, "label": "blocked_ai_score:ai_score_50_buy_hold_override"}, {"count": 86, "label": "blocked_ai_score:score_0.0"}, {"count": 39, "label": "wait65_79_ev_candidate:score_65.0"}, {"count": 36, "label": "blocked_ai_score:score_11.0"}, {"count": 22, "label": "blocked_ai_score:score_65.0"}, {"count": 19, "label": "blocked_ai_score:score_13.0"}, {"count": 19, "label": "blocked_ai_score:score_14.0"}, {"count": 11, "label": "blocked_ai_score:score_16.0"}, {"count": 8, "label": "blocked_ai_score:score_64.0"}]}, "next_repair_action": "split upstream AI terminal and score gate reasons before threshold interpretation", "observed_count": 531, "status": "observed"}}, "axis_order": ["UPSTREAM_GATE", "BUDGET_PASS_COLLAPSE", "LATENCY_PRE_SUBMIT", "BROKER_RECEIPT", "ECONOMIC_PARTICIPATION", "SIM_REAL_AUTHORITY", "SOURCE_TAXONOMY_LEAKAGE"], "broker_order_submit_allowed": false, "decision_authority": "submit_drought_attribution_only", "forbidden_uses": ["broker_order_submit", "runtime_apply_candidate", "intraday_threshold_mutation", "provider_route_change", "bot_restart_trigger", "live_auto_promotion"], "runtime_effect": false}, "quote_freshness_attribution_inconsistent": false, "quote_freshness_latency_pass_recovered_count": 5, "quote_freshness_refresh_applied_count": 30, "quote_freshness_refresh_attempted_count": 77, "required_downstream": ["code_improvement_workorder", "lifecycle_decision_matrix.submit_bucket_attribution", "threshold_cycle_ev_report", "runtime_approval_summary", "postclose_verifier"], "root_cause_closure_status_hint": "root_cause_closed", "root_cause_counts": {"quote_freshness_input_snapshot_noop": 135, "quote_stale": 94, "spread_microstructure_guard": 177, "spread_or_slippage_guard": 131}, "root_cause_signal": "SUBMIT_DROUGHT_CRITICAL", "runtime_effect": false, "source_report_type": "buy_funnel_sentinel", "weak_contract_matches": ["BROKER_RECEIPT", "BUDGET_PASS_COLLAPSE", "ECONOMIC_PARTICIPATION", "FILL_QUALITY", "LATENCY_PRE_SUBMIT", "PRICE_REVALIDATION", "SIM_REAL_AUTHORITY", "TELEGRAM_POST_SUBMIT_ONLY", "UPSTREAM_GATE"]}`
...
- evidence: `ai_confirmed_unique=136`, `budget_pass_unique=89`, `latency_pass_unique=21`, `submitted_unique=5`, `submitted_to_ai_pct=3.7`, `submitted_to_budget_pct=5.6`, `blocker:blocked_strength_momentum:below_window_buy_value=544`, `blocker:blocked_strength_momentum:insufficient_history=314`, `blocker:blocked_strength_momentum:below_strength_base=277`, `upstream:first_ai_wait:-=153`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=119`, `upstream:blocked_ai_score:score_0.0=86`, `latency:latency_block:latency_state_danger=177`, `weak_contract_gap=broker_receipt_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=136`, `budget_pass_unique=89`, `latency_pass_unique=21`, `submitted_unique=5`, `submitted_to_ai_pct=3.7`, `submitted_to_budget_pct=5.6`, `blocker:blocked_strength_momentum:below_window_buy_value=544`, `blocker:blocked_strength_momentum:insufficient_history=314`, `blocker:blocked_strength_momentum:below_strength_base=277`, `upstream:first_ai_wait:-=153`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=119`, `upstream:blocked_ai_score:score_0.0=86`, `latency:latency_block:latency_state_danger=177`, `weak_contract_gap=fill_quality_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=136`, `budget_pass_unique=89`, `latency_pass_unique=21`, `submitted_unique=5`, `submitted_to_ai_pct=3.7`, `submitted_to_budget_pct=5.6`, `blocker:blocked_strength_momentum:below_window_buy_value=544`, `blocker:blocked_strength_momentum:insufficient_history=314`, `blocker:blocked_strength_momentum:below_strength_base=277`, `upstream:first_ai_wait:-=153`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=119`, `upstream:blocked_ai_score:score_0.0=86`, `latency:latency_block:latency_state_danger=177`, `weak_contract_gap=post_submit_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=136`, `budget_pass_unique=89`, `latency_pass_unique=21`, `submitted_unique=5`, `submitted_to_ai_pct=3.7`, `submitted_to_budget_pct=5.6`, `blocker:blocked_strength_momentum:below_window_buy_value=544`, `blocker:blocked_strength_momentum:insufficient_history=314`, `blocker:blocked_strength_momentum:below_strength_base=277`, `upstream:first_ai_wait:-=153`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=119`, `upstream:blocked_ai_score:score_0.0=86`, `latency:latency_block:latency_state_danger=177`, `weak_contract_gap=source_taxonomy_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`, `taxonomy_leakage_labels=[]`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
- tuning_axis_effect: `True`
- expected_ev_effect: none_direct_source_quality_only
- evidence: `ai_confirmed_unique=136`, `budget_pass_unique=89`, `latency_pass_unique=21`, `submitted_unique=5`, `submitted_to_ai_pct=3.7`, `submitted_to_budget_pct=5.6`, `blocker:blocked_strength_momentum:below_window_buy_value=544`, `blocker:blocked_strength_momentum:insufficient_history=314`, `blocker:blocked_strength_momentum:below_strength_base=277`, `upstream:first_ai_wait:-=153`, `upstream:blocked_ai_score:ai_score_50_buy_hold_override=119`, `upstream:blocked_ai_score:score_0.0=86`, `latency:latency_block:latency_state_danger=177`, `weak_contract_gap=telegram_post_submit_contract_gap`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: Entry post-submit weak contracts remain source-only workorders with runtime_effect=false and allowed_runtime_apply=false until explicit implementation and verification.
- files_likely_touched: `src/engine/buy_funnel_sentinel.py`, `src/engine/lifecycle_decision_matrix.py`, `src/engine/build_code_improvement_workorder.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_buy_funnel_sentinel.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_4`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_lt60_source_blo:70a865069d`, `reason=incomplete_lifecycle_flow`, `join_gap_reasons=['missing_submit', 'missing_holding', 'missing_exit']`, `required_producer_consumer_candidates=['entry producer', 'submit observation', 'holding flow', 'exit/post-sell feedback', 'bridge key normalizer']`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Prevent entry-only EV from being interpreted as full lifecycle EV by keeping incomplete parent flow bundles visible as source-quality evidence.
- evidence: `workorder_id=lifecycle_flow_bucket_incomplete_9`, `lifecycle_flow_bucket_id=lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_70p_source_scal:425fb814b4`, `reason=incomplete_lifecycle_flow`, `join_gap_reasons=['missing_submit', 'missing_holding', 'missing_exit']`, `required_producer_consumer_candidates=['entry producer', 'submit observation', 'holding flow', 'exit/post-sell feedback', 'bridge key normalizer']`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_lifecycle_flow_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_flow bucket counts, complete-flow counts, runtime candidates, and workorders must be visible in threshold EV, runtime summary, control tower, and verifier.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/lifecycle_bucket_discovery.py`, `src/engine/runtime_approval_summary.py`, `src/engine/runtime_apply_bridge.py`, `src/engine/verify_threshold_cycle_postclose_chain.py`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_lifecycle_bucket_discovery.py src/tests/test_runtime_apply_bridge.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if lifecycle-flow parent bucket output is dropped`
...
- implementation_status: `implemented`
- root_cause_closure_status: `root_cause_closed`
- implementation_provenance: `{"recommended_resolution": "join_labels_before_bucket_decision", "source_field_coverage": {"score": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 1, "source_fields": ["runtime_features.ai_score"]}}, "unknown_dimension_counts": {"score": 1}, "unknown_reason_counts": {"join_gap": 1}}`
- repeat_unresolved_escalation: `-`
- longstanding_non_implement_review: `-`
- longstanding_non_implement_action: `-`
- structural_blocker_escalation: `-`
...
- implementation_status: `implemented`
- root_cause_closure_status: `root_cause_closed`
- implementation_provenance: `{"recommended_resolution": "entry_label_not_applicable", "source_field_coverage": {"exit_rule": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 602, "source_fields": ["labels.exit_rule"]}}, "unknown_dimension_counts": {"exit_rule": 1}, "unknown_reason_counts": {"entry_label_not_applicable": 1}}`
- repeat_unresolved_escalation: `-`
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep entry bucket EV attribution, source-quality gaps, and threshold-cycle approval candidates connected without mutating intraday thresholds or broker submission.
- evidence: `workorder_id=entry_bucket_unknown_source_quality_9`, `bucket_type=score_band`, `bucket_key=score_unknown`, `reason=unknown_bucket_source_quality_blocker`, `recommended_route=source_quality_workorder`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_entry_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_decision_matrix.entry_bucket_attribution should reduce unknown buckets, keep runtime_approval_candidates visible in threshold EV/runtime summary, and regenerate this workorder when source-quality confirmation is still needed.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/scalp_entry_action_decision_matrix.py`, `src/engine/daily_threshold_cycle_report.py`, `src/engine/runtime_approval_summary.py`, `docs/report-based-automation-traceability.md`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM entry bucket candidates/workorders are not propagated`
- implementation_status: `implemented`
- root_cause_closure_status: `root_cause_closed`
- implementation_provenance: `{"recommended_resolution": "join_labels_before_bucket_decision", "source_field_coverage": {"score_band": {"coverage_rate": 0.0, "present_count": 0, "sample_count": 11, "source_fields": ["runtime_features.ai_score"]}}, "unknown_dimension_counts": {"score_band": 1}, "unknown_reason_counts": {"join_gap": 1}}`
- repeat_unresolved_escalation: `-`
- longstanding_non_implement_review: `-`
- longstanding_non_implement_action: `-`
- structural_blocker_escalation: `-`
...
- evidence: `quiet_gap_count=246`, `rollup_required_count=246`, `sim_live_connected_quiet_gap_count=0`, `quiet_gap_type_counts={'positive_source_only_keep_collecting': 245, 'ai_review_parsed_low_coverage': 1}`, `ai_review_coverage={'status': 'parsed', 'shard_count': 5, 'parsed_shard_count': 3, 'reviewed_candidate_count': 3, 'low_coverage': True}`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
...
- evidence: `rollup_only_gap_count=44`, `unknown_source_dimensions=7`, `recommended_resolution_counts={'explicit_lifecycle_flow_source_only_blocker': 37, 'join_labels_before_bucket_decision': 6, 'entry_label_not_applicable': 1}`, `missing_dimension_key_counts={'entry': 12, 'exit': 70, 'holding': 70, 'submit': 56}`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
...
- evidence: `join_gap_candidate_count=6`, `join_gap_stage_counts={'entry': 5, 'scale_in': 1}`, `join_gap_bucket_type_counts={'combo_entry_spot': 4, 'score_band': 1, 'ai_score_band': 1}`, `join_gap_recommended_resolution_counts={'join_labels_before_bucket_decision': 6}`, `join_gap_missing_dimension_key_counts={}`, `recommended_next_action=enrich_bucket_label_or_join_key_before_bucket_decision`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
...
- tuning_axis_effect: `False`
- expected_ev_effect: Keep entry bucket EV attribution, source-quality gaps, and threshold-cycle approval candidates connected without mutating intraday thresholds or broker submission.
- evidence: `workorder_id=entry_bucket_unknown_source_quality_10`, `bucket_type=source_stage`, `bucket_key=scalp_sim_entry_ai_price_skip_order`, `reason=unknown_bucket_source_quality_blocker`, `recommended_route=source_quality_workorder`, `metric_role=source_quality_gate`, `decision_authority=adm_ldm_entry_bucket_attribution_source_only`, `primary_decision_metric=source_quality_adjusted_ev_pct`, `runtime_effect=false`, `allowed_runtime_apply=false`
- parity_contract: -
- next_postclose_metric: lifecycle_decision_matrix.entry_bucket_attribution should reduce unknown buckets, keep runtime_approval_candidates visible in threshold EV/runtime summary, and regenerate this workorder when source-quality confirmation is still needed.
- files_likely_touched: `src/engine/lifecycle_decision_matrix.py`, `src/engine/scalp_entry_action_decision_matrix.py`, `src/engine/daily_threshold_cycle_report.py`, `src/engine/runtime_approval_summary.py`, `docs/report-based-automation-traceability.md`
- acceptance_tests: `PYTHONPATH=. .venv/bin/python -m pytest -q src/tests/test_lifecycle_decision_matrix.py src/tests/test_build_code_improvement_workorder.py src/tests/test_verify_threshold_cycle_postclose_chain.py`, `postclose verifier fails if LDM entry bucket candidates/workorders are not propagated`
...
- 구현 결과는 `2026-08-01` 이후 postclose `threshold_cycle`, `scalping_pattern_lab_automation`, `threshold_cycle_ev`가 자동으로 다시 읽는다.
