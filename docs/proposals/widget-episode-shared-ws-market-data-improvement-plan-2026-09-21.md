...
> 전환 후 재리뷰: 제외 봉의 메타데이터 재혼입·종료 PID를 원천 파일 부재로 오인한 REST 대체 허용·원천 실패 사유 덮어쓰기를 수리한다. 승인된 결손 허용 및 주문 직전 guard는 유지한다. [후속 리뷰](../audit-reports/2026-09-21-widget-ws-completed-bars-implementation-review.md#observed-history-follow-up-review-and-repair)가 배포·검증 증거를 소유한다.
