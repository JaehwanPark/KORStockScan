...
6. `latency_classifier_recommendation`이 같은 snapshot의 `latency_block`에서 age/jitter/spread 조합별 통과 가능성을 계산하고, sample/pass floor가 닫힌 경우 다음 PREOPEN env candidate를 만든다.
