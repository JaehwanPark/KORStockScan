...
- [ ] `[ScannerAsyncEvalCommitRuntimeActivation0727] scanner_async_eval_commit_v1 별도 승인·우아한 재기동·전 venue 귀속` (`Due: 2026-07-27`, `Slot: INTRADAY`, `TimeWindow: operator-approved`, `Track: RuntimeStability`)
  ...
  - 다음 액션: `implemented_not_runtime_reflected_opening_rotation_async_context`, `reviewed_opening_rotation_async_restart_async_v1`, `async_v1_fresh_cohort_attribution_started`, `async_v1_full_cycle_pass`, `rollback_to_deadline_v1` 중 하나로 닫는다.
