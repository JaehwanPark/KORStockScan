...
- [x] `[OpenAIWSIntradaySample0602] OpenAI WS/entry_price 장중 표본 및 fallback/fail-closed 재확인` (`Due: 2026-06-02`, `Slot: INTRADAY`, `TimeWindow: 09:20~09:35`, `Track: RuntimeStability`)
  - Source: [openai_ws_stability_2026-06-01.md](/home/ubuntu/KORStockScan/data/report/openai_ws/openai_ws_stability_2026-06-01.md)
  ...
  - 처리 결과: 판정 `transport_sample_present_no_fail_closed`. 전일 source [openai_ws_stability_2026-06-01.md](/home/ubuntu/KORStockScan/data/report/openai_ws/openai_ws_stability_2026-06-01.md)은 `analyze_target` WS fallback 0/6203, success rate 1.0, warning-only WS error 1건을 남긴다. 당일 장중 이벤트는 `openai_endpoint_name=analyze_target` 3346건, `openai_transport_mode=responses_ws` 3333건, `openai_ws_http_fallback=False` 3719건을 남겼고 `entry_price`는 `openai_endpoint_name=entry_price` 386건, `openai_transport_mode=bedrock_primary` 386건으로 별도 transport provenance가 찍혔다. 다음 액션은 postclose OpenAI WS 리포트에서 analyze_target WS와 entry_price Bedrock-primary route를 분리 집계하는 것이며 provider/order/threshold 변경은 하지 않는다.
...
- [ ] `[HumanInterventionSummary0602] 자동화체인 사용자 개입 요구사항 분류 및 누락 확인` (`Due: 2026-06-02`, `Slot: POSTCLOSE`, `TimeWindow: 17:00~17:15`, `Track: RuntimeStability`)
...
- [ ] `[RuntimeApplyGapDirectiveReview0602] runtime apply gap Codex 작업지시 표면화 및 구현 여부 확인` (`Due: 2026-06-02`, `Slot: POSTCLOSE`, `TimeWindow: 17:15~17:30`, `Track: ScalpingLogic`)
...
- [ ] `[AutomationChainTriggerDecisionFollowup0602] lifecycle/deep/workorder trigger decision 적용 및 skip 계약 검증` (`Due: 2026-06-02`, `Slot: POSTCLOSE`, `TimeWindow: 17:30~17:45`, `Track: RuntimeStability`)
