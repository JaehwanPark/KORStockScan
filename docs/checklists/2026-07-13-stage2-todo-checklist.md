...
- [ ] `[TightStopEntryCompanionReview0713] tight stop 환경 entry companion source-only 산출물 확인` (`Due: 2026-07-13`, `Slot: POSTCLOSE`, `TimeWindow: 16:55~17:00`, `Track: ScalpingLogic`)
...
- [ ] `[EntryContextIntradayProbe0713] 진입가-보유청산 AI 입력계약 장중 커버리지 및 live OpenAI probe 확인` (`Due: 2026-07-13`, `Slot: INTRADAY`, `TimeWindow: 10:50~11:05`, `Track: ScalpingLogic`)
