...
- [ ] `[ThresholdEnvAutoApplyPreopen0706] threshold env 자동 apply 산출물 및 사용자 개입 여부 확인` (`Due: 2026-07-06`, `Slot: PREOPEN`, `TimeWindow: 08:50~08:55`, `Track: RuntimeStability`)
...
- [ ] `[RisingMissedScoutRuntimePreopen0706] rising_missed_scout_workorder 구현분 다음 장전 runtime 반영 여부 확인` (`Due: 2026-07-06`, `Slot: PREOPEN`, `TimeWindow: 08:55~09:00`, `Track: ScalpingLogic`)
