...
- [ ] `[KiwoomCommonHealthOpportunityCostAcceptance0917] 공통 health·실행 모델·compact 정책 자연 소비 및 실제 성과 검증` (`Due: 2026-09-21`, `Slot: ALL`, `TimeWindow: 07:00~20:35`, `Track: RuntimeStability`)
  - 현재 WS 비교 창: 완료봉 연결 수리의12:39:38 메인 재기동으로 WS producer가 PID164792로 바뀌었다. 기본 collector153602·153619·153620은 재기동하지 않았고 기존 process-local census를 유지한다. 혼합 producer 창12:30–12:45는 제외하고 **13:30 이후**에12:45–13:00/13:00–13:15/13:15–13:30 연속3×15분 창을 검증한다. 앞선13:15 점검시각은 대체하며 다른 producer/PID 분모를 합산하지 않는다. [최신 배포/자연 소비 receipt](../audit-reports/2026-09-21-preflight-submit-bottleneck-repair.md#authorized-machine-completed-bar-handoff-and-observation-read-reduction), [통합 리뷰 이력](../audit-reports/2026-09-21-integrated-code-review.md). REST 중복조회 감축은 WS 전환/P2 승인이나 자동 gate 통과가 아니다.
