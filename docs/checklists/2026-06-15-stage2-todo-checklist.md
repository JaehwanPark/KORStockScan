...
- [ ] `[WeakPullbackEntryBlockPreopen0615] real SCALPING 약한 눌림/CAUTION 진입 차단 operator lock 및 PID env 확인` (`Due: 2026-06-15`, `Slot: PREOPEN`, `TimeWindow: 08:55~09:00`, `Track: ScalpingLogic`)
...
- [ ] `[AggressiveEntryPriceOverridePreopen0615] real SCALPING defensive missed-upside 공격 진입가 override operator lock 및 PID env 확인` (`Due: 2026-06-15`, `Slot: PREOPEN`, `TimeWindow: 08:55~09:00`, `Track: ScalpingLogic`)
...
- [ ] `[SoftStopDynamicGracePreopen0615] real SCALPING soft-stop 동적유예 operator lock 및 PID env 확인` (`Due: 2026-06-15`, `Slot: PREOPEN`, `TimeWindow: 08:55~09:00`, `Track: ScalpingLogic`)
