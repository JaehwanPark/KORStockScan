...
- [ ] `[SwingLifecycleFlowBundlePlan0528] 스윙 lifecycle flow bundle parent bucket 구현 계획 반영` (`Due: 2026-05-28`, `Slot: POSTCLOSE`, `TimeWindow: 17:30~17:45`, `Track: ScalpingLogic`)
