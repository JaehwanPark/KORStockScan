...
- [ ] `[EntrySetupRiskOOSFullDay0806] V2.14 setup-risk 첫 full-day out-of-sample 재판정` (`Due: 2026-08-06`, `Slot: POSTCLOSE`, `TimeWindow: 21:00~21:15`, `Track: ScalpingLogic`)
  - Source: [ai_decision_quality.py](/home/ubuntu/KORStockScan/src/engine/scalping/ai_decision_quality.py), [entry_setup_evidence.py](/home/ubuntu/KORStockScan/src/engine/scalping/entry_setup_evidence.py), [entry_setup_paired_replay_batch.py](/home/ubuntu/KORStockScan/src/engine/scalping/entry_setup_paired_replay_batch.py), [entry_setup_live_policy.py](/home/ubuntu/KORStockScan/src/engine/scalping/entry_setup_live_policy.py), [ai_engine_openai.py](/home/ubuntu/KORStockScan/src/engine/ai_engine_openai.py), [run_ai_entry_setup_paired_replay_postclose.sh](/home/ubuntu/KORStockScan/deploy/run_ai_entry_setup_paired_replay_postclose.sh), [run_threshold_cycle_preopen.sh](/home/ubuntu/KORStockScan/deploy/run_threshold_cycle_preopen.sh), [ai_prompt_contracts.py](/home/ubuntu/KORStockScan/src/engine/ai_prompt_contracts.py)
  - 현재 근거: 종전 단일 산출물의 `outcome_as_of=2026-08-06T18:13:24+09:00` 체크포인트는 4건·1종목, exposure 0건, trigger recheck 2건인 부분 거래일 결과였다. 보완 후 control/replay 산출물은 exact prompt SHA와 `venue/session`별 경로로 분리하고, 같은 contract·venue·session 표본만 clean-baseline cumulative에 합산한다. 리뷰 시점 `2026-08-06` 자연 exact 원천은 선택 full signature 기준 KRX 정규장 459건·119종목, NXT 애프터마켓 54건·13종목이므로 원천 표본 `10건/3종목`은 달성 가능하다. 실제 병목이었던 full-day mature outcome 이후 candidate 미실행은 main postclose DONE과 60분 성숙을 기다리는 21:05 별도 offline batch, outcome-blind 종목 round-robin, cohort당 신규 최대 30건으로 보완했다.
  ...
  - 다음 액션: `full_day_oos_keep_collecting`, `next_day_krx_bounded_canary_ready`, `ready_exposure_drought_review_required`, `source_quality_or_provider_blocked`, `contract_drift_or_cohort_split_required` 중 하나로 닫고, canary가 열리면 다음 거래일 trace의 activation SHA, deterministic setup, AI risk, probe/submit/post-probe 귀속을 재확인한다.
