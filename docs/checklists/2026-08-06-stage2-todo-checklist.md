...
- [x] `[WidgetDailyAutoCalibrationAndExpansionRecommendation0806] 세 종목 위젯 장후 누적 calibration·다음 거래일 자동 적용 및 확대 후보 관리자 추천` (`Due: 2026-08-06`, `Slot: INTRADAY`, `TimeWindow: 13:28~14:15`, `Track: ScalpingLogic`)
