...
- [ ] `[ThresholdEnvAutoApplyPreopen0520] threshold env 자동 apply 산출물 및 사용자 개입 여부 확인` (`Due: 2026-05-20`, `Slot: PREOPEN`, `TimeWindow: 08:50~08:55`, `Track: RuntimeStability`)
...
- [ ] `[OpenAIWSPreopenConfirm0520] OpenAI WS 유지 설정 및 entry_price/analyze_target provenance 확인` (`Due: 2026-05-20`, `Slot: PREOPEN`, `TimeWindow: 08:55~09:00`, `Track: RuntimeStability`)
