...
- [ ] `[CodeImprovementWorkorderReview0601] code improvement workorder 구현 필요 여부 및 Codex 지시 대상 확인` (`Due: 2026-06-01`, `Slot: POSTCLOSE`, `TimeWindow: 16:45~17:00`, `Track: ScalpingLogic`)
  ...
  - 판정 기준: selected_order_count=101와 `implement_now`, `attach_existing_family`, `design_family_candidate`, `reject` 분류를 확인한다.
  - 금지: code-improvement workorder를 자동 repo 수정으로 취급하지 않는다. 사용자가 Codex 구현을 지시한 경우에만 실행한다.
  - 다음 액션: 구현 필요, 설계 보류, reject, already_implemented 중 하나로 닫는다.

- [ ] `[HumanInterventionSummary0601] 자동화체인 사용자 개입 요구사항 분류 및 누락 확인` (`Due: 2026-06-01`, `Slot: POSTCLOSE`, `TimeWindow: 17:00~17:15`, `Track: RuntimeStability`)
...
- [ ] `[ShadowCanaryCohortReview0601] shadow/canary/cohort 런타임 분류 및 정리 판정` (`Due: 2026-06-01`, `Slot: POSTCLOSE`, `TimeWindow: 18:40~18:55`, `Track: Plan`)
...
- [ ] `[RuntimeApplyGapDirectiveReview0601] runtime apply gap Codex 작업지시 표면화 및 구현 여부 확인` (`Due: 2026-06-01`, `Slot: POSTCLOSE`, `TimeWindow: 17:15~17:30`, `Track: ScalpingLogic`)
