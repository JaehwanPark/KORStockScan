...
- [ ] `[NxtRisingMissedRuntimeMonitor0721] NXT 거래 window rising-missed·freshness·submit·multi-leg·exit 관측 및 NXT 전용 보완 판정` (`Due: 2026-07-21`, `Slot: INTRADAY`, `TimeWindow: 16:00~19:20`, `Track: ScalpingLogic`)
  ...
  - 다음 액션: 19:20 KST까지 PID/provider/WS와 NXT event provenance를 관찰하고 `nxt_runtime_healthy_no_change|nxt_specific_observation_gap|nxt_specific_bounded_change_reviewed|common_runtime_contamination_detected|insufficient_nxt_sample_keep_observing` 중 하나로 닫는다.
