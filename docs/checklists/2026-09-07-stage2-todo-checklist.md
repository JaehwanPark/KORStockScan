...
- 이관 기록: `ScannerLookupAttentionNaturalEvidence0908`의 미완료 acceptance는 [9/8 checklist](2026-09-08-stage2-todo-checklist.md)의 같은 ID로 옮겼다. 아래는 원 요청·근거 보존이며 완료 체크나 중복 OPEN이 아니다.
...
- 이관 기록: `EntryRecheckNaturalAttribution0907`의 미완료 acceptance는 [9/8 checklist](2026-09-08-stage2-todo-checklist.md)의 같은 ID로 옮겼다. 아래는 원 요청·근거 보존이며 완료 체크나 중복 OPEN이 아니다.
...
- 이관 기록: `[MarketWeaknessNaturalEvidence0907] market breadth immutable policy·health·0B/0D yield·비용 차감 EV 자연 확인` (원래 `Due: 2026-09-07`, `Slot: POSTCLOSE`, `TimeWindow: 09:00~21:35`, `Track: RuntimeStability`). 미완료 수용조건과 아래 이력은 보존하며 현재 실행 owner는 [9/9 체크리스트](2026-09-09-stage2-todo-checklist.md)의 같은 ID다. 완료 처리하지 않고 이전 중복 OPEN 표시만 제거했다.
...
- 이관 기록: `AIDecisionActionOutcomeNaturalEvidence0908`의 미완료 acceptance는 [9/8 checklist](2026-09-08-stage2-todo-checklist.md)의 같은 ID로 옮겼다. 아래는 원 요청·근거 보존이며 완료 체크나 중복 OPEN이 아니다.
...
- 이관 기록: `DailyThresholdNaturalAcceptance0908`의 미완료 acceptance는 [9/8 checklist](2026-09-08-stage2-todo-checklist.md)의 동일 ID로 이관했다. 아래는 최초 계약/근거의 이력이며 완료 체크나 중복 OPEN이 아니다. 현행 경제성 승인 계약은 9/8 재설계 보고서를 따른다.
