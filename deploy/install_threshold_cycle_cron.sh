...
10 20 * * 1-5 THRESHOLD_CYCLE_AI_CORRECTION_PROVIDER=openai THRESHOLD_CYCLE_POSTCLOSE_BOT_ACTION=stop $PROJECT_DIR/deploy/run_threshold_cycle_postclose.sh \$(TZ=Asia/Seoul date +\\%F) >> $PROJECT_DIR/logs/threshold_cycle_postclose_cron.log 2>&1 # THRESHOLD_CYCLE_POSTCLOSE
EOF
