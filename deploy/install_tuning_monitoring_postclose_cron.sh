...
10 20 * * 1-5 TUNING_MONITORING_PREDECESSOR_WAIT_SEC=14400 $RUNNER \$(TZ=Asia/Seoul date +\\%F) >> $PROJECT_DIR/logs/tuning_monitoring_postclose_cron.log 2>&1 # TUNING_MONITORING_POSTCLOSE
EOF
