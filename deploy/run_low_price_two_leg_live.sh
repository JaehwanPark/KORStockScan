...
case "$PROFILE" in
  ...
  samsung_heavy_afternoon)
    ...
    ;;
  daewoo_ec_midday)
    export KORSTOCKSCAN_LOW_PRICE_TWO_LEG_DAEWOO_EC_MIDDAY_ENABLED=true
    CONFIRM="047040_MIDDAY_TWO_LEG_LIVE"
    ;;
  daewoo_ec_afternoon)
    export KORSTOCKSCAN_LOW_PRICE_TWO_LEG_DAEWOO_EC_AFTERNOON_ENABLED=true
    CONFIRM="047040_AFTERNOON_TWO_LEG_LIVE"
    ;;
  sk_eternix_midday)
