...
생성일: 2026-07-29 08:06:40
분석 기간: 2026-06-04 ~ 2026-07-28
...
|---|---:|---:|---:|---:|---|
| full_fill | 252 | 58.3% | +0.430% | -26.410% | ✓ |
| split-entry | 38 | 39.5% | -0.230% | -37.190% | ✓ |

### 1-4. 튜닝 관찰축 요약

- `WAIT65~79 total_candidates=0`, `recovery_check=0`, `promoted=0`, `submitted=0`
- `blocked_ai_score_share=0.0%`, `gatekeeper_eval_ms_p95=0ms`, `budget_pass_to_submitted_rate=18.9%`
...
- 빈도: 44건 | 손익 중앙값: -3.190% | 기여손익: -136.760%
- 보유시간 중앙값: 2486.5초
- 선행 조건: 없음
...
- 빈도: 104건 | 손익 중앙값: +1.410% | 기여손익: +175.230%
...
**#1** — `AI threshold miss`
- 차단 건수 합계: 293275건 | 차단 비율: 99.8% | 관찰 일수: 40일

**#2** — `latency guard miss`
- 차단 건수 합계: 142063건 | 차단 비율: 99.6% | 관찰 일수: 40일

**#3** — `overbought gate miss`
- 차단 건수 합계: 16740건 | 차단 비율: 96.9% | 관찰 일수: 40일
