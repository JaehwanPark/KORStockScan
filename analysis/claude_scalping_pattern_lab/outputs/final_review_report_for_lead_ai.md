...
생성일: 2026-07-30 21:23:24
분석 기간: 2026-06-04 ~ 2026-07-30
...
|---|---:|---:|---:|---:|---|
| full_fill | 257 | 58.0% | +0.420% | -34.830% | ✓ |
| split-entry | 38 | 39.5% | -0.230% | -37.190% | ✓ |

### 1-4. 튜닝 관찰축 요약

- `WAIT65~79 total_candidates=2`, `recovery_check=0`, `promoted=0`, `submitted=0`
- `blocked_ai_score_share=50.0%`, `gatekeeper_eval_ms_p95=0ms`, `budget_pass_to_submitted_rate=10.0%`
...
- 빈도: 46건 | 손익 중앙값: -3.225% | 기여손익: -145.620%
- 보유시간 중앙값: 2364.5초
- 선행 조건: 없음
...
- 빈도: 106건 | 손익 중앙값: +1.400% | 기여손익: +175.900%
...
**#1** — `AI threshold miss`
- 차단 건수 합계: 293858건 | 차단 비율: 99.8% | 관찰 일수: 42일

**#2** — `latency guard miss`
- 차단 건수 합계: 142082건 | 차단 비율: 99.6% | 관찰 일수: 42일

**#3** — `overbought gate miss`
- 차단 건수 합계: 16740건 | 차단 비율: 96.8% | 관찰 일수: 42일
