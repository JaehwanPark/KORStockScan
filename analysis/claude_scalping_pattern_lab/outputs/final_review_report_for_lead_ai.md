...
생성일: 2026-07-29 22:26:06
분석 기간: 2026-06-04 ~ 2026-07-29
...
|---|---:|---:|---:|---:|---|
| full_fill | 256 | 58.2% | +0.425% | -29.640% | ✓ |
| split-entry | 38 | 39.5% | -0.230% | -37.190% | ✓ |

### 1-4. 튜닝 관찰축 요약

- `WAIT65~79 total_candidates=0`, `recovery_check=0`, `promoted=0`, `submitted=0`
- `blocked_ai_score_share=0.0%`, `gatekeeper_eval_ms_p95=0ms`, `budget_pass_to_submitted_rate=22.2%`
...
- 빈도: 45건 | 손익 중앙값: -3.200% | 기여손익: -140.430%
- 보유시간 중앙값: 2473.0초
- 선행 조건: 없음
...
**#1** — `AI threshold miss`
- 차단 건수 합계: 293589건 | 차단 비율: 99.8% | 관찰 일수: 41일

**#2** — `latency guard miss`
- 차단 건수 합계: 142075건 | 차단 비율: 99.6% | 관찰 일수: 41일

**#3** — `overbought gate miss`
- 차단 건수 합계: 16740건 | 차단 비율: 96.8% | 관찰 일수: 41일
