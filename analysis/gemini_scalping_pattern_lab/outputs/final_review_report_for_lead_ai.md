...
- generated_at: `2026-05-28 16:38:28`
...
**#1** — `AI threshold miss`
- 차단 건수 합계: 4688603건 | 차단 비율: 100.0% | 관찰 일수: 33일

**#2** — `overbought gate miss`
- 차단 건수 합계: 1527342건 | 차단 비율: 100.0% | 관찰 일수: 33일

**#3** — `latency guard miss`
- 차단 건수 합계: 122242건 | 차단 비율: 99.7% | 관찰 일수: 33일

**#4** — `liquidity gate miss`
- 차단 건수 합계: 91655건 | 차단 비율: 99.6% | 관찰 일수: 33일
