...
- generated_at: `2026-05-26 16:29:14`
...
- `blocked_ai_score_share=79.8%`, `budget_pass_to_submitted_rate=0.8%`, `gatekeeper_eval_ms_p95=5831ms`
...
**#1** — `AI threshold miss`
- 차단 건수 합계: 4658574건 | 차단 비율: 100.0% | 관찰 일수: 31일

**#2** — `overbought gate miss`
- 차단 건수 합계: 1516814건 | 차단 비율: 100.0% | 관찰 일수: 31일

**#3** — `liquidity gate miss`
- 차단 건수 합계: 89290건 | 차단 비율: 99.6% | 관찰 일수: 31일

**#4** — `latency guard miss`
- 차단 건수 합계: 64641건 | 차단 비율: 99.5% | 관찰 일수: 31일
...
- `AI threshold miss EV 회수 조건 점검`
  검증지표: 차단건수=4658574, 차단비율=100.0%
- `overbought gate miss EV 회수 조건 점검`
  검증지표: 차단건수=1516814, 차단비율=100.0%
