...
- generated_at: `2026-05-21 17:45:38`
- analysis_period: `2026-04-21 ~ 2026-05-21`
...
- `blocked_ai_score_share=57.9%`, `budget_pass_to_submitted_rate=1.5%`, `gatekeeper_eval_ms_p95=5455ms`
...
**#1** — `AI threshold miss`
- 차단 건수 합계: 4559709건 | 차단 비율: 100.0% | 관찰 일수: 27일

**#2** — `overbought gate miss`
- 차단 건수 합계: 1471081건 | 차단 비율: 100.0% | 관찰 일수: 27일

**#3** — `liquidity gate miss`
- 차단 건수 합계: 86683건 | 차단 비율: 99.6% | 관찰 일수: 27일

**#4** — `latency guard miss`
- 차단 건수 합계: 62163건 | 차단 비율: 99.5% | 관찰 일수: 27일
...
- `AI threshold miss EV 회수 조건 점검`
  검증지표: 차단건수=4559709, 차단비율=100.0%
- `overbought gate miss EV 회수 조건 점검`
  검증지표: 차단건수=1471081, 차단비율=100.0%
