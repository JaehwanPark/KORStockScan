...
- generated_at: `2026-05-22 17:05:52`
...
- `blocked_ai_score_share=74.3%`, `budget_pass_to_submitted_rate=0.0%`, `gatekeeper_eval_ms_p95=5221ms`
...
**#1** — `AI threshold miss`
- 차단 건수 합계: 4623195건 | 차단 비율: 100.0% | 관찰 일수: 28일

**#2** — `overbought gate miss`
- 차단 건수 합계: 1495965건 | 차단 비율: 100.0% | 관찰 일수: 28일

**#3** — `liquidity gate miss`
- 차단 건수 합계: 87859건 | 차단 비율: 99.7% | 관찰 일수: 28일

**#4** — `latency guard miss`
- 차단 건수 합계: 62245건 | 차단 비율: 99.5% | 관찰 일수: 28일
...
- `AI threshold miss EV 회수 조건 점검`
  검증지표: 차단건수=4623195, 차단비율=100.0%
- `overbought gate miss EV 회수 조건 점검`
  검증지표: 차단건수=1495965, 차단비율=100.0%
