...
- generated_at: `2026-05-29 21:32:03`
...
- `blocked_ai_score_share=72.8%`, `budget_pass_to_submitted_rate=0.0%`, `gatekeeper_eval_ms_p95=3582ms`
...
**#1** — `AI threshold miss`
- 차단 건수 합계: 4715643건 | 차단 비율: 100.0% | 관찰 일수: 34일

**#2** — `overbought gate miss`
- 차단 건수 합계: 1539209건 | 차단 비율: 100.0% | 관찰 일수: 34일

**#3** — `latency guard miss`
- 차단 건수 합계: 138246건 | 차단 비율: 99.7% | 관찰 일수: 34일

**#4** — `liquidity gate miss`
- 차단 건수 합계: 92545건 | 차단 비율: 99.6% | 관찰 일수: 34일
...
- `AI threshold miss EV 회수 조건 점검`
  검증지표: 차단건수=4715643, 차단비율=100.0%
- `overbought gate miss EV 회수 조건 점검`
  검증지표: 차단건수=1539209, 차단비율=100.0%
