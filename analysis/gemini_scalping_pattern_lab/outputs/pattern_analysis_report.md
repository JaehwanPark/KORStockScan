...
- `WAIT65~79 total_candidates=35`
- `recovery_check=0`, `promoted=0`, `submitted=0`
- `blocked_ai_score_share=74.3%`, `gatekeeper_eval_ms_p95=5221ms`
...
### 1. AI threshold miss
- 판정: EV 회수 우선 후보
- 근거: 차단건수 4623195건, 차단비율 100.0%, 관찰일수 28일
- 다음 액션: blocker 성격을 관찰축과 연결해 원인 귀속

### 2. overbought gate miss
- 판정: EV 회수 우선 후보
- 근거: 차단건수 1495965건, 차단비율 100.0%, 관찰일수 28일
- 다음 액션: blocker 성격을 관찰축과 연결해 원인 귀속

### 3. liquidity gate miss
- 판정: EV 회수 우선 후보
- 근거: 차단건수 87859건, 차단비율 99.7%, 관찰일수 28일
- 다음 액션: blocker 성격을 관찰축과 연결해 원인 귀속

### 4. latency guard miss
- 판정: EV 회수 우선 후보
- 근거: 차단건수 62245건, 차단비율 99.5%, 관찰일수 28일
- 다음 액션: blocker 성격을 관찰축과 연결해 원인 귀속
