# Pattern Lab Currentness Audit - 2026-05-27
...
### `gemini_scalping_observability_source_contract`

- status: `pass`
- severity: `info`
- finding: gemini_scalping tuning observability output must expose schema_version>=3, source_quality, source_contract_status=pass, and source contract workorders when producer/consumer inputs drift.
- sources: `['analysis/gemini_scalping_pattern_lab/outputs/tuning_observability_summary.json']`
...
- status: `pass`
- severity: `info`
- finding: gemini_scalping manifest must cover target_date=2026-05-27; stale outputs cannot be reused as fresh source.
...
- status: `pass`
- severity: `info`
- finding: claude_scalping manifest must cover target_date=2026-05-27; stale outputs cannot be reused as fresh source.
...
- status: `pass`
- severity: `info`
- finding: deepseek_swing manifest must cover target_date=2026-05-27; stale outputs cannot be reused as fresh source.
