# Lifecycle Bucket Discovery - 2026-09-04_mtd
...
- surfaced_candidate_count: `89`
- canonical/legacy buckets: `166` / `481`
- dual_proposals: deterministic=`500` ai=`1` hybrid_selected=`1`
- absorbed/source_quality_blocker: `345` / `0`
- lifecycle_flow_parent_granularity: `target_pass` level=`L2_default` parents=`33` target=`30-60`
- lifecycle_flow_absorbed_children: child=`82` sample=`6512` conflict_parents=`0`
...
- active_sim_priority: eligible=`2` active=`2` source_blocked=`7` parent_count_decoupled=`0`
...
- source_dimension_gap_count: `52` / actionable_unknown_gap_count: `0`
- quiet_gap_count: `411` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`34482`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`81` context_chars=`39555`
- `sim_policy_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`34452`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`34458`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`34454`

### Source Dimension Gap Enrichment
- gap_count: `52` / actionable_unknown_gap_count: `0`
