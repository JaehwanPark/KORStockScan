# Lifecycle Bucket Discovery - 2026-06-08_mtd
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`28311`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`199` context_chars=`34855`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`11` context_chars=`34841`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`28287`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`28283`
