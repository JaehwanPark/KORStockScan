# Lifecycle Bucket Discovery - 2026-09-03_rolling5d
...
- canonical/legacy buckets: `167` / `480`
- dual_proposals: deterministic=`500` ai=`1` hybrid_selected=`1`
- absorbed/source_quality_blocker: `344` / `0`
- lifecycle_flow_parent_granularity: `target_pass` level=`L2_default` parents=`33` target=`30-60`
- lifecycle_flow_absorbed_children: child=`78` sample=`7165` conflict_parents=`0`
...
- source_dimension_gap_count: `48` / actionable_unknown_gap_count: `0`
- quiet_gap_count: `423` / sim_live_connected: `0`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33036`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`77` context_chars=`38109`
- `sim_policy_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33006`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33012`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`33008`

### Source Dimension Gap Enrichment
- gap_count: `48` / actionable_unknown_gap_count: `0`
