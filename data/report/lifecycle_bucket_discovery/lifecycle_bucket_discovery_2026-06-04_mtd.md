# Lifecycle Bucket Discovery - 2026-06-04_mtd
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`28021`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`61` context_chars=`33041`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`85` context_chars=`31552`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`27997`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`27993`
