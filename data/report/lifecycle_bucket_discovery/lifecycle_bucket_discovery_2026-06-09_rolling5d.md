# Lifecycle Bucket Discovery - 2026-06-09_rolling5d
...
- lifecycle_flow_absorbed_children: child=`261` sample=`54728` conflict_parents=`10`
...
- quiet_gap_count: `450` / sim_live_connected: `30`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`28499`
- `lifecycle_flow_review` status=`disabled` candidates=`1` omitted=`199` context_chars=`35055`
- `sim_policy_review` status=`disabled` candidates=`1` omitted=`17` context_chars=`35029`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`28475`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`28471`
