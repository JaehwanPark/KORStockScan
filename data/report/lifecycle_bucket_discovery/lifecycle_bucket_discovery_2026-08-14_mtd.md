# Lifecycle Bucket Discovery - 2026-08-14_mtd
...
- lifecycle_flow_absorbed_children: child=`132` sample=`10643` conflict_parents=`1`
...
- active_sim_priority: eligible=`4` active=`4` source_blocked=`9` parent_count_decoupled=`0`
...
- quiet_gap_count: `388` / sim_live_connected: `1`
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41882`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`131` context_chars=`48460`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`11` context_chars=`45383`
- `gap_workorder_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41858`
- `taxonomy_discovery_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`41854`

### Source Dimension Gap Enrichment
- gap_count: `94` / actionable_unknown_gap_count: `0`
