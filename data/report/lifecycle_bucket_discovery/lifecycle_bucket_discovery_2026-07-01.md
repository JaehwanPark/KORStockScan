# Lifecycle Bucket Discovery - 2026-07-01
...
### AI Review Shards
- `live_contract_review` status=`skipped_empty` candidates=`0` omitted=`0` context_chars=`42175`
- `lifecycle_flow_review` status=`parsed` candidates=`1` omitted=`72` context_chars=`48752`
- `sim_policy_review` status=`parsed` candidates=`1` omitted=`12` context_chars=`45676`
- `gap_workorder_review` status=`parsed` candidates=`1` omitted=`13` context_chars=`45709`
- `taxonomy_discovery_review` status=`parsed` candidates=`1` omitted=`12` context_chars=`45892`
