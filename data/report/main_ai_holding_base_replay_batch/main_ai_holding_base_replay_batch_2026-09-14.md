# Main AI Holding Base Replay Manifest - 2026-09-14

## Decision
- status: `ready_source_only_holding_base_manifest`
- decision: `holding_base_request_path_hash_bound_provider_execution_gated`
- exact request fingerprints: `52`
- natural_empty_holding_observation: `False`
- provider_call_performed: `False`

## Cohorts
- `KRX/KRX_REGULAR` status=`connected_and_hash_bound`, requests=`52`, future provider candidate/deferred=`30/22`, reason=`None`
