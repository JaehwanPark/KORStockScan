...
- 근거: LDM `sim_auto_approved=123` (`-17`), `live_auto_apply_ready=7` (`+7`), swing sim-auto `0` (`+0`).
...
- Lifecycle bucket: candidates `500` (`+0`), surfaced `238` (`-11`), sim-auto `123` (`-17`), live-ready `7` (`+7`).
...
- Swing matrix: rows `3685` (`+413`), probe `81` (`+13`), pending future quotes `3033` (`+416`).
...
- selected orders `101`, selected decisions `{"attach_existing_family": 97, "implement_now": 4}`, routes `{"auto_patch_required": 3, "existing_family": 97, "instrumentation_order": 1}`.
