...
- 근거: LDM `sim_auto_approved=73` (`-22`), `live_auto_apply_ready=0` (`+0`), swing sim-auto `0` (`+0`).
...
- Bridge/verifier: greenfield_policy_emit_state `not_emitted_no_complete_lifecycle_flow`, promotion_contract_passed `True`, verifier_status `warning`, verifier_missing `[]`, handoff_warnings `["active_sim_priority_preopen_handoff_pending", "active_sim_priority_runtime_observation_missing", "swing_active_arm_priority_runtime_observation_missing", "swing_lifecycle_bucket_discovery:ai_two_pass_review_fail_closed_sim_auto_blocked", "swing_lifecycle_bucket_discovery:ai_two_pass_review_missing_fail_closed"]`.
- Runtime gap audit: status `pass`, directives `3`, source_dimension_gap `164`, quiet_gap `308`, quiet_gap_directives `1`.
...
- EV warnings: `lifecycle_bucket_discovery:source_contract_drift_warning, lifecycle_bucket_discovery:source_contract_drift_warning, swing_strategy_discovery:pending_future_quotes, swing_lifecycle_decision_matrix:pending_future_quotes, swing_lifecycle_bucket_discovery:ai_two_pass_review_missing_fail_closed, swing_lifecycle_bucket_discovery:ai_two_pass_review_fail_closed_sim_auto_blocked, pattern_lab_currentness_audit_warning, pattern_lab_ai_review_warning, pattern_lab_ai_review_ai_review_followup_required, pattern_lab_propagation_audit_warning`.

## Workorder

- selected orders `134`, selected decisions `{"attach_existing_family": 112, "implement_now": 22}`, routes `{"ai_review_coverage_review": 1, "auto_patch_required": 12, "existing_family": 108, "implement_now": 8, "instrumentation_order": 1, "parent_conflict_exclusion_review": 1, "positive_source_only_review": 1, "review_ai_output": 1, "source_dimension_rollup": 1}`.
- pattern lab AI review source orders `6`, pattern lab currentness source orders `2`.
