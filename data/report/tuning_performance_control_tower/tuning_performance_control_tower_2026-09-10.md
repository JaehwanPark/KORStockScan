# Tuning Performance Control Tower - 2026-09-10
...
- sim_priority_only: `0`
- observation_scope: runtime_policy_source_date=`2026-09-09` postclose_candidate_source_date=`2026-09-10` new_postclose_candidates_due_state=`not_due_until_next_preopen`
...
- Daily completed trades `5`, win-rate `60.0`, avg profit pct `0.366`, realized PnL KRW `None`.
...
- Real split sample `5`, avg `0.366`, win-rate `0.6`.
- Sim split sample `10`, avg `-0.656`, win-rate `0.5`.
...
- selected orders `27`, selected decisions `{"attach_existing_family": 11, "defer_evidence": 3, "implement_now": 13}`, routes `{"existing_family": 10, "implement_now": 2, "instrumentation_order": 10, "maintenance_review": 2, "pattern_lab_ai_review_followup_evidence": 1, "pattern_lab_exact_currentness_evidence": 1, "source_quality_warning_producer_fix": 1}`.
- root-cause closure `{"handoff_closed_root_cause_open": 4, "implementation_done": 5, "needs_followup_workorder": 13, "root_cause_closed": 1}`, implementation_done `5`, artifact_regeneration_required `0`, handoff_closed_root_cause_open `4`, root_cause_closed `1`, needs_followup `13`.
- pattern lab AI review source orders `3`, pattern lab currentness source orders `1`.
...
- observation_source_quality_audit: `/home/ubuntu/KORStockScan/data/report/observation_source_quality_audit/observation_source_quality_audit_2026-09-10.json` exists=true json_valid=true
- threshold_cycle_ev: `/home/ubuntu/KORStockScan/data/report/threshold_cycle_ev/threshold_cycle_ev_2026-09-10.json` exists=true json_valid=true
- threshold_cycle_calibration: `/home/ubuntu/KORStockScan/data/report/threshold_cycle_calibration/threshold_cycle_calibration_2026-09-10_postclose.json` exists=true json_valid=true
- threshold_cycle_ai_review: `/home/ubuntu/KORStockScan/data/report/threshold_cycle_ai_review/threshold_cycle_ai_review_2026-09-10_postclose.json` exists=true json_valid=true
- runtime_approval_summary: `/home/ubuntu/KORStockScan/data/report/runtime_approval_summary/runtime_approval_summary_2026-09-10.json` exists=true json_valid=true
- runtime_apply_bridge: `/home/ubuntu/KORStockScan/data/report/runtime_apply_bridge/runtime_apply_bridge_2026-09-10.json` exists=false json_valid=false
- runtime_apply_gap_audit: `/home/ubuntu/KORStockScan/data/report/runtime_apply_gap_audit/runtime_apply_gap_audit_2026-09-10.json` exists=true json_valid=true
- key_lineage_ledger: `/home/ubuntu/KORStockScan/data/report/key_lineage_ledger/key_lineage_ledger_2026-09-10.json` exists=true json_valid=true
- conversion_lane: `/home/ubuntu/KORStockScan/data/report/conversion_lane/conversion_lane_2026-09-10.json` exists=true json_valid=true
- lifecycle_decision_matrix: `/home/ubuntu/KORStockScan/data/report/lifecycle_decision_matrix/lifecycle_decision_matrix_2026-09-10.json` exists=false json_valid=false
- lifecycle_bucket_discovery: `/home/ubuntu/KORStockScan/data/report/lifecycle_bucket_discovery/lifecycle_bucket_discovery_2026-09-10.json` exists=false json_valid=false
- swing_lifecycle_decision_matrix: `/home/ubuntu/KORStockScan/data/report/swing_lifecycle_decision_matrix/swing_lifecycle_decision_matrix_2026-09-10.json` exists=false json_valid=false
- swing_lifecycle_bucket_discovery: `/home/ubuntu/KORStockScan/data/report/swing_lifecycle_bucket_discovery/swing_lifecycle_bucket_discovery_2026-09-10.json` exists=false json_valid=false
- code_improvement_workorder: `/home/ubuntu/KORStockScan/data/report/code_improvement_workorder/code_improvement_workorder_2026-09-10.json` exists=true json_valid=true
- threshold_apply: `/home/ubuntu/KORStockScan/data/threshold_cycle/apply_plans/threshold_apply_2026-09-10.json` exists=true json_valid=true
- threshold_cycle_postclose_verification: `/home/ubuntu/KORStockScan/data/report/threshold_cycle_postclose_verification/threshold_cycle_postclose_verification_2026-09-10.json` exists=true json_valid=true
- scalp_sim_auto_approval: `/home/ubuntu/KORStockScan/data/threshold_cycle/sim_auto_approvals/scalp_sim_auto_approval_2026-09-10.json` exists=true json_valid=true
- scalp_sim_policy_catalog: `/home/ubuntu/KORStockScan/data/threshold_cycle/scalp_sim_policies/scalp_sim_policy_catalog_2026-09-10.json` exists=true json_valid=true
