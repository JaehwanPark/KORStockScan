...
- 근거: LDM `sim_auto_approved=95` (`-28`), `live_auto_apply_ready=0` (`+0`), swing sim-auto `0` (`+0`).
...
- Bridge/verifier: greenfield_policy_emit_state `not_emitted_no_complete_lifecycle_flow`, promotion_contract_passed `True`, verifier_status `warning`, verifier_missing `[]`, handoff_warnings `["swing_lifecycle_bucket_discovery:ai_two_pass_review_missing_fail_closed", "swing_lifecycle_bucket_discovery:ai_two_pass_review_missing_source_only"]`.
- Runtime gap audit: status `pass`, directives `4`, source_dimension_gap `150`, quiet_gap `287`, quiet_gap_directives `1`.
...
- Swing matrix: rows `95919` (`+31984`), probe `91483` (`+31610`), pending future quotes `3458` (`+403`).
...
- EV warnings: `lifecycle_bucket_discovery:source_contract_drift_warning, lifecycle_bucket_discovery:source_contract_drift_warning, swing_strategy_discovery:pending_future_quotes, swing_lifecycle_decision_matrix:pending_future_quotes, swing_lifecycle_bucket_discovery:ai_two_pass_review_missing_source_only, swing_lifecycle_bucket_discovery:ai_two_pass_review_missing_fail_closed`.

## Workorder

- selected orders `106`, selected decisions `{"attach_existing_family": 100, "implement_now": 6}`, routes `{"ai_review_coverage_review": 1, "attach_existing_family": 1, "auto_patch_required": 5, "existing_family": 91, "instrumentation_order": 1, "parent_conflict_exclusion_review": 1, "performance_optimization_order": 4, "positive_source_only_review": 1, "source_dimension_rollup": 1}`.
...
- runtime_apply_gap_audit: `/home/ubuntu/KORStockScan/data/report/runtime_apply_gap_audit/runtime_apply_gap_audit_2026-06-01.json` exists=true json_valid=true
