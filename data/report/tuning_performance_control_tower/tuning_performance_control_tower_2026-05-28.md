...
- 근거: LDM `sim_auto_approved=181` (`-4`), `live_auto_apply_ready=0` (`-1`), swing sim-auto `13` (`+5`).
...
- Lifecycle bucket: candidates `500` (`+121`), surfaced `258` (`+72`), sim-auto `181` (`-4`), live-ready `0` (`-1`).
- Lifecycle matrix: rows `24454` (`-16718`), joined `23739` (`-15725`), promote-ready `1` (`+0`).
- Lifecycle flow: buckets `69` (`-13`), complete `0` (`+0`), runtime `0` (`+0`), workorders `20` (`+0`).
- Holding/exit buckets: holding `31` (`+1`), exit `67` (`+13`), workorders `10`/`10`.
- Lifecycle identity: missing `0` (`+0`), join_rate `1.0`, complete_flow_rate `0.0`.
- Lifecycle join contract: blocked `true`, incomplete `12962`, top reason `missing_holding`.
- Swing matrix: rows `2922` (`+147`), probe `68` (`-253`), pending future quotes `2557` (`+319`).
- Swing bucket: sim-auto `13` (`+5`), code-patch `18` (`+4`).
...
- EV warnings: `lifecycle_bucket_discovery:source_contract_drift_warning, swing_strategy_discovery:pending_future_quotes, swing_lifecycle_decision_matrix:pending_future_quotes, pattern_lab_ai_review_warning, pattern_lab_ai_review_ai_review_followup_required`.

## Workorder

- selected orders `112`, selected decisions `{"attach_existing_family": 93, "implement_now": 19}`, routes `{"existing_family": 93, "implement_now": 3, "instrumentation_order": 15, "review_ai_output": 1}`.
