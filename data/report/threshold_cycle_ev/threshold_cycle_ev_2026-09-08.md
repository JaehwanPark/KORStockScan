# Threshold Cycle Daily EV Report - 2026-09-08
...
- runtime_change: `True`
- selected_families: `score65_74_recovery_probe, scalping_scanner_real_source_guard_runtime, score65_74_recovery_probe_strong_micro_override_runtime, entry_price_gap_profile_runtime, profit_stagnation_exit_runtime, latency_spread_relief_real_operator_override, quote_consistency_normalization, scalp_sim_candidate_window_expansion, scalp_sim_ai_budget_manager, post_probe_winner_recovery, entry_opportunity_recheck_runtime, holding_decision_context_v1, weak_pullback_entry_block_runtime, early_accel_recheck_runtime, real_pyramid_scale_in_quality_guard_runtime, sell_side_open_time_block_runtime, pre_submit_liquidity_relief_runtime, weak_context_late_entry_guard_runtime, rising_missed_normal_buy_bridge, persistent_operator_overrides_2026_06_26`
...
## Entry Funnel
- budget_pass_to_submitted: `0` / `617` (`0.0`%)
- latency pass/block: `92` / `367`
...
- entry_split_order_plan: status=`pass` candidates=`0` policy=`entry_split_order_plan:2026-09-08:97d170e155`
- scale_in_split_order_plan: status=`pass` candidates=`1` policy=`scale_in_split_order_plan:2026-09-08:dfef4ae66496`

## Holding Exit
- holding_reviews: `185`
- exit_signals: `3`
- holding_review_ms_p95: `8002.0`
...
- completed_profit_summary: `{'sample': 4, 'win_count': 1, 'loss_count': 3, 'avg_profit_rate': -1.7125, 'median_profit_rate': -3.09, 'downside_p10_profit_rate': -3.35, 'upside_p90_profit_rate': 1.09, 'win_rate': 0.25, 'loss_rate': 0.75, 'stddev_profit_rate': 2.0395}`
- post_sell_join: joined=`4` / pending=`0`
- post_sell_mfe_mae_10m: mfe=`0.421`% / mae=`-7.5678`% / close=`-0.146`%

## Missed Probe Counterfactual
- book: `scalp_score65_74_probe_counterfactual` / role: `missed_buy_probe_counterfactual`
- total/raw_score60_74/economic_eligible_score60_74: `10` / `0` / `0`
- avg_gross_counterfactual_ev: `-0.4326`% / avg_cost_adjusted_counterfactual_ev: `None`%
...
- artifact: `/home/ubuntu/KORStockScan/data/report/scalping_pattern_lab_automation/scalping_pattern_lab_automation_2026-09-08.json`
- fresh: gemini=`False` claude=`True`
- consensus/orders/family_candidates: `0` / `8` / `2`
...
- artifact: `/home/ubuntu/KORStockScan/data/report/pipeline_event_verbosity/pipeline_event_verbosity_2026-09-08.json`
...
## Pattern Lab Audits
- currentness: status=`pass` fail=`0` orders=`0` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_currentness_audit/pattern_lab_currentness_audit_2026-09-08.json`
- ai_review: status=`warning` orders=`3` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_ai_review/pattern_lab_ai_review_2026-09-08.json`
...
- artifact: `/home/ubuntu/KORStockScan/data/report/code_improvement_workorder/code_improvement_workorder_2026-09-08.json`
- markdown: `/home/ubuntu/KORStockScan/docs/code-improvement-workorders/code_improvement_workorder_2026-09-08.md`
- selected_order_count: `25`
- decision_counts: `{'implement_now': 12, 'attach_existing_family': 25, 'design_family_candidate': 2, 'defer_evidence': 6}`
...
- `order_scanner_eligible_no_heavy_closed_loop` decision=`implement_now` subsystem=`scanner_runtime_freshness_funnel`
- `order_scanner_scan_generation_conservation_gap` decision=`implement_now` subsystem=`scanner_runtime_freshness_funnel`

- `soft_stop_whipsaw_confirmation`: `hold_sample` sample=`897/10`
- `holding_flow_ofi_smoothing`: `hold_sample` sample=`2/20`
- `protect_trailing_smoothing`: `hold_sample` sample=`5/20`
- `trailing_continuation`: `freeze` sample=`52/20`
- `market_regime_continuous_thresholds`: `hold_sample` sample=`7/10`
- `pre_submit_price_guard`: `hold` sample=`0/1`
- `dynamic_entry_price_resolver`: `hold_sample` sample=`25/20`
...
- `strength_momentum_soft_gate_p1`: `hold` sample=`894/20`
- `overbought_pullback_guard_p1`: `hold` sample=`1161/20`
- `liquidity_pre_submit_guard_p1`: `hold` sample=`732/20`
