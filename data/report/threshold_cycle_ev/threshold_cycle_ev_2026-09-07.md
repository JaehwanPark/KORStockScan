# Threshold Cycle Daily EV Report - 2026-09-07
...
- entry_split_order_plan: status=`pass` candidates=`0` policy=`entry_split_order_plan:2026-09-07:97d170e155`
- scale_in_split_order_plan: status=`pass` candidates=`1` policy=`scale_in_split_order_plan:2026-09-07:dfef4ae66496`

## Holding Exit
- holding_reviews: `413`
- exit_signals: `8`
- holding_review_ms_p95: `8011.0`

## Scalp Simulator
- authority: `equal_weight` / fill_policy: `signal_inclusive_best_ask_v1`
- armed/filled/sold: `13` / `13` / `9`
- expired/unpriced/duplicate: `0` / `0` / `9`
- entry_ai_price applied/skip: `13` / `5`
- submit_revalidation warning/block: `0` / `0`
- scale_in filled/unfilled: `0` / `0`
- overnight decision/sell/hold/carry_restored: `0` / `0` / `0` / `0`
- completed_profit_summary: `{'sample': 9, 'win_count': 3, 'loss_count': 6, 'avg_profit_rate': -1.3567, 'median_profit_rate': -1.42, 'downside_p10_profit_rate': -3.36, 'upside_p90_profit_rate': 0.94, 'win_rate': 0.3333, 'loss_rate': 0.6667, 'stddev_profit_rate': 1.6687}`
- post_sell_join: joined=`9` / pending=`0`
- post_sell_mfe_mae_10m: mfe=`0.9204`% / mae=`-5.396`% / close=`0.5059`%

## Missed Probe Counterfactual
- book: `scalp_score65_74_probe_counterfactual` / role: `missed_buy_probe_counterfactual`
- total/raw_score60_74/economic_eligible_score60_74: `1` / `None` / `0`
- avg_gross_counterfactual_ev: `0.0`% / avg_cost_adjusted_counterfactual_ev: `None`%
- score60_74_cost_adjusted_ev: `None`% / cost_contract_complete: `None` / source_quality_or_cost_excluded: `None`
...
- artifact: `/home/ubuntu/KORStockScan/data/report/scalping_pattern_lab_automation/scalping_pattern_lab_automation_2026-09-07.json`
...
- artifact: `/home/ubuntu/KORStockScan/data/report/pipeline_event_verbosity/pipeline_event_verbosity_2026-09-07.json`
- state: `v2_shadow_pending_flush`
- recommended_workorder_state: `observe_pending_next_flush`
- high_volume_line_count: `161387`
- high_volume_byte_share_pct: `26.49`
- parity_ok: `False`
...
## Pattern Lab Audits
- currentness: status=`pass` fail=`0` orders=`0` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_currentness_audit/pattern_lab_currentness_audit_2026-09-07.json`
- ai_review: status=`warning` orders=`2` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_ai_review/pattern_lab_ai_review_2026-09-07.json`
...
- propagation: status=`pass` fail=`0` warnings=`0` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_propagation_audit/pattern_lab_propagation_audit_2026-09-07.json`
...
- artifact: `/home/ubuntu/KORStockScan/data/report/code_improvement_workorder/code_improvement_workorder_2026-09-07.json`
- markdown: `/home/ubuntu/KORStockScan/docs/code-improvement-workorders/code_improvement_workorder_2026-09-07.md`
- selected_order_count: `15`
- decision_counts: `{'implement_now': 9, 'attach_existing_family': 25, 'design_family_candidate': 2, 'reject': 1}`
...
- `strength_momentum_soft_gate_p1`: `hold` sample=`1250/20`
- `overbought_pullback_guard_p1`: `hold` sample=`1243/20`
- `liquidity_pre_submit_guard_p1`: `hold` sample=`792/20`
...
- `microstructure_reaction_context:diagnostic_contract:required_holding_payload_missing`
