# Threshold Cycle Daily EV Report - 2026-09-09
...
## Entry Funnel
- budget_pass_to_submitted: `0` / `578` (`0.0`%)
- latency pass/block: `109` / `352`
...
- entry_split_order_plan: status=`pass` candidates=`0` policy=`entry_split_order_plan:2026-09-09:97d170e155`
- scale_in_split_order_plan: status=`pass` candidates=`1` policy=`scale_in_split_order_plan:2026-09-09:dfef4ae66496`

## Holding Exit
- holding_reviews: `549`
- exit_signals: `16`
- holding_review_ms_p95: `6154.0`

## Scalp Simulator
- authority: `equal_weight` / fill_policy: `signal_inclusive_best_ask_v1`
- armed/filled/sold: `21` / `21` / `21`
- expired/unpriced/duplicate: `0` / `0` / `22`
- entry_ai_price applied/skip: `20` / `9`
- submit_revalidation warning/block: `0` / `0`
- scale_in filled/unfilled: `0` / `0`
- overnight decision/sell/hold/carry_restored: `0` / `0` / `0` / `0`
- completed_profit_summary: `{'sample': 21, 'win_count': 10, 'loss_count': 11, 'avg_profit_rate': -0.809, 'median_profit_rate': -0.23, 'downside_p10_profit_rate': -3.38, 'upside_p90_profit_rate': 1.61, 'win_rate': 0.4762, 'loss_rate': 0.5238, 'stddev_profit_rate': 1.9241}`
- post_sell_join: joined=`21` / pending=`0`
- post_sell_mfe_mae_10m: mfe=`0.9163`% / mae=`-5.3428`% / close=`-0.0094`%

## Missed Probe Counterfactual
- book: `scalp_score65_74_probe_counterfactual` / role: `missed_buy_probe_counterfactual`
- total/raw_score60_74/economic_eligible_score60_74: `38` / `0` / `0`
- avg_gross_counterfactual_ev: `0.1767`% / avg_cost_adjusted_counterfactual_ev: `None`%
...
- artifact: `/home/ubuntu/KORStockScan/data/report/scalping_pattern_lab_automation/scalping_pattern_lab_automation_2026-09-09.json`
- fresh: gemini=`False` claude=`True`
- consensus/orders/family_candidates: `0` / `7` / `2`
...
- artifact: `/home/ubuntu/KORStockScan/data/report/pipeline_event_verbosity/pipeline_event_verbosity_2026-09-09.json`
...
## Pattern Lab Audits
- currentness: status=`pass` fail=`0` orders=`0` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_currentness_audit/pattern_lab_currentness_audit_2026-09-09.json`
- ai_review: status=`warning` orders=`10` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_ai_review/pattern_lab_ai_review_2026-09-09.json`
...
- propagation: status=`pass` fail=`0` warnings=`0` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_propagation_audit/pattern_lab_propagation_audit_2026-09-09.json`
...
- artifact: `/home/ubuntu/KORStockScan/data/report/code_improvement_workorder/code_improvement_workorder_2026-09-09.json`
- markdown: `/home/ubuntu/KORStockScan/docs/code-improvement-workorders/code_improvement_workorder_2026-09-09.md`
- selected_order_count: `33`
- decision_counts: `{'implement_now': 11, 'attach_existing_family': 22, 'design_family_candidate': 2, 'defer_evidence': 16}`
...
- `strength_momentum_soft_gate_p1`: `hold` sample=`1695/20`
- `overbought_pullback_guard_p1`: `hold` sample=`1108/20`
- `liquidity_pre_submit_guard_p1`: `hold` sample=`699/20`
- `bad_entry_refined_canary`: `hold_sample` sample=`0/10`
- `scale_in_price_guard`: `hold_sample` sample=`40/20`
- `position_sizing_dynamic_formula`: `hold_sample` sample=`7/30`
