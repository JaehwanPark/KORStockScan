...
## Entry Funnel
- budget_pass_to_submitted: `0` / `11641` (`0.0`%)
- latency pass/block: `101` / `11536`
...
## Holding Exit
- holding_reviews: `2183`
- exit_signals: `456`
- holding_review_ms_p95: `1877.0`
...
- total/score65_74: `77` / `0`
- avg_expected_ev: `2.7069`% / score65_74_avg_expected_ev: `0.0`%
...
- policy_entries: `[{'stage': 'entry', 'sample': 500, 'joined_sample': 91, 'stage_ev_composite_pct': 1.3233, 'confidence': 1.0, 'selected_action': 'BUY_DEFENSIVE', 'source_quality_gate': 'pass', 'promote_ready': True}, {'stage': 'submit', 'sample': 197, 'joined_sample': 167, 'stage_ev_composite_pct': -0.6543, 'confidence': 1.0, 'selected_action': 'NO_CHANGE', 'source_quality_gate': 'pass', 'promote_ready': False}, {'stage': 'holding', 'sample': 183, 'joined_sample': 167, 'stage_ev_composite_pct': -0.8742, 'confidence': 1.0, 'selected_action': 'EXIT', 'source_quality_gate': 'pass', 'promote_ready': False}, {'stage': 'scale_in', 'sample': 20128, 'joined_sample': 20096, 'stage_ev_composite_pct': -0.4519, 'confidence': 1.0, 'selected_action': 'NO_CHANGE', 'source_quality_gate': 'pass', 'promote_ready': False}, {'stage': 'exit', 'sample': 799, 'joined_sample': 623, 'stage_ev_composite_pct': -0.7324, 'confidence': 1.0, 'selected_action': 'EXIT', 'source_quality_gate': 'pass', 'promote_ready': False}]`
...
- candidates/surfaced: `385` / `250`
- sim_auto/live_auto/new_bucket: `176` / `0` / `0`
- state_counts: `{'source_only_keep_collecting': 201, 'sim_auto_approved': 176, 'entry_only_source_candidate': 6, 'entry_only_sim_auto_approved': 2}`
- top_surfaced: `[{'bucket_id': 'lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holding_missing_scale_in_scale_in_arm_avg_down', 'stage': 'lifecycle_flow', 'classification_state': 'source_only_keep_collecting', 'live_auto_apply_family': None, 'recommended_action': 'keep_collecting', 'joined_sample': 8587, 'source_quality_adjusted_ev_pct': -0.6791}, {'bucket_id': 'lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holding_missing_scale_in_scale_in_arm_pyramid_', 'stage': 'lifecycle_flow', 'classification_state': 'source_only_keep_collecting', 'live_auto_apply_family': None, 'recommended_action': 'keep_collecting', 'joined_sample': 2023, 'source_quality_adjusted_ev_pct': 0.6588}, {'bucket_id': 'lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_source_scalp_sim_pre_submit_liquidity_gua', 'stage': 'lifecycle_flow', 'classification_state': 'source_only_keep_collecting', 'live_auto_apply_family': None, 'recommended_action': 'keep_collecting', 'joined_sample': 76, 'source_quality_adjusted_ev_pct': -0.6624}, {'bucket_id': 'lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_70p_source_wait6579_ev_cohort_stale_fresh_or_unflagged_', 'stage': 'lifecycle_flow', 'classification_state': 'source_only_keep_collecting', 'live_auto_apply_family': None, 'recommended_action': 'keep_collecting', 'joined_sample': 49, 'source_quality_adjusted_ev_pct': 1.643}, {'bucket_id': 'lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_source_scalp_sim_pre_submit_liquidity_gua', 'stage': 'lifecycle_flow', 'classification_state': 'source_only_keep_collecting', 'live_auto_apply_family': None, 'recommended_action': 'keep_collecting', 'joined_sample': 42, 'source_quality_adjusted_ev_pct': -0.5119}, {'bucket_id': 'lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_66_69_source_wait6579_ev_cohort_stale_fresh_or_unflagge', 'stage': 'lifecycle_flow', 'classification_state': 'source_only_keep_collecting', 'live_auto_apply_family': None, 'recommended_action': 'keep_collecting', 'joined_sample': 21, 'source_quality_adjusted_ev_pct': 1.1823}, {'bucket_id': 'lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_source_scalp_sim_entry_submit_revalidatio', 'stage': 'lifecycle_flow', 'classification_state': 'source_only_keep_collecting', 'live_auto_apply_family': None, 'recommended_action': 'keep_collecting', 'joined_sample': 16, 'source_quality_adjusted_ev_pct': -0.4756}, {'bucket_id': 'lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_60_62_source_scalp_entry_action_decision_snapshot_stale', 'stage': 'lifecycle_flow', 'classification_state': 'source_only_keep_collecting', 'live_auto_apply_family': None, 'recommended_action': 'keep_collecting', 'joined_sample': 8, 'source_quality_adjusted_ev_pct': 0.0085}]`
...
- eligible/applied/skipped: `1994` / `1994` / `0`
- replay_budget: `30`
...
- ofi_qi_stale_missing_reasons: `{'micro_missing': 3150, 'micro_stale': 0, 'observer_unhealthy': 8, 'micro_not_ready': 3154, 'state_insufficient': 3154}`
- ofi_qi_stale_missing_reason_combinations: `{'micro_not_ready+state_insufficient': 4, 'micro_missing+micro_not_ready+state_insufficient': 3142, 'micro_missing+observer_unhealthy+micro_not_ready+state_insufficient': 8}`
- ofi_qi_stale_missing_reason_combination_unique_records: `{'micro_missing+micro_not_ready+state_insufficient': 13, 'micro_missing+observer_unhealthy+micro_not_ready+state_insufficient': 3}`
...
- labeled/pending_future_quotes: `165` / `2483`
- implementation_status: `implemented`
- top_surviving_arm: `arm05_breakout_conf_trailing`
- surviving/avoid_bucket_count: `1` / `12`
...
## Pattern Lab Audits
- currentness: status=`warning` fail=`2` orders=`2` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_currentness_audit/pattern_lab_currentness_audit_2026-05-28.json`
- ai_review: status=`warning` orders=`4` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_ai_review/pattern_lab_ai_review_2026-05-28.json`
...
- decision_counts: `{'implement_now': 8, 'attach_existing_family': 103, 'design_family_candidate': 7, 'defer_evidence': 10, 'reject': 3}`
...
- `order_producer_gap_discovery_producer_gap_missed_fill_recovery_counterfactual_missing` decision=`implement_now` subsystem=`scalping/submit`
- `order_producer_gap_discovery_producer_gap_sim_entry_selection_gap_missing` decision=`implement_now` subsystem=`scalping/entry`
- `order_pattern_lab_ai_review_scalping_lifecycle_bucket_discovery` decision=`implement_now` subsystem=`pattern_lab`
...
- `holding_flow_ofi_smoothing`: `hold` sample=`2370/20`
...
- `lifecycle_decision_matrix_runtime`: `adjust_up` sample=`21807/20`
- `scale_in_price_guard`: `hold` sample=`808/20`
- `position_sizing_cap_release`: `hold_sample` sample=`16/30`
