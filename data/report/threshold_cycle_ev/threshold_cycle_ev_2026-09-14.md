# Threshold Cycle Daily EV Report - 2026-09-14

## Summary
- status: `warning`
- warning_count: `6`
- warning_contract active/disabled/raw: `6` / `9` / `15`
- source_quality: status=`warning` allowed=`True`
- samples real/sim: `1` / `3`
...
- runtime_change: `True`
- selected_families: `entry_split_order_plan, score65_74_recovery_probe, scalping_scanner_real_source_guard_runtime, score65_74_recovery_probe_strong_micro_override_runtime, entry_price_gap_profile_runtime, latency_spread_relief_real_operator_override, quote_consistency_normalization, scalp_sim_candidate_window_expansion, scalp_sim_ai_budget_manager, post_probe_winner_recovery, position_sizing_dynamic_formula, holding_decision_context_v1, early_accel_recheck_runtime, real_pyramid_scale_in_quality_guard_runtime, sell_side_open_time_block_runtime, pre_submit_liquidity_relief_runtime, weak_context_late_entry_guard_runtime, rising_missed_normal_buy_bridge, persistent_operator_overrides_2026_06_26`

## Daily EV
- completed: `1` / open: `0`
- win/loss: `0` / `1` (`0.0`%)
- avg_profit_rate: `-1.68`%
- realized_pnl_krw: `None`
- realized_pnl_status: `count_reconciled_snapshot_diagnostic_not_cost_verified`
- full_fill_completed_avg_profit_rate: `-1.68`%

## Entry Funnel
- budget_pass_to_submitted: `2` / `201` (`1.0`%)
- latency pass/block: `9` / `180`
...
- entry_split_order_plan: status=`pass` candidates=`1` policy=`entry_split_order_plan:2026-09-14:f66584ecf6`
- scale_in_split_order_plan: status=`pass` candidates=`1` policy=`scale_in_split_order_plan:2026-09-14:b84cc1c7e534`

## Holding Exit
- holding_reviews: `141`
- exit_signals: `16`
- holding_review_ms_p95: `8379.0`
...
- completed_profit_summary: `{'sample': 3, 'win_count': 1, 'loss_count': 2, 'avg_profit_rate': -0.3167, 'median_profit_rate': -0.72, 'downside_p10_profit_rate': -1.43, 'upside_p90_profit_rate': 1.2, 'win_rate': 0.3333, 'loss_rate': 0.6667, 'stddev_profit_rate': 1.3606}`
- post_sell_join: joined=`3` / pending=`0`
- post_sell_mfe_mae_10m: mfe=`0.527`% / mae=`-6.5707`% / close=`-0.7787`%

## Missed Probe Counterfactual
- book: `scalp_score65_74_probe_counterfactual` / role: `missed_buy_probe_counterfactual`
- total/raw_score60_74/economic_eligible_score60_74: `2` / `0` / `0`
- avg_gross_counterfactual_ev: `-0.1714`% / avg_cost_adjusted_counterfactual_ev: `None`%
...
- artifact: `/home/ubuntu/KORStockScan/data/report/scalping_pattern_lab_automation/scalping_pattern_lab_automation_2026-09-14.json`
- fresh: gemini=`False` claude=`True`
- consensus/orders/family_candidates: `0` / `7` / `1`
...
- artifact: `/home/ubuntu/KORStockScan/data/report/pipeline_event_verbosity/pipeline_event_verbosity_2026-09-14.json`
...
## Pattern Lab Audits
- currentness: status=`warning` fail=`1` orders=`1` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_currentness_audit/pattern_lab_currentness_audit_2026-09-14.json`
- ai_review: status=`warning` orders=`6` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_ai_review/pattern_lab_ai_review_2026-09-14.json`
...
- artifact: `/home/ubuntu/KORStockScan-runtime-releases/machine-entry-postclose-handoff-r6-20260915/data/report/code_improvement_workorder/code_improvement_workorder_2026-09-14.json`
- markdown: `/home/ubuntu/KORStockScan-runtime-releases/machine-entry-postclose-handoff-r6-20260915/docs/code-improvement-workorders/code_improvement_workorder_2026-09-14.md`
- selected_order_count: `57`
- decision_counts: `{'implement_now': 14, 'attach_existing_family': 30, 'design_family_candidate': 1, 'defer_evidence': 12}`
...
- `soft_stop_whipsaw_confirmation`: `adjust_up` sample=`1084/10`
- `holding_flow_ofi_smoothing`: `hold_sample` sample=`10/20`
- `protect_trailing_smoothing`: `hold_no_edge` sample=`225/20`
- `trailing_continuation`: `freeze` sample=`225/20`
...
- `entry_split_order_plan`: `adjust_up` sample=`182/20`
...
- `strength_momentum_soft_gate_p1`: `hold` sample=`874/20`
- `overbought_pullback_guard_p1`: `hold` sample=`1067/20`
- `liquidity_pre_submit_guard_p1`: `hold` sample=`730/20`
