...
- unknown_bucket_affected_rows: `338`
- unknown_bucket_dimension_counts: `{'price_resolution_bucket': 189, 'risk_context_bucket': 248, 'score_bucket': 159}`
...
- `score50_64|risk_unknown|-|fresh|price_unknown|liquidity_not_available|overbought_not_available|time_0900_1000` sample=`20` joined=`15` action=`NO_BUY_AI` sq_ev=`0.7465`
...
- `score50_64|risk_unknown|-|fresh|price_unknown|liquidity_not_available|overbought_not_available|time_1000_1200` sample=`9` joined=`9` action=`NO_BUY_AI` sq_ev=`-0.4767`
- `score50_64|risk_unknown|-|fresh|price_unknown|liquidity_not_available|overbought_not_available|time_1200_1400` sample=`9` joined=`8` action=`NO_BUY_AI` sq_ev=`-1.9022`
