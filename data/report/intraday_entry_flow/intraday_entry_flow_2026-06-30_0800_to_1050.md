...
- generated_at: 2026-06-30T10:50:00
- source_events: /home/ubuntu/KORStockScan/data/runtime/sentinel_event_cache/buy_funnel_sentinel_events_2026-06-30.jsonl
- source_diagnostic: data/report/intraday_entry_blocker_diagnostics/intraday_entry_blocker_diagnostics_2026-06-30_1050_goal.json
- event_window_since: 2026-06-30T08:00:00
- event_window_until: 2026-06-30T10:50:00
- symbol_count: 40
...
- 246: `runtime_backpressure`
- 139: `strategy_reject`
- 63: `intended_guard`
- 27: `pre_submit_quality_guard`
- 16: `watch_budget_reallocated`
- 14: `source_freshness_blocker`

## suppressed non-major blocker counts

- 246: `runtime_backpressure` / `scalping_scanner_watching_runtime_skip` / `scanner_full_eval_loop_budget_deferred`
- 17: `intended_guard` / `scalping_scanner_watching_runtime_skip` / `entry_cooldown_active`
- 14: `watch_budget_reallocated` / `scalping_scanner_watch_eviction` / `scanner_hardgate_prefilter`
...
|제룡전기(033100)|08:01:42|10:49:39|rising|5.25%|5.25%|`latency_block`/latency_state_danger|pre_submit_quality_guard|0|0|-||-||9|-|
...
|SK이터닉스(475150)|10:11:58|10:49:39|rising|4.06%|4.06%|`latency_block`/latency_state_danger|pre_submit_quality_guard|0|6|-|2668.0|10:23:16|70/USE_DEFENSIVE|3|10:12:52 blocked_strength_momentum:below_strength_base(+0.00%) -> 10:12:52 blocked_vpw(+0.00%) -> 10:12:52 blocked_ai_score:ai_score_50_buy_hold_override(+0.00%) -> 10:16:55 latency_block:latency_state_danger(+4.06%) -> ... -> 10:24:59 blocked_ai_score(+4.06%) -> 10:24:59 ai_confirmed_terminal_no_budget:blocked_ai_score_below_buy_score_threshold(+4.06%) -> 10:25:00 entry_ai_price_canary_fallback:pre_submit_price_guard(+4.06%)|
|LS ELECTRIC(010120)|08:01:43|10:49:39|rising|3.25%|3.25%|`latency_block`/latency_state_danger|pre_submit_quality_guard|5|127|diagnostic_quote_age_stale|221288.0|08:04:28|74/WAIT|9|08:03:07 latency_block:latency_state_danger(+1.73%) -> 08:04:28 latency_pass:caution_normal_entry_allowed(+2.60%) -> 08:04:43 latency_pass:caution_normal_entry_allowed(+2.60%) -> 08:04:47 order_bundle_submitted:caution_normal_entry_allowed(+2.60%) -> ... -> 10:30:25 latency_block:latency_state_danger(+3.25%) -> 10:33:50 latency_pass:caution_normal_entry_allowed(+3.25%) -> 10:33:55 order_bundle_submitted:caution_normal_entry_allowed(+3.25%)|
|삼화콘덴서(001820)|08:26:25|10:49:39|rising|2.57%|2.57%|`latency_block`/latency_state_danger|pre_submit_quality_guard|8|13|diagnostic_quote_age_stale|4569.0|10:31:19|54/WAIT|3|08:26:49 blocked_strength_momentum:below_window_buy_value(+0.00%) -> 08:26:50 ai_confirmed(+0.00%) -> 08:26:52 first_ai_wait(+0.00%) -> 08:26:52 ai_confirmed_terminal_no_budget:first_ai_wait_big_bite_not_confirmed(+0.00%) -> ... -> 10:45:02 blocked_ai_score(+2.57%) -> 10:45:02 ai_confirmed_terminal_no_budget:blocked_ai_score_below_buy_score_threshold(+2.57%) -> 10:45:03 entry_ai_price_canary_fallback:pre_submit_price_guard(+2.57%)|
...
|스피어(347700)|08:04:44|10:49:51|flat_or_falling|0.00%|0.00%|`latency_block`/latency_state_danger|pre_submit_quality_guard|10|16|diagnostic_quote_age_stale|4769.0|10:18:07|78/BUY|0|08:05:24 blocked_strength_momentum:below_window_buy_value(+0.00%) -> 10:10:15 blocked_overbought(+0.00%) -> 10:10:17 blocked_strength_momentum:below_window_buy_value(+0.00%) -> 10:10:17 blocked_vpw(+0.00%) -> ... -> 10:48:57 entry_armed:qualification_passed(+0.00%) -> 10:48:58 budget_pass(+0.00%) -> 10:48:59 latency_block:latency_state_danger(+0.00%)|
...
|미래산업(025560)|10:10:57|10:49:39|flat_or_falling|0.00%|0.00%|`scalping_scanner_watching_runtime_skip`/scanner_fast_precheck_stability_pending|strategy_reject|8|7|diagnostic_quote_age_stale|11966.0|-|64/WAIT|0|10:12:53 blocked_overbought(+0.00%) -> 10:12:55 blocked_strength_momentum:below_buy_ratio(+0.00%) -> 10:12:55 blocked_vpw(+0.00%) -> 10:12:56 ai_confirmed(+0.00%) -> ... -> 10:47:28 blocked_strength_momentum:below_window_buy_value(+0.00%) -> 10:49:21 blocked_overbought(+0.00%) -> 10:49:21 blocked_strength_momentum:insufficient_history(+0.00%)|
...
|주성엔지니어링(036930)|10:13:59|10:49:51|flat_or_falling|0.00%|0.00%|`scalping_scanner_watching_runtime_skip`/scanner_fast_precheck_stability_pending|strategy_reject|11|9|diagnostic_quote_age_stale|5146.0|-|65/WAIT|0|10:15:58 blocked_strength_momentum:below_buy_ratio(+0.00%) -> 10:15:58 blocked_vpw(+0.00%) -> 10:16:00 ai_confirmed(+0.00%) -> 10:16:00 first_ai_wait(+0.00%) -> ... -> 10:48:12 wait65_79_ev_candidate(+0.00%) -> 10:48:13 blocked_ai_score(+0.00%) -> 10:48:13 ai_confirmed_terminal_no_budget:blocked_ai_score_below_buy_score_threshold(+0.00%)|
|금호건설(002990)|10:15:00|10:49:39|flat_or_falling|0.00%|0.00%|`scalping_scanner_watching_runtime_skip`/scanner_fast_precheck_stability_pending|strategy_reject|17|11|diagnostic_quote_age_stale|4984.0|-|58/WAIT|0|10:18:10 blocked_overbought(+0.00%) -> 10:18:12 blocked_strength_momentum:below_strength_base(+0.00%) -> 10:18:12 blocked_vpw(+0.00%) -> 10:18:14 ai_confirmed(+0.00%) -> ... -> 10:49:33 ai_confirmed(+0.00%) -> 10:49:33 blocked_ai_score(+0.00%) -> 10:49:33 ai_confirmed_terminal_no_budget:blocked_ai_score_below_buy_score_threshold(+0.00%)|
