...
- generated_at: 2026-06-30T10:20:00
- source_events: /home/ubuntu/KORStockScan/data/runtime/sentinel_event_cache/buy_funnel_sentinel_events_2026-06-30.jsonl
- source_diagnostic: data/report/intraday_entry_blocker_diagnostics/intraday_entry_blocker_diagnostics_2026-06-30_1020_goal.json
- event_window_since: 2026-06-30T08:00:00
- event_window_until: 2026-06-30T10:20:00
- symbol_count: 37
- rising_symbol_count_by_max_delta: 19
- rising_missed_buy_count_in_latest_diagnostic: 2
- rising_missed_symbol_count_in_report: 2
- real_submit_symbol_count_in_latest_diagnostic: 17
...
- stale_refresh_recovered_symbol_count: 23
...
- 284: `runtime_backpressure`
- 151: `strategy_reject`
- 55: `intended_guard`
- 23: `pre_submit_quality_guard`
- 12: `watch_budget_reallocated`
- 12: `source_freshness_blocker`
- 6: `source_freshness_recovering`

## suppressed non-major blocker counts

- 284: `runtime_backpressure` / `scalping_scanner_watching_runtime_skip` / `scanner_full_eval_loop_budget_deferred`
- 25: `intended_guard` / `scalping_scanner_watching_runtime_skip` / `entry_cooldown_active`
- 10: `watch_budget_reallocated` / `scalping_scanner_watch_eviction` / `scanner_hardgate_prefilter`
- 6: `source_freshness_recovering` / `scalping_scanner_watching_runtime_skip` / `ws_snapshot_missing_or_zero`
...
- 14: `latency_block` / `latency_state_danger`
- 2: `blocked_strength_momentum` / `below_buy_ratio`
...
- 8: `latency_block` / `latency_state_danger`
- 2: `blocked_strength_momentum` / `below_buy_ratio`
- 1: `scalping_scanner_watching_runtime_skip` / `entry_cooldown_active`
- 1: `scalping_scanner_watching_runtime_skip` / `scanner_fast_precheck_stability_pending`
...
|현대무벡스(319400)|08:03:13|10:19:53|rising|5.78%|4.10%|`latency_block`/latency_state_danger|pre_submit_quality_guard|1|56|diagnostic_quote_age_stale|10343.0|08:04:00|82/BUY|9|08:04:00 ai_confirmed(+0.00%) -> 08:04:00 entry_armed:qualification_passed(+0.00%) -> 08:04:01 budget_pass(+0.00%) -> 08:04:01 latency_block:latency_state_danger(+0.00%) -> ... -> 09:31:02 latency_block:latency_state_danger(+4.10%) -> 10:06:03 latency_pass:safe_normal_entry_allowed(+4.10%) -> 10:06:07 order_bundle_submitted:safe_normal_entry_allowed(+4.10%)|
|제룡전기(033100)|08:01:42|10:18:51|rising|5.25%|5.25%|`latency_block`/latency_state_danger|pre_submit_quality_guard|0|0|-||-||9|-|
|일진전기(103590)|08:06:14|10:19:53|rising|5.14%|5.14%|`latency_block`/latency_state_danger|pre_submit_quality_guard|0|40|-|2132.0|08:10:53|62/WAIT|9|08:07:18 blocked_strength_momentum:below_buy_ratio(+0.00%) -> 08:07:18 blocked_gap_from_scan(+0.00%) -> 08:07:20 ai_confirmed(+0.00%) -> 08:07:22 first_ai_wait(+0.00%) -> ... -> 10:07:35 latency_block:latency_state_danger(+5.14%) -> 10:15:13 latency_pass:caution_normal_entry_allowed(+5.14%) -> 10:15:17 order_bundle_submitted:caution_normal_entry_allowed(+5.14%)|
|SK이터닉스(475150)|10:11:58|10:19:43|rising|4.06%|4.06%|`latency_block`/latency_state_danger|pre_submit_quality_guard|0|2|-|2668.0|-|70/|0|10:12:52 blocked_strength_momentum:below_strength_base(+0.00%) -> 10:12:52 blocked_vpw(+0.00%) -> 10:12:52 blocked_ai_score:ai_score_50_buy_hold_override(+0.00%) -> 10:16:55 latency_block:latency_state_danger(+4.06%)|
|LS ELECTRIC(010120)|08:01:43|10:19:40|rising|3.25%|3.25%|`latency_block`/latency_state_danger|pre_submit_quality_guard|4|122|diagnostic_quote_age_stale|221288.0|08:04:28|74/WAIT|6|08:03:07 latency_block:latency_state_danger(+1.73%) -> 08:04:28 latency_pass:caution_normal_entry_allowed(+2.60%) -> 08:04:43 latency_pass:caution_normal_entry_allowed(+2.60%) -> 08:04:47 order_bundle_submitted:caution_normal_entry_allowed(+2.60%) -> ... -> 10:19:40 wait65_79_ev_candidate(+3.25%) -> 10:19:40 first_ai_wait(+3.25%) -> 10:19:40 ai_confirmed_terminal_no_budget:first_ai_wait_big_bite_not_confirmed(+3.25%)|
...
|테스(095610)|10:06:54|10:19:43|rising|1.24%|1.24%|`latency_block`/latency_state_danger|pre_submit_quality_guard|0|3|-|263.0|-|62/WAIT|0|10:07:42 ai_confirmed(+0.00%) -> 10:07:42 first_ai_wait(+0.00%) -> 10:07:42 ai_confirmed_terminal_no_budget:first_ai_wait_big_bite_not_confirmed(+0.00%) -> 10:10:28 blocked_strength_momentum:below_window_buy_value(+0.00%) -> 10:16:42 latency_block:latency_state_danger(+1.24%)|
...
|삼화콘덴서(001820)|08:26:25|10:19:53|rising|0.43%|0.43%|`scalping_scanner_watching_runtime_skip`/scanner_fast_precheck_stability_pending|strategy_reject|3|4|diagnostic_quote_age_stale|4119.0|-|62/WAIT|0|08:26:49 blocked_strength_momentum:below_window_buy_value(+0.00%) -> 08:26:50 ai_confirmed(+0.00%) -> 08:26:52 first_ai_wait(+0.00%) -> 08:26:52 ai_confirmed_terminal_no_budget:first_ai_wait_big_bite_not_confirmed(+0.00%) -> ... -> 10:15:52 ai_confirmed(+0.43%) -> 10:15:52 first_ai_wait(+0.43%) -> 10:15:52 ai_confirmed_terminal_no_budget:first_ai_wait_big_bite_not_confirmed(+0.43%)|
...
|스피어(347700)|08:04:44|10:19:43|flat_or_falling|0.00%|0.00%|`latency_block`/latency_state_danger|pre_submit_quality_guard|2|1|diagnostic_quote_age_stale|3318.0|10:18:07|78/BUY|0|08:05:24 blocked_strength_momentum:below_window_buy_value(+0.00%) -> 10:10:15 blocked_overbought(+0.00%) -> 10:10:17 blocked_strength_momentum:below_window_buy_value(+0.00%) -> 10:10:17 blocked_vpw(+0.00%) -> ... -> 10:18:07 entry_armed:qualification_passed(+0.00%) -> 10:18:07 budget_pass(+0.00%) -> 10:18:08 latency_block:latency_state_danger(+0.00%)|
...
|삼성전기(009150)|10:06:54|10:19:43|flat_or_falling|0.00%|0.00%|`scalping_scanner_watching_runtime_skip`/scanner_fast_precheck_stability_pending|strategy_reject|6|2|diagnostic_quote_age_stale|13427.0|-|62/WAIT|0|10:09:11 ai_confirmed(+0.00%) -> 10:09:11 first_ai_wait(+0.00%) -> 10:09:11 ai_confirmed_terminal_no_budget:first_ai_wait_big_bite_not_confirmed(+0.00%) -> 10:11:48 blocked_strength_momentum:below_buy_ratio(+0.00%) -> ... -> 10:11:50 blocked_ai_score(+0.00%) -> 10:11:50 ai_confirmed_terminal_no_budget:blocked_ai_score_below_buy_score_threshold(+0.00%) -> 10:16:06 blocked_strength_momentum:below_buy_ratio(+0.00%)|
...
|미래산업(025560)|10:10:57|10:19:43|flat_or_falling|0.00%|0.00%|`scalping_scanner_watching_runtime_skip`/scanner_fast_precheck_stability_pending|strategy_reject|0|0|-|2841.0|-|64/WAIT|0|10:12:53 blocked_overbought(+0.00%) -> 10:12:55 blocked_strength_momentum:below_buy_ratio(+0.00%) -> 10:12:55 blocked_vpw(+0.00%) -> 10:12:56 ai_confirmed(+0.00%) -> 10:12:56 first_ai_wait(+0.00%) -> 10:12:56 ai_confirmed_terminal_no_budget:first_ai_wait_big_bite_not_confirmed(+0.00%)|
...
|주성엔지니어링(036930)|10:13:59|10:19:43|flat_or_falling|0.00%|0.00%|`scalping_scanner_watching_runtime_skip`/scanner_fast_precheck_stability_pending|strategy_reject|2|2|diagnostic_quote_age_stale|3682.0|-|60/WAIT|0|10:15:58 blocked_strength_momentum:below_buy_ratio(+0.00%) -> 10:15:58 blocked_vpw(+0.00%) -> 10:16:00 ai_confirmed(+0.00%) -> 10:16:00 first_ai_wait(+0.00%) -> 10:16:00 ai_confirmed_terminal_no_budget:first_ai_wait_big_bite_not_confirmed(+0.00%)|
|금호건설(002990)|10:15:00|10:19:43|flat_or_falling|0.00%|0.00%|`scalping_scanner_watching_runtime_skip`/scanner_fast_precheck_stability_pending|strategy_reject|0|0|-|2927.0|-|62/WAIT|0|10:18:10 blocked_overbought(+0.00%) -> 10:18:12 blocked_strength_momentum:below_strength_base(+0.00%) -> 10:18:12 blocked_vpw(+0.00%) -> 10:18:14 ai_confirmed(+0.00%) -> 10:18:14 first_ai_wait(+0.00%) -> 10:18:14 ai_confirmed_terminal_no_budget:first_ai_wait_big_bite_not_confirmed(+0.00%)|
...
|에코프로비엠(247540)|08:01:43|10:19:42|flat_or_falling|-1.41%|-1.41%|`blocked_strength_momentum`/below_strength_base|strategy_reject|3|7|diagnostic_quote_age_stale|14829.0|08:03:08|76/WAIT|9|08:03:08 latency_pass:caution_normal_entry_allowed(-1.41%) -> 08:03:12 order_bundle_submitted:caution_normal_entry_allowed(-1.41%) -> 08:21:18 latency_pass:caution_normal_entry_allowed(-1.41%) -> 08:21:28 order_bundle_submitted:caution_normal_entry_allowed(-1.41%) -> ... -> 10:15:01 ai_confirmed_terminal_no_budget:blocked_ai_score_below_buy_score_threshold(-1.41%) -> 10:18:43 blocked_strength_momentum:insufficient_history(-1.41%) -> 10:19:42 blocked_strength_momentum:below_strength_base(-1.41%)|
