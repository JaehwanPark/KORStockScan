# Threshold Cycle Postclose Verification - 2026-08-14

- status: `warning`
- latest_start_marker: `[START] threshold-cycle postclose target_date=2026-08-14 max_iterations=320 recovery_reuse=true started_at=2026-08-14T21:48:48+0900`
- latest_done_marker: `[DONE] threshold-cycle postclose target_date=2026-08-14 recovery_action=tail_repair_done_reconciliation full_wrapper_rerun=false deepseek_swing_lab=false swing_lifecycle=false swing_lifecycle_bucket_discovery=false swing_lifecycle_matrix=false swing_strategy_discovery=false finished_at=2026-08-14T22:48:30+0900`
...
- P2 `scalp_entry_adm_unknown_bucket_source_quality_gap` 판정: `source_quality_followup_required`
  - 근거: `{'status': 'warning', 'warnings': ['joined_sample_below_sample_floor', 'sim_post_sell_outcome_source_below_sample_floor', 'unknown_bucket_source_quality_gap'], 'affected_rows': 18, 'affected_rate': 0.0251, 'dimension_counts': {'risk_context_bucket': 18, 'price_resolution_bucket': 2}, 'unknown_root_cause_counts': {'risk_context_bucket:post_submit_or_exit_not_required': 5, 'risk_context_bucket:source_field_missing': 13, 'price_resolution_bucket:post_submit_or_exit_not_required': 2}, 'stage_counts': {'scalp_sim_sell_order_assumed_filled': 4, 'scalp_entry_action_decision_snapshot': 330, 'latency_block': 68, 'scalp_sim_entry_ai_price_skip_order': 12, 'blocked_ai_score': 27, 'order_bundle_submitted': 10, 'scalp_sim_pre_submit_liquidity_guard_would_block': 5}, 'recommended_route': 'source_quality_workorder', 'not_available_route': 'field_legitimately_unavailable_no_workorder', 'lookup_status_counts': {'new_or_unseen_token_vs_prior_adm': 250, 'matched_prior_bucket': 468}}`
...
- adm_bridge_complete_flow_count: `6`
- fallback_complete_flow_count: `0`
- incomplete_flow_count: `2377`
