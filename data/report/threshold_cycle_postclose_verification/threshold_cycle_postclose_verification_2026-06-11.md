...
- P4 `live_auto_ready_zero_breakdown` 판정: `warning_explained_no_live_auto_ready`
  - 근거: `{'live_auto_apply_ready_count': 0, 'state_counts': {'source_only_keep_collecting': 401, 'lifecycle_flow_sim_probe_candidate': 15, 'sim_auto_approved': 69, 'entry_only_sim_auto_approved': 14, 'entry_only_source_candidate': 1}, 'source_bucket_kind_counts': {'source_only_observation': 335, 'taxonomy_provenance_gap': 66, 'lifecycle_flow_sim_probe_policy': 15, 'sim_auto_policy': 69, 'entry_only_sim_policy': 14, 'entry_only_source_candidate': 1}, 'runtime_gap_categories': {'code_patch_required': 15, 'runtime_blocked_contract_gap': 27, 'sim_auto_approved': 36, 'source_only_explicit_exclusion': 1, 'source_only_keep_collecting': 46, 'source_quality_blocker': 536, 'tier2_fail_closed_source_only': 9}, 'source_contract_status': 'warning', 'source_contract_change_count': 11, 'ai_two_pass_review_status': 'parsed', 'positive_edge_source_quality_pass_count': 24, 'bridge_blocker_ledger_count': 200, 'runtime_uptake_rate_pct': 0.0, 'handoff_warnings': ['lifecycle_bucket_discovery_source_contract_warning', 'source_contract_drift_warning']}`
...
- summary: `{'actionable_unknown_gap_count': 0, 'ai_review_retry_pending': False, 'ai_review_status': 'parsed', 'bridge_blocker_ledger_count': 200, 'candidate_count': 670, 'codex_directive_count': 1, 'conversion_blocker_rank_count': 200, 'critical_failure_count': 0, 'derived_review_category_counts': {'code_patch_required': 15, 'runtime_blocked_contract_gap': 27, 'sim_auto_approved': 36, 'source_only_explicit_exclusion': 1, 'source_only_keep_collecting': 46, 'source_quality_blocker': 536, 'tier2_fail_closed_source_only': 9}, 'positive_edge_source_quality_pass_count': 24, 'quiet_gap_codex_directive_count': 0, 'quiet_gap_count': 333, 'quiet_gap_rollup_count': 333, 'retry_queue_count': 0, 'runtime_uptake_rate_pct': 0.0, 'source_dimension_gap_count': 66, 'status': 'pass'}`
...
- status: `pass`
- ai_status: `parsed`
- provider_status: `{'provider': 'openai', 'status': 'success', 'new_provider_call': True, 'key_name': 'OPENAI_API_KEY', 'attempt_index': 1, 'model_index': 1, 'configured_key_count': 2, 'attempted_key_count': 1, 'attempted_keys': 1, 'attempted_key_names': ['OPENAI_API_KEY'], 'configured_model_count': 3, 'attempted_model_count': 1, 'attempted_models': ['gpt-5.5'], 'configured_models': ['gpt-5.5', 'gpt-5.4', 'gpt-5.4-mini'], 'model': 'gpt-5.5', 'schema_name': 'threshold_ai_correction_v1', 'reasoning_effort': 'high', 'prompt_chars': 113236, 'input_context_chars': 111916, 'input_context_hash': 'f1d2694689e7cb78567e5a392c61cc19fbc266589f1debf69928d54c1755e334', 'elapsed_ms': 122826, 'output_chars': 12004, 'input_tokens': 32106, 'output_tokens': 7432, 'total_tokens': 39538, 'estimated_cost': None, 'estimated_cost_usd': None, 'cost_estimate_status': 'missing_price_contract'}`
...
- status: `pass`
- expected_candidate_ids: `['entry_bucket_11', 'entry_bucket_12', 'entry_bucket_13', 'entry_bucket_14', 'entry_bucket_16', 'entry_bucket_17', 'entry_bucket_18', 'entry_bucket_19', 'entry_bucket_20', 'entry_bucket_21']`
...
- source_present: `True`
- status: `pass`
- expected_candidate_ids: `['overnight_bucket_1', 'overnight_bucket_3', 'overnight_bucket_4']`
- missing_ev_candidate_ids: `[]`
- missing_runtime_summary_candidate_ids: `[]`
- missing_workorder_order_ids: `[]`
...
- status: `warning`
- active_seed_ids: `['active_seed_03c539e6527cdda2', 'active_seed_0747f150d4c2eab8', 'active_seed_136f942c5ddd1131', 'active_seed_5a2bc352f93a2417', 'active_seed_5fbf3e3baf24631e', 'active_seed_6e36e8c6382881aa', 'active_seed_7cf1c198fc1e5246', 'active_seed_88622d589d5ff21a', 'active_seed_b99a2dea7aac2a83', 'active_seed_d263354d5e66d645', 'active_seed_f2db9775052c4d8d']`
...
- top_candidate_prefixes: `[('{"entry_score_parent": "score_watch_recovery", "entry_source_parent": "entry_source_blocked_ai_score"}', 2356), ('{"entry_score_parent": "score_watch_recovery", "entry_source_parent": "entry_source_wait6579"}', 1098), ('{"entry_score_parent": "score_mid_recovery", "entry_source_parent": "entry_source_wait6579"}', 58), ('{"entry_score_parent": "score_mid_recovery", "entry_source_parent": "entry_source_blocked_ai_score"}', 39), ('{"entry_score_parent": "score_high_confirmation", "entry_source_parent": "entry_source_wait6579"}', 16)]`

## Lifecycle Bucket Windows
- status: `pass`
- checked: `True`
- windows: `{'rolling5d': {'available': True, 'source_contract_status': 'pass', 'parent_granularity_status': 'target_pass', 'parent_bucket_count': 36}, 'rolling10d': {'available': True, 'source_contract_status': 'pass', 'parent_granularity_status': 'target_pass', 'parent_bucket_count': 43}, 'mtd': {'available': True, 'source_contract_status': 'pass', 'parent_granularity_status': 'target_pass', 'parent_bucket_count': 43}}`
- missing: `[]`
- warnings: `[]`

## Swing Lifecycle Handoff
- status: `pass`
- expected_candidate_ids: `['swing_ldm_lifecycle_flow_combo_swing_lifecycle_flow_entry_swing_entry_entry_bucket_attribution_swing_strategy_discovery_s_b74bbc500a']`
- missing_ev_candidate_ids: `[]`
- missing_runtime_summary_candidate_ids: `[]`
- missing_workorder_order_ids: `[]`
