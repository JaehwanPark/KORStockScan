...
- P2 `scalp_entry_adm_unknown_bucket_source_quality_gap` 판정: `pass_no_unknown_bucket_warning`
  - 근거: `{'status': 'warning', 'warnings': ['ai_numeric_consistency_rows_excluded_from_aggregates'], 'affected_rows': 20, 'affected_rate': 0.0275, 'dimension_counts': {'risk_context_bucket': 20, 'price_resolution_bucket': 20}, 'unknown_root_cause_counts': {'risk_context_bucket:post_submit_or_exit_not_required': 20, 'price_resolution_bucket:post_submit_or_exit_not_required': 20}, 'stage_counts': {'latency_block': 17, 'latency_pass': 3, 'blocked_ai_score': 54, 'scalp_sim_pre_submit_liquidity_guard_would_block': 50, 'pre_submit_liquidity_guard_block': 1, 'scalp_sim_sell_order_assumed_filled': 20}, 'recommended_route': 'classified_not_applicable_no_workorder', 'not_available_route': 'field_legitimately_unavailable_no_workorder', 'lookup_status_counts': {'matched_prior_bucket': 349, 'new_or_unseen_token_vs_prior_adm': 379}}`
...
- P4 `live_auto_ready_zero_breakdown` 판정: `warning_explained_no_live_auto_ready`
  - 근거: `{'live_auto_apply_ready_count': 0, 'state_counts': {'source_only_keep_collecting': 479, 'lifecycle_flow_sim_probe_candidate': 7, 'sim_auto_approved': 4, 'entry_only_sim_auto_approved': 9, 'entry_only_source_candidate': 1}, 'source_bucket_kind_counts': {'source_only_observation': 404, 'taxonomy_provenance_gap': 75, 'lifecycle_flow_sim_probe_policy': 7, 'sim_auto_policy': 4, 'entry_only_sim_policy': 9, 'entry_only_source_candidate': 1}, 'runtime_gap_categories': {'code_patch_required': 11, 'runtime_blocked_contract_gap': 32, 'sim_auto_approved': 44, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 60, 'source_quality_blocker': 524, 'tier2_fail_closed_source_only': 17}, 'source_contract_status': 'warning', 'source_contract_change_count': 12, 'ai_two_pass_review_status': 'parsed', 'positive_edge_source_quality_pass_count': 72, 'bridge_blocker_ledger_count': 200, 'runtime_uptake_rate_pct': 0.0, 'handoff_warnings': ['lifecycle_bucket_discovery_source_contract_warning', 'source_contract_drift_warning']}`
...
- summary: `{'actionable_unknown_gap_count': 0, 'ai_review_retry_pending': False, 'ai_review_status': 'parsed', 'bridge_blocker_ledger_count': 200, 'candidate_count': 690, 'codex_directive_count': 0, 'conversion_blocker_rank_count': 200, 'critical_failure_count': 0, 'derived_review_category_counts': {'code_patch_required': 11, 'runtime_blocked_contract_gap': 32, 'sim_auto_approved': 44, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 60, 'source_quality_blocker': 524, 'tier2_fail_closed_source_only': 17}, 'positive_edge_source_quality_pass_count': 72, 'quiet_gap_codex_directive_count': 0, 'quiet_gap_count': 416, 'quiet_gap_rollup_count': 416, 'retry_queue_count': 0, 'runtime_uptake_rate_pct': 0.0, 'source_dimension_gap_count': 75, 'status': 'pass'}`
...
- attribution_present: `True`
- flow_count: `2269`
- complete_flow_count: `57`
- direct_sim_record_complete_flow_count: `0`
- adm_bridge_complete_flow_count: `57`
- fallback_complete_flow_count: `0`
- incomplete_flow_count: `2212`
...
- status: `pass`
- ai_status: `parsed`
- provider_status: `{'provider': 'openai', 'status': 'success', 'new_provider_call': True, 'key_name': 'OPENAI_API_KEY', 'attempt_index': 1, 'model_index': 1, 'configured_key_count': 2, 'attempted_key_count': 1, 'attempted_keys': 1, 'attempted_key_names': ['OPENAI_API_KEY'], 'configured_model_count': 3, 'attempted_model_count': 1, 'attempted_models': ['gpt-5.5'], 'configured_models': ['gpt-5.5', 'gpt-5.4', 'gpt-5.4-mini'], 'model': 'gpt-5.5', 'schema_name': 'threshold_ai_correction_v1', 'reasoning_effort': 'high', 'prompt_chars': 107702, 'input_context_chars': 106382, 'input_context_hash': 'f49e0e6f5cfcb256a4601539f2b0d9228a5f0d0ed924428cf6dd7121a407faa8', 'elapsed_ms': 154778, 'output_chars': 12261, 'input_tokens': 30877, 'output_tokens': 10778, 'total_tokens': 41655, 'estimated_cost': None, 'estimated_cost_usd': None, 'cost_estimate_status': 'missing_price_contract'}`
...
- status: `pass`
- expected_candidate_ids: `['entry_bucket_10', 'entry_bucket_11', 'entry_bucket_13', 'entry_bucket_14', 'entry_bucket_15', 'entry_bucket_16', 'entry_bucket_17', 'entry_bucket_18', 'entry_bucket_8', 'entry_bucket_9']`
...
- source_present: `True`
- status: `pass`
- expected_candidate_ids: `['overnight_bucket_10', 'overnight_bucket_11', 'overnight_bucket_2', 'overnight_bucket_3', 'overnight_bucket_4', 'overnight_bucket_5', 'overnight_bucket_6', 'overnight_bucket_7', 'overnight_bucket_9']`
- missing_ev_candidate_ids: `[]`
- missing_runtime_summary_candidate_ids: `[]`
- missing_workorder_order_ids: `[]`
...
- top_candidate_prefixes: `[('{"entry_score_parent": "score_watch_recovery", "entry_source_parent": "entry_source_wait6579"}', 1165), ('{"entry_score_parent": "score_watch_recovery", "entry_source_parent": "entry_source_blocked_ai_score"}', 323), ('{"entry_score_parent": "score_mid_recovery", "entry_source_parent": "entry_source_wait6579"}', 153), ('{"entry_score_parent": "score_high_confirmation", "entry_source_parent": "entry_source_wait6579"}', 82)]`
