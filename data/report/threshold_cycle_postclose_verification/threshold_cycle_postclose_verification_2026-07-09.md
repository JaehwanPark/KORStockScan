...
- P2 `scalp_entry_adm_unknown_bucket_source_quality_gap` 판정: `pass_no_unknown_bucket_warning`
  - 근거: `{'status': 'warning', 'warnings': ['joined_sample_below_sample_floor'], 'affected_rows': 7, 'affected_rate': 0.0473, 'dimension_counts': {'risk_context_bucket': 7, 'price_resolution_bucket': 2}, 'unknown_root_cause_counts': {'risk_context_bucket:post_submit_or_exit_not_required': 7, 'price_resolution_bucket:post_submit_or_exit_not_required': 2}, 'stage_counts': {'blocked_ai_score': 10, 'scalp_sim_pre_submit_liquidity_guard_would_block': 9, 'latency_block': 11, 'scalp_entry_action_decision_snapshot': 55, 'order_bundle_submitted': 12, 'scalp_sim_sell_order_assumed_filled': 2}, 'recommended_route': 'classified_not_applicable_no_workorder', 'not_available_route': 'field_legitimately_unavailable_no_workorder', 'lookup_status_counts': {'new_or_unseen_token_vs_prior_adm': 79, 'matched_prior_bucket': 69}}`
...
- P4 `live_auto_ready_zero_breakdown` 판정: `warning_explained_no_live_auto_ready`
  - 근거: `{'live_auto_apply_ready_count': 0, 'state_counts': {'source_only_keep_collecting': 414, 'lifecycle_flow_sim_probe_candidate': 4, 'automation_handoff_gap': 1, 'sim_auto_approved': 4, 'runtime_blocked_contract_gap': 2, 'new_bucket_candidate': 12}, 'source_bucket_kind_counts': {'taxonomy_provenance_gap': 44, 'source_only_observation': 383, 'lifecycle_flow_sim_probe_policy': 4, 'sim_auto_policy': 4, 'source_quality_gap': 2}, 'runtime_gap_categories': {'runtime_blocked_contract_gap': 19, 'sim_auto_approved': 45, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 193, 'source_quality_blocker': 415, 'tier2_fail_closed_source_only': 40}, 'source_contract_status': 'warning', 'source_contract_change_count': 14, 'ai_two_pass_review_status': 'parsed', 'positive_edge_source_quality_pass_count': 81, 'bridge_blocker_ledger_count': 200, 'runtime_uptake_rate_pct': 0.0, 'handoff_warnings': ['lifecycle_bucket_discovery_source_contract_warning', 'source_contract_drift_warning']}`
...
- summary: `{'actionable_unknown_gap_count': 1, 'ai_review_retry_pending': False, 'ai_review_status': 'parsed', 'bridge_blocker_ledger_count': 200, 'candidate_count': 714, 'codex_directive_count': 1, 'conversion_blocker_rank_count': 200, 'critical_failure_count': 0, 'derived_review_category_counts': {'runtime_blocked_contract_gap': 19, 'sim_auto_approved': 45, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 193, 'source_quality_blocker': 415, 'tier2_fail_closed_source_only': 40}, 'positive_edge_source_quality_pass_count': 81, 'quiet_gap_codex_directive_count': 0, 'quiet_gap_count': 358, 'quiet_gap_rollup_count': 358, 'retry_queue_count': 0, 'runtime_uptake_rate_pct': 0.0, 'source_dimension_gap_count': 48, 'status': 'pass'}`
...
- adm_bridge_complete_flow_count: `10`
- fallback_complete_flow_count: `0`
- incomplete_flow_count: `1082`
...
- status: `pass`
- ai_status: `parsed`
- provider_status: `{'provider': 'openai', 'status': 'success', 'new_provider_call': True, 'key_name': 'OPENAI_API_KEY', 'attempt_index': 1, 'model_index': 1, 'configured_key_count': 2, 'attempted_key_count': 1, 'attempted_keys': 1, 'attempted_key_names': ['OPENAI_API_KEY'], 'configured_model_count': 3, 'attempted_model_count': 1, 'attempted_models': ['gpt-5.5'], 'configured_models': ['gpt-5.5', 'gpt-5.4', 'gpt-5.4-mini'], 'model': 'gpt-5.5', 'schema_name': 'threshold_ai_correction_v1', 'reasoning_effort': 'high', 'prompt_chars': 108377, 'input_context_chars': 107057, 'input_context_hash': '1b2970f6f8b42c5d162a7d9c5dd2a64d349a4d6ce77006f26af71c0bd4eaf8ce', 'elapsed_ms': 97365, 'output_chars': 14358, 'input_tokens': 31311, 'output_tokens': 7513, 'total_tokens': 38824, 'estimated_cost': None, 'estimated_cost_usd': None, 'cost_estimate_status': 'missing_price_contract'}`
- blocking_runtime_candidate_families: `['entry_split_order_plan', 'lifecycle_decision_matrix_runtime', 'protect_trailing_smoothing', 'scale_in_split_order_plan', 'score65_74_recovery_probe', 'soft_stop_whipsaw_confirmation']`
- parse_warnings: `[]`
...
- missing: `[]`
- warnings: `[]`
- contract_drift: `{'candidate_feature_event_count': 529, 'recomputable_match_count': 529, 'recomputable_hypothesis_ids': ['ldm_hypothesis_00d0b765311ad7aa', 'ldm_hypothesis_711caa66c89b3f51', 'ldm_hypothesis_92dfecb5a05caa64', 'ldm_hypothesis_e04e4d815fd8d0f9'], 'runtime_matched_event_count': 529}`
- diagnosis_missing_warning_input_ids: `[]`
- diagnosis_missing_fail_input_ids: `[]`
- diagnosed_repeated_input_ids: `['ldm_refinement_a1782b3585bce622', 'ldm_refinement_5742709b0b3ca652', 'ldm_refinement_a5a73ddab7c2dcc3', 'ldm_refinement_72f235ced889d33f']`
- runtime_authority_violation_input_ids: `[]`

## Active Sim Priority Handoff
- status: `warning`
- active_seed_ids: `['active_seed_1fc6245cf630af1c', 'active_seed_7cf1c198fc1e5246', 'active_seed_dcd8fdaa26695704']`
- observed_seed_ids: `['active_seed_b56aa70cf7a51748', 'active_seed_b99a2dea7aac2a83']`
- missing: `[]`
