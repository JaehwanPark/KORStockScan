...
- P4 `live_auto_ready_zero_breakdown` 판정: `warning_explained_no_live_auto_ready`
  - 근거: `{'live_auto_apply_ready_count': 0, 'state_counts': {'source_only_keep_collecting': 416, 'lifecycle_flow_sim_probe_candidate': 4, 'sim_auto_approved': 4, 'runtime_blocked_contract_gap': 1, 'new_bucket_candidate': 13}, 'source_bucket_kind_counts': {'taxonomy_provenance_gap': 49, 'source_only_observation': 380, 'lifecycle_flow_sim_probe_policy': 4, 'sim_auto_policy': 4, 'source_quality_gap': 1}, 'runtime_gap_categories': {'runtime_blocked_contract_gap': 19, 'sim_auto_approved': 45, 'source_only_explicit_exclusion': 2, 'source_only_keep_collecting': 193, 'source_quality_blocker': 415, 'tier2_fail_closed_source_only': 40}, 'source_contract_status': 'warning', 'source_contract_change_count': 14, 'ai_two_pass_review_status': 'parsed', 'positive_edge_source_quality_pass_count': 81, 'bridge_blocker_ledger_count': 200, 'runtime_uptake_rate_pct': 0.0, 'handoff_warnings': ['lifecycle_bucket_discovery_source_contract_warning', 'source_contract_drift_warning']}`
...
- closure_counts: `{'new_parent_candidate_created': 2, 'parent_refinement_candidate_created': 2}`
- missing: `[]`
- warnings: `[]`
