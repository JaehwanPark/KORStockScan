# Lifecycle AI Context - 2026-09-04

- context_version: `lifecycle_ai_context_v1_2026-09-04`
- authority: `ai_advisory_prompt_context_only`
- runtime_effect: `False`
- provider_status: `{'provider': 'deterministic_source_only', 'status': 'deterministic_fallback', 'schema_name': 'lifecycle_ai_context_v1', 'fallback_used': True}`

## Stage Contexts
| stage | prompt | policy_key | hint | contribution | quality |
| --- | --- | --- | --- | --- | --- |
| `entry` | `True` | `entry:weighted_adm_v1` | `BUY_DEFENSIVE` | `-0.271` | `observational_only_pending_outcome` |
