# 2026-09-11 Rising Missed Scout Workorder

- generated_at: 2026-09-11T22:11:03+09:00
...
- forced_scout_record_count: 386
- forced_scout_with_post_sell_count: 13
- forced_scout_post_sell_join_coverage_pct: 3.367876
...
- profitable_forced_scout_count: 10
- loss_or_flat_forced_scout_count: 3
- winner_avg_profit_rate: 0.6671
- loser_avg_profit_rate: -3.376
- forced_initial_entry_equal_weight_avg_profit_pct: -0.265923
- forced_initial_entry_notional_weighted_ev_pct: -0.410041
- forced_initial_entry_estimated_gross_pnl_krw: -704.392
- total_position_estimated_gross_pnl_krw: -575.908
...
- take_profit_avg_giveback_pct: 0.3969
...
- evidence:
  - prior_count=109
  - recommendation_counts={"hold_sample": 63, "loss_filter": 46}
  - runtime_effect=false
...
- evidence:
  - winner_count=10
  - evaluated_capture_count=10
  - avg_peak_profit=1.064
  - avg_profit_rate=0.6671
  - avg_giveback_pct=0.3969
  - runner_review_candidate_count=1
  - runtime_effect=false
...
- evidence:
  ...
  - pre_anchor_bbo_path_event_count=2423
  - exact_ws_bbo_join_coverage_pct=0
  - pre_anchor_bbo_coverage_pct=0
  - paired_coverage_pct=0
  - primary_right_censored_pct=100.0
  - source_quality_gap_counts={"current_outcome_non_executable_or_unresolved": 373, "symbol_master:master_unavailable": 373}
