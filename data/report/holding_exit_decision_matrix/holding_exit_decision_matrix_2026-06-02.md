# Holding/Exit Decision Matrix - 2026-06-02

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-06-02`
...
- per_action_samples: `{'exit_only': 126, 'avg_down_wait': 0, 'pyramid_wait': 3}`
- proxy_sample_snapshots: `13411`
- proxy_joined_candidates: `1014`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 13056, 'exit_only': 4941, 'avg_down_wait': 6852, 'pyramid_wait': 1860}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.8614 | - | 14 | 0.3571 | False | avg_down_wait | candidate_weight_source |
| price_bucket | price_gte_70k | no_clear_edge | -0.7065 | - | 28 | 0.4643 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -0.9805 | - | 14 | 0.4286 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.5376 | - | 9 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | -1.2624 | - | 12 | 0.5833 | False | avg_down_wait | candidate_weight_source |
| volume_bucket | volume_unknown | no_clear_edge | -0.8583 | - | 7 | 0.2857 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_0930_1030 | no_clear_edge | -1.2305 | - | 7 | 0.5714 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.6946 | - | 30 | 0.4 | False | avg_down_wait | candidate_weight_source |
| time_bucket | time_1400_1530 | no_clear_edge | -1.3313 | - | 5 | 0.4 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
