# Holding/Exit Decision Matrix - 2026-05-19

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-05-19`
...
- proxy_sample_snapshots: `8834`
- proxy_joined_candidates: `0`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 8747, 'exit_only': 4005, 'avg_down_wait': 4976, 'pyramid_wait': 288}`
