# Holding/Exit Decision Matrix - 2026-05-29

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-05-29`
...
- per_action_samples: `{'exit_only': 63, 'avg_down_wait': 0, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `8126`
- proxy_joined_candidates: `118`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 7947, 'exit_only': 3535, 'avg_down_wait': 2941, 'pyramid_wait': 1673}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -1.0153 | - | 9 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| price_bucket | price_gte_70k | no_clear_edge | -1.0352 | - | 12 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -1.5054 | - | 7 | 0.5714 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.7701 | - | 7 | 0.2857 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| volume_bucket | volume_unknown | no_clear_edge | -0.9608 | - | 6 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_1030_1400 | no_clear_edge | -0.9955 | - | 11 | 0.3636 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
