# Holding/Exit Decision Matrix - 2026-06-04

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-06-04`
...
- per_action_samples: `{'exit_only': 117, 'avg_down_wait': 0, 'pyramid_wait': 3}`
- proxy_sample_snapshots: `1244`
- proxy_joined_candidates: `26`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 1230, 'exit_only': 350, 'avg_down_wait': 791, 'pyramid_wait': 113}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.937 | - | 9 | 0.3333 | False | avg_down_wait | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | - | - | - | - | False | avg_down_wait,pyramid_wait | insufficient_sample |
| price_bucket | price_gte_70k | no_clear_edge | -1.0716 | - | 29 | 0.5517 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -1.3401 | - | 16 | 0.5625 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.6772 | - | 11 | 0.3636 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | -1.2236 | - | 7 | 0.4286 | False | avg_down_wait | candidate_weight_source |
...
| time_bucket | time_0930_1030 | no_clear_edge | -1.3569 | - | 10 | 0.6 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| time_bucket | time_1030_1400 | no_clear_edge | -0.9301 | - | 25 | 0.48 | False | avg_down_wait | candidate_weight_source |
