# Holding/Exit Decision Matrix - 2026-05-27

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-05-27`
...
- per_action_samples: `{'exit_only': 39, 'avg_down_wait': 0, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `12597`
- proxy_joined_candidates: `492`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 12385, 'exit_only': 3503, 'avg_down_wait': 7534, 'pyramid_wait': 1673}`
...
| price_bucket | price_gte_70k | no_clear_edge | -0.8042 | - | 9 | 0.4444 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_2m_10m | no_clear_edge | -1.0649 | - | 5 | 0.4 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -1.2622 | - | 5 | 0.4 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_1030_1400 | no_clear_edge | -1.2091 | - | 6 | 0.5 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
