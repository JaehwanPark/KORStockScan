# Holding/Exit Decision Matrix - 2026-08-14

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-08-14`
...
- per_action_samples: `{'exit_only': 33, 'avg_down_wait': 0, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `828`
- proxy_joined_candidates: `188`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait', 'pyramid_wait']`
- proxy_missing_actions: `[]`
- proxy_per_action_samples: `{'hold_defer': 771, 'exit_only': 821, 'avg_down_wait': 788, 'pyramid_wait': 33}`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.6974 | - | 11 | 0.2727 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
...
| time_bucket | time_1030_1400 | no_clear_edge | -1.3257 | - | 6 | 0.3333 | False | avg_down_wait,pyramid_wait | candidate_weight_source |
