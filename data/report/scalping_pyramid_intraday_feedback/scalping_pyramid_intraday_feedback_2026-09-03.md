# 2026-09-03 Scalping Pyramid Intraday Feedback

- generated_at: 2026-09-03T22:12:42+09:00
...
- whole_day_real_entry_lifecycle: {"by_effective_venue": [{"allowed_runtime_apply": false, "canceled_unfilled_cycle_count": 0, "closed_cycle_count": 3, "diagnostic_win_rate": 0.6667, "effective_venue": "KRX", "equal_weight_avg_profit_pct": -0.21, "filled_cycle_count": 3, "flat_count": 0, "holding_cycle_count": 0, "loss_count": 1, "multi_leg_probe_cycle_count": 0, "realized_pnl_krw_known_count": 3, "realized_pnl_krw_known_sum": 141, "runtime_effect": false, "single_share_plan_closed_winner_count": 2, "submitted_cycle_count": 3, "winner_count": 2}], "by_market_session_bucket": [{"allowed_runtime_apply": false, "canceled_unfilled_cycle_count": 0, "closed_cycle_count": 3, "diagnostic_win_rate": 0.6667, "equal_weight_avg_profit_pct": -0.21, "filled_cycle_count": 3, "flat_count": 0, "holding_cycle_count": 0, "loss_count": 1, "market_session_bucket": "krx_regular", "multi_leg_probe_cycle_count": 0, "realized_pnl_krw_known_count": 3, "realized_pnl_krw_known_sum": 141, "runtime_effect": false, "single_share_plan_closed_winner_count": 2, "submitted_cycle_count": 3, "winner_count": 2}], "canceled_unfilled_cycle_count": 0, "closed_cycle_count": 3, "diagnostic_win_rate": 0.6667, "equal_weight_avg_profit_pct": -0.21, "filled_cycle_count": 3, "flat_count": 0, "holding_cycle_count": 0, "loss_count": 1, "multi_leg_probe_cycle_count": 0, "multi_leg_zero_residual_fill_count": 0, "pending_entry_cycle_count": 0, "realized_pnl_krw_known_count": 3, "realized_pnl_krw_known_sum": 141, "realized_pnl_krw_missing_count": 0, "realized_pnl_krw_source_counts": [{"count": 3, "source": "broker_fill_prices_fee_aware"}], "realized_pnl_source_quality_state": "complete", "single_share_plan_closed_winner_count": 2, "submitted_cycle_count": 3, "venue_source_quality_invalid_count": 0, "venue_source_quality_valid_count": 3, "winner_count": 2}
...
- record_id= code=267270 name=HD건설기계 label=pyramid_open_unresolved blocker=profit_not_enough profit=0.06 final=None ai=50.0 tick=2.0 micro_vwap=-18.22
- record_id= code=138930 name=BNK금융지주 label=pyramid_open_unresolved blocker=profit_not_enough profit=0.72 final=None ai=50.0 tick=1.333 micro_vwap=-9.4
- record_id= code=441270 name=파인엠텍 label=pyramid_open_unresolved blocker=profit_not_enough profit=0.2 final=None ai=44.0 tick=0.5 micro_vwap=-20.79
...
- record_id=39381 code=096770 name=SK이노베이션 venue=KRX session=krx_regular state=closed planned_qty=1 submitted_qty=1 filled_qty=1 final=0.29 realized_pnl_krw=391 realized_pnl_source=broker_fill_prices_fee_aware canonical=None
- record_id=39439 code=100090 name=SK오션플랜트 venue=KRX session=krx_regular state=closed planned_qty=1 submitted_qty=1 filled_qty=1 final=2.12 realized_pnl_krw=279 realized_pnl_source=broker_fill_prices_fee_aware canonical=None
- record_id=39231 code=476060 name=온코닉테라퓨틱스 venue=KRX session=krx_regular state=closed planned_qty=1 submitted_qty=1 filled_qty=1 final=-3.04 realized_pnl_krw=-529 realized_pnl_source=broker_fill_prices_fee_aware canonical=None
