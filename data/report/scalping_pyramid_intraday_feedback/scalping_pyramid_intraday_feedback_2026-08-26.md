...
- record_id= code=388050 name=지투파워 label=pyramid_open_unresolved blocker=pyramid_quality_blocked:ai_score_unavailable,tick_aggressor_pressure_unusable,tick_accel_stale,micro_context_stale profit=1.76 final=None ai=50.0 tick=0.0 micro_vwap=-69.69
- record_id= code=053690 name=한미글로벌 label=pyramid_open_unresolved blocker=pyramid_hard_blocked:buy_pressure_severe_below_min,large_sell_detected profit=1.35 final=None ai=62.0 tick=0.0 micro_vwap=188.78
- record_id= code=336260 name=두산퓨얼셀 label=pyramid_open_unresolved blocker=profit_not_enough profit=0.41 final=None ai=43.0 tick=1.0 micro_vwap=-29.11
