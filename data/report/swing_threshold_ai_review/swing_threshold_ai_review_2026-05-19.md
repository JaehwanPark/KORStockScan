...
| `swing_selection_top_k` | `selection` | `hold_no_edge` | `correction_proposed` | state=hold, value=3 | accepted=True, reason=- |
...
| `swing_market_regime_sensitivity` | `entry` | `hold_no_edge` | `caution` | state=hold_sample, value=standard | accepted=False, reason=missing_numeric_bounds_for_value_proposal |
...
| `swing_exit_ofi_qi_smoothing` | `holding_exit` | `freeze` | `caution` | state=freeze, value=None | accepted=True, reason=- |
