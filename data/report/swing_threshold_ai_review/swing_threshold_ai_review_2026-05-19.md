# Swing Threshold AI Review - 2026-05-19
...
| --- | --- | --- | --- | --- | --- |
| `swing_model_floor` | `selection` | `hold_no_edge` | `unavailable` | state=hold, value=None | accepted=True, reason=- |
| `swing_selection_top_k` | `selection` | `hold_no_edge` | `unavailable` | state=hold, value=None | accepted=True, reason=- |
| `swing_gatekeeper_accept_reject` | `entry` | `freeze` | `unavailable` | state=freeze, value=None | accepted=True, reason=- |
| `swing_gatekeeper_reject_cooldown` | `entry` | `hold_no_edge` | `unavailable` | state=hold, value=None | accepted=True, reason=- |
| `swing_market_regime_sensitivity` | `entry` | `hold_no_edge` | `unavailable` | state=hold, value=None | accepted=True, reason=- |
