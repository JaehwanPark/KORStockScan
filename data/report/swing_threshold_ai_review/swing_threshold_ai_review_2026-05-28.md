...
| `swing_gatekeeper_reject_cooldown` | `entry` | `freeze` | `insufficient_context` | state=hold_sample, value=None | accepted=True, reason=- |
...
| `swing_trailing_stop_time_stop` | `exit` | `freeze` | `insufficient_context` | state=hold_sample, value=None | accepted=True, reason=- |
| `swing_holding_flow_defer` | `holding_exit` | `freeze` | `safety_concern` | state=freeze, value=None | accepted=True, reason=- |
