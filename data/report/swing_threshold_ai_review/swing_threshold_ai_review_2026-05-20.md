# Swing Threshold AI Review - 2026-05-20
...
| --- | --- | --- | --- | --- | --- |
| `swing_model_floor` | `selection` | `hold_no_edge` | `unavailable` | state=adjust_up, value=0.4 | accepted=True, reason=- |
| `swing_selection_top_k` | `selection` | `hold_no_edge` | `unavailable` | state=adjust_down, value=2 | accepted=True, reason=- |
| `swing_gatekeeper_accept_reject` | `entry` | `freeze` | `unavailable` | state=freeze, value=None | accepted=True, reason=- |
| `swing_gatekeeper_reject_cooldown` | `entry` | `hold_no_edge` | `unavailable` | state=hold, value=7200 | accepted=True, reason=- |
| `swing_market_regime_sensitivity` | `entry` | `hold_no_edge` | `unavailable` | state=adjust_up, value=strict_entry_observe | accepted=False, reason=missing_numeric_bounds_for_value_proposal |
