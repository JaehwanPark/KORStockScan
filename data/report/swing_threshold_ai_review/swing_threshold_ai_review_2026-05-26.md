# Swing Threshold AI Review - 2026-05-26
...
| --- | --- | --- | --- | --- | --- |
| `swing_model_floor` | `selection` | `freeze` | `unavailable` | state=freeze, value=None | accepted=True, reason=- |
| `swing_selection_top_k` | `selection` | `freeze` | `unavailable` | state=freeze, value=None | accepted=True, reason=- |
| `swing_gatekeeper_accept_reject` | `entry` | `freeze` | `unavailable` | state=freeze, value=None | accepted=True, reason=- |
| `swing_gatekeeper_reject_cooldown` | `entry` | `freeze` | `unavailable` | state=freeze, value=None | accepted=True, reason=- |
| `swing_market_regime_sensitivity` | `entry` | `freeze` | `unavailable` | state=freeze, value=None | accepted=True, reason=- |
