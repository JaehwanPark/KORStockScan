...
| --- | --- | --- | --- | --- | --- |
| `swing_model_floor` | `selection` | `approval_required` | `unavailable` | state=hold, value=None | accepted=True, reason=- |
...
| `swing_market_regime_sensitivity` | `entry` | `freeze` | `unavailable` | state=hold, value=None | accepted=True, reason=- |
