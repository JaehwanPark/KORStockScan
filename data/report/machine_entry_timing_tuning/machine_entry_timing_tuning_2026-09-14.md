...
- Rebound source gaps: `{"source_contract_gap": 29, "source_section_missing": 15}`.
...
- Sample-floor state: `no_natural_sample`; next action `continue_exact_date_collection_without_imputation`.
