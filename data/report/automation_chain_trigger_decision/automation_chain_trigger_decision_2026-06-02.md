...
| --- | --- | --- |
| `lifecycle_window_rolling5d` | `run` | output_missing_or_unreadable, source_missing_or_unreadable |
| `lifecycle_window_rolling10d` | `run` | output_missing_or_unreadable, source_missing_or_unreadable |
| `lifecycle_window_mtd` | `run` | output_missing_or_unreadable, source_missing_or_unreadable |
...
| `observation_source_quality_audit` | `run` | output_missing_or_unreadable, source_missing_or_unreadable |
