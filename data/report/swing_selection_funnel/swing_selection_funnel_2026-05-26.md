...
| --- | ---: | ---: |
| `blocked_gatekeeper_reject` | 30 | 6 |
| `blocked_swing_gap` | 12427 | 5 |
| `blocked_swing_score_vpw` | 162831 | 22 |
| `gatekeeper_fast_reuse_bypass` | 30 | 6 |
| `holding_flow_ofi_smoothing_applied` | 794 | 97 |
| `holding_started` | 7 | 1 |
| `swing_probe_discarded` | 7560 | 22 |
| `swing_probe_entry_candidate` | 29 | 13 |
| `swing_probe_exit_signal` | 21 | 9 |
| `swing_probe_holding_started` | 29 | 13 |
...
- `blocked_swing_score_vpw` KB금융(105560): 9105
- `blocked_swing_score_vpw` GS리테일(007070): 9105
- `blocked_swing_score_vpw` NC(036570): 9105
- `blocked_swing_score_vpw` 한국타이어앤테크놀로지(161390): 9105
- `blocked_swing_score_vpw` 셀트리온(068270): 9105
- `blocked_swing_score_vpw` KT&G(033780): 9104
- `blocked_swing_score_vpw` 현대해상(001450): 9104
- `blocked_swing_score_vpw` GS(078930): 9103
- `blocked_swing_score_vpw` HMM(011200): 9103
- `blocked_swing_score_vpw` 한세실업(105630): 9103
