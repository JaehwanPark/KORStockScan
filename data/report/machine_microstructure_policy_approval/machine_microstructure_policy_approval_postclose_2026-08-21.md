...
| --- | --- | --- | --- | --- |
| machine_lifecycle_turnover_policy_research_v1 | EVIDENCE_ACCUMULATING | rolling_paired_research_source_quality_blocked | current_attribution_source_contract_invalid | quarantine_current_source_date_and_continue_next_exact_date_collection |
