# Main AI Prompt Consumer - 2026-09-11
...
- `holding_base`: connected=`0`, blocked=`2`
  - `KRX/KRX_REGULAR` status=`intentionally_blocked_with_owner_and_acceptance_test` reason=`holding_base_manifest_missing_or_invalid`
  - `NXT/NXT_AFTERMARKET` status=`intentionally_blocked_with_owner_and_acceptance_test` reason=`holding_base_manifest_missing_or_invalid`

## Optional 2x2 Prompt/Input Cells
- cell_count: `1`
- status_counts: `{'intentionally_blocked_with_owner_and_acceptance_test': 1}`
