...
- generated_at: 2026-07-06T12:05:01+09:00
...
- forced_rising_missed_record_count: 20
...
- first_touch_micro_provenance_unusable_count: 6
...
- record_id=15506 code=042660 name=한화오션 label=first_touch_open_unresolved submitted=True touch_profit=-3.02 touch_peak=-0.23 touch_ai=54.0 final_profit=None submitted_count=1 runtime_decision=insufficient_first_touch_recovery_confirmation shadow_cap1=cap1_first_avg_down_allowed max_avg_down=1 blockers=blocked_strength_momentum=1,blocked_vpw=1
- record_id=15536 code=001260 name=남광토건 label=first_touch_open_unresolved submitted=False touch_profit=-3.62 touch_peak=-0.23 touch_ai=50.0 final_profit=None submitted_count=0 runtime_decision=liquidity_or_spread_block|weak_strength_vpw_without_recovery shadow_cap1=cap1_not_applicable_no_submit max_avg_down=0 blockers=blocked_overbought=5,blocked_liquidity=4,blocked_ai_score=3,blocked_strength_momentum=1
