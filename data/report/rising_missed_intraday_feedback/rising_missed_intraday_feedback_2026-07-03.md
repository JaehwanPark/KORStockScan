...
- generated_at: 2026-07-03T10:40:01+09:00
...
- record_id=15206 code=042660 name=한화오션 label=first_touch_open_unresolved submitted=True touch_profit=-3.1 touch_peak=-0.23 touch_ai=65.0 final_profit=None submitted_count=3 runtime_decision=- shadow_cap1=cap1_extra_avg_down_would_block max_avg_down=3 blockers=blocked_strength_momentum=3,blocked_ai_score=1
...
- record_id=15206 code=042660 name=한화오션 label=rising_missed_initial_quality_fail avg_down=3 latest_profit=-5.23 min_profit=-5.23 max_profit=0.67 latest_gate=None
