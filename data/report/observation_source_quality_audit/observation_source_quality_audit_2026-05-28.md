...
## Warning Stages
- `scalp_sim_pre_submit_overbought_guard_would_pass` sample=`200` missing=`{'sim_overbought_risk_state': 0.965}` zero=`{}`
...
- `bad_entry_refined_candidate`: `10955`
- `scalp_sim_panic_scale_in_blocked`: `9880`
- `stat_action_decision_snapshot`: `8433`
...
- `scalp_entry_action_decision_snapshot`: `4456`
