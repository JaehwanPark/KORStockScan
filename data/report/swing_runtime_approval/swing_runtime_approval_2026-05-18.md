...
| --- | --- | ---: | --- |
| `swing_model_floor` | `hold_no_edge` | 0.3501 | `tradeoff_score_below_approval_threshold` |
| `swing_selection_top_k` | `hold_no_edge` | 0.3501 | `tradeoff_score_below_approval_threshold` |
| `swing_gatekeeper_accept_reject` | `freeze` | 0.3501 | `runtime_family_guard_missing` |
| `swing_gatekeeper_reject_cooldown` | `hold_no_edge` | 0.3501 | `tradeoff_score_below_approval_threshold` |
| `swing_market_regime_sensitivity` | `hold_no_edge` | 0.3501 | `tradeoff_score_below_approval_threshold` |
...
| --- | --- | --- | ---: |
| `swing_scale_in_ofi_qi_confirmation` | `scale_in` | `scale_in_ofi_qi_invalid_micro_context` | 52/2 |
| `swing_scale_in_real_canary_phase0` | `scale_in` | `scale_in_ofi_qi_invalid_micro_context` | 52/2 |
