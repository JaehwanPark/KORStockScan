# Swing Runtime Approval - 2026-05-27
...
| --- | --- | --- | ---: |
| `swing_entry_ofi_qi_execution_quality` | `entry` | `entry_ofi_qi_invalid_micro_context` | 65882/19 |
| `swing_scale_in_ofi_qi_confirmation` | `scale_in` | `scale_in_ofi_qi_invalid_micro_context` | 94/2 |
| `swing_scale_in_real_canary_phase0` | `scale_in` | `scale_in_ofi_qi_invalid_micro_context` | 94/2 |
