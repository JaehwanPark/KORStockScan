...
| --- | --- | --- | ---: | ---: | --- |
| `swing_runtime_approval:2026-05-21:swing_model_floor` | `swing_model_floor` | `selection` | 0.955 | 3/3 | `SWING_FLOOR_BULL, SWING_FLOOR_BEAR` |
| `swing_runtime_approval:2026-05-21:swing_gatekeeper_reject_cooldown` | `swing_gatekeeper_reject_cooldown` | `entry` | 0.955 | 19/5 | `ML_GATEKEEPER_REJECT_COOLDOWN` |
| `swing_one_share_real_canary:2026-05-21:phase0` | `swing_one_share_real_canary_phase0` | `real_canary_entry` | 0.955 | 22/5 | `SWING_ONE_SHARE_REAL_CANARY_ENABLED, SWING_ONE_SHARE_REAL_CANARY_ALLOWED_CODES, SWING_ONE_SHARE_REAL_CANARY_MAX_QTY, SWING_ONE_SHARE_REAL_CANARY_MAX_NEW_ENTRIES_PER_DAY, SWING_ONE_SHARE_REAL_CANARY_MAX_OPEN_POSITIONS, SWING_ONE_SHARE_REAL_CANARY_MAX_TOTAL_NOTIONAL_KRW, SWING_ONE_SHARE_REAL_CANARY_REQUIRE_APPROVAL_ARTIFACT` |
...
| `swing_entry_ofi_qi_execution_quality` | `hold_sample` | 0.905 | `family_sample_floor_not_met, runtime_family_guard_missing` |
...
| --- | --- | --- | ---: |
| `swing_scale_in_ofi_qi_confirmation` | `scale_in` | `scale_in_ofi_qi_invalid_micro_context` | 24/1 |
| `swing_scale_in_real_canary_phase0` | `scale_in` | `scale_in_ofi_qi_invalid_micro_context` | 24/1 |
