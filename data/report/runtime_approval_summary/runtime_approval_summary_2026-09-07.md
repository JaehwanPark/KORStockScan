# Runtime Approval Summary - 2026-09-07
...
- scalping_reported_items/current_selected/current_enabled: `20` / `2` / `1`
- scalping_reported_current_selected_postclose_hold/next_preopen_candidate: `2` / `0`
...
- microstructure_reaction_available/ok: `True` / `752`
...
- env_generated_at: `2026-09-07T07:35:03`
- first_bot_start_at: `2026-09-07T07:55:03`
- first_bot_start_after_env_at: `2026-09-07T07:55:03`
...
- avg_scores ask/hold/bid: `49.642` / `50.102` / `53.922`
...
| `scale_in_price_guard` | 추가매수 직전 best bid/defensive limit, spread, stale quote로 가격품질을 보장하는 축 | 기존 적용 유지: 추가매수 가격품질 guard ON | `False` / `False` | `hold_sample` | `hold_no_next_preopen_change` | `intentional_pre_submit_safety_guard` | scale-in price quality EV/source-quality only | 축은 유지/관찰하지만 표본/소스 계약 미충족으로 runtime 변경은 하지 않는다 | 1 | `-` | window_policy primary=rolling_10d 기준 재평가: 물타기/불타기 resolved/executed cohort가 없어 가격·수량 guard 값은 유지하고 다음 장후 재산정, ai_review_item_missing |
...
## Pattern Lab Audits
- currentness: status=`pass` fail=`0` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_currentness_audit/pattern_lab_currentness_audit_2026-09-07.json`
- ai_review: status=`warning` artifact=`/home/ubuntu/KORStockScan/data/report/pattern_lab_ai_review/pattern_lab_ai_review_2026-09-07.json`
