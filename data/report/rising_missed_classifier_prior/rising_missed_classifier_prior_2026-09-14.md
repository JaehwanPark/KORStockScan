# Rising Missed Classifier Prior - 2026-09-14

- generated_at: 2026-09-14T22:16:20+09:00
...
- recommendation_counts: {"hold_sample": 24, "loss_filter": 13}
...
- entry_score_parent=-|entry_source_parent=-|source_signature=BID_IMBALANCE_SURGE,VALUE_TOP|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=loss_filter | confidence=medium | window=None | reason=counterfactual_avoided_loser_exceeds_missed_winner
...
- entry_score_parent=-|entry_source_parent=-|source_signature=NEW_HIGH_CONFIRMATION,OPEN_TOP,PREV_CLOSE_GAINER,PRICE_JUMP_START,VI_TRIGGERED|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=hold_sample | confidence=low | window=None | reason=counterfactual_missed_winner_waiting_rolling_confirmation
...
- entry_score_parent=-|entry_source_parent=-|source_signature=NEW_HIGH_CONFIRMATION,OPEN_TOP,PRICE_JUMP_START,REALTIME_RANK_START,VOLUME_SURGE_POSITIVE|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=loss_filter | confidence=medium | window=None | reason=counterfactual_avoided_loser_exceeds_missed_winner
- entry_score_parent=-|entry_source_parent=-|source_signature=NEW_HIGH_CONFIRMATION|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=loss_filter | confidence=medium | window=None | reason=counterfactual_avoided_loser_exceeds_missed_winner
- entry_score_parent=-|entry_source_parent=-|source_signature=OPEN_TOP,PREV_CLOSE_GAINER,PRICE_JUMP_START,REALTIME_RANK_START,VALUE_TOP,VI_TRIGGERED,VOLUME_SURGE_POSITIVE|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=hold_sample | confidence=low | window=None | reason=counterfactual_missed_winner_waiting_rolling_confirmation
...
- entry_score_parent=-|entry_source_parent=-|source_signature=OPEN_TOP,PREV_CLOSE_GAINER,PRICE_JUMP_START,VI_TRIGGERED,VOLUME_SURGE_POSITIVE|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=loss_filter | confidence=medium | window=None | reason=counterfactual_avoided_loser_exceeds_missed_winner
- entry_score_parent=-|entry_source_parent=-|source_signature=OPEN_TOP,PREV_CLOSE_GAINER,PRICE_JUMP_START|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=hold_sample | confidence=low | window=None | reason=counterfactual_missed_winner_waiting_rolling_confirmation
- entry_score_parent=-|entry_source_parent=-|source_signature=OPEN_TOP,PREV_CLOSE_GAINER,REALTIME_RANK_START,VALUE_TOP,VI_TRIGGERED,VOLUME_SURGE_POSITIVE|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=loss_filter | confidence=medium | window=None | reason=counterfactual_avoided_loser_exceeds_missed_winner
...
- tp1_selector|rising_missed_tp1_insufficient_positive_support | assessment=bounded_probe_exploration_candidate | sample=30 | target_first=5 | adverse_first=8 | payoff_proxy=0.03
- tp1_selector|rising_missed_tp1_wait_confirmation_pending | assessment=bounded_probe_exploration_candidate | sample=24 | target_first=9 | adverse_first=12 | payoff_proxy=0.1375
- tp1_selector|tp1_micro_ws_unavailable | assessment=hold_loss_dominant | sample=808 | target_first=42 | adverse_first=164 | payoff_proxy=-0.074505
- tp1_selector|rising_missed_tp1_nxt_fast_tape_confirmation_required | assessment=hold_loss_dominant | sample=378 | target_first=25 | adverse_first=65 | payoff_proxy=-0.034392
- tp1_selector|rising_missed_tp1_lane_not_eligible | assessment=hold_loss_dominant | sample=232 | target_first=14 | adverse_first=79 | payoff_proxy=-0.159914
- latency_block|latency_state_danger | assessment=hold_loss_dominant | sample=107 | target_first=3 | adverse_first=95 | payoff_proxy=-0.585047
- tp1_selector|rising_missed_tp1_hard_negative_evidence | assessment=hold_loss_dominant | sample=54 | target_first=5 | adverse_first=27 | payoff_proxy=-0.22963
- rising_missed_tick_speed_entry_block|tick_acceleration_ratio_lt_1 | assessment=hold_loss_dominant | sample=38 | target_first=4 | adverse_first=17 | payoff_proxy=-0.176316
- tp1_selector|rising_missed_tp1_ai_state_blocked | assessment=hold_loss_dominant | sample=33 | target_first=5 | adverse_first=14 | payoff_proxy=-0.1
...
- rising_missed_tick_speed_entry_block|tick_window_span_sec_ge_60 | assessment=hold_loss_dominant | sample=7 | target_first=0 | adverse_first=1 | payoff_proxy=-0.1
- tp1_selector|tp1_freshness_envelope_unavailable | assessment=hold_loss_dominant | sample=6 | target_first=1 | adverse_first=2 | payoff_proxy=-0.016667
