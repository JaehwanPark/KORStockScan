# Rising Missed Classifier Prior - 2026-09-08

- generated_at: 2026-09-08T21:48:50+09:00
...
- recommendation_counts: {"hold_sample": 83, "loss_filter": 37}
...
- entry_score_parent=-|entry_source_parent=-|source_signature=BID_IMBALANCE_SURGE,NEW_HIGH_CONFIRMATION,PREV_CLOSE_GAINER,PRICE_JUMP_START,REALTIME_RANK_START,VALUE_TOP,VOLUME_SURGE_POSITIVE|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=hold_sample | confidence=low | window=None | reason=counterfactual_missed_winner_waiting_rolling_confirmation
...
- entry_score_parent=-|entry_source_parent=-|source_signature=BID_IMBALANCE_SURGE,NEW_HIGH_CONFIRMATION,PRICE_JUMP_START|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=loss_filter | confidence=medium | window=None | reason=counterfactual_avoided_loser_exceeds_missed_winner
...
- tp1_selector|rising_missed_tp1_wait_confirmation_pending | assessment=bounded_probe_exploration_candidate | sample=28 | target_first=9 | adverse_first=16 | payoff_proxy=0.017857
- tp1_selector|tp1_micro_ws_unavailable | assessment=hold_loss_dominant | sample=723 | target_first=40 | adverse_first=132 | payoff_proxy=-0.055878
- tp1_selector|rising_missed_tp1_nxt_fast_tape_confirmation_required | assessment=hold_loss_dominant | sample=444 | target_first=29 | adverse_first=85 | payoff_proxy=-0.049099
- tp1_selector|rising_missed_tp1_lane_not_eligible | assessment=hold_loss_dominant | sample=279 | target_first=14 | adverse_first=94 | payoff_proxy=-0.170609
- latency_block|latency_state_danger | assessment=hold_loss_dominant | sample=119 | target_first=4 | adverse_first=104 | payoff_proxy=-0.568067
- tp1_selector|rising_missed_tp1_hard_negative_evidence | assessment=hold_loss_dominant | sample=63 | target_first=9 | adverse_first=27 | payoff_proxy=-0.114286
...
- rising_missed_tick_speed_entry_block|tick_window_span_sec_ge_60+tick_acceleration_ratio_lt_1 | assessment=hold_loss_dominant | sample=11 | target_first=0 | adverse_first=1 | payoff_proxy=-0.063636
