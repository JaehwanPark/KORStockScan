# Rising Missed Classifier Prior - 2026-09-07

- generated_at: 2026-09-07T21:43:15+09:00
...
- entry_score_parent=-|entry_source_parent=-|source_signature=BID_IMBALANCE_SURGE,NEW_HIGH_CONFIRMATION,OPEN_TOP,PREV_CLOSE_GAINER,VI_TRIGGERED,VOLUME_SURGE_POSITIVE|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=hold_sample | confidence=low | window=None | reason=insufficient_positive_rolling_prior
...
- entry_score_parent=-|entry_source_parent=-|source_signature=BID_IMBALANCE_SURGE,OPEN_TOP,PREV_CLOSE_GAINER,VOLUME_SURGE_POSITIVE|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=loss_filter | confidence=medium | window=None | reason=counterfactual_avoided_loser_exceeds_missed_winner
...
- entry_score_parent=-|entry_source_parent=-|source_signature=BID_IMBALANCE_SURGE,PREV_CLOSE_GAINER|liquidity_bucket=-|strength_bucket=-|overbought_bucket=-|chosen_action=- | recommendation=hold_sample | confidence=low | window=None | reason=counterfactual_missed_winner_waiting_rolling_confirmation
...
- tp1_selector|rising_missed_tp1_insufficient_positive_support | assessment=bounded_probe_exploration_candidate | sample=33 | target_first=5 | adverse_first=9 | payoff_proxy=0.006061
- tp1_selector|rising_missed_tp1_wait_confirmation_pending | assessment=bounded_probe_exploration_candidate | sample=31 | target_first=11 | adverse_first=16 | payoff_proxy=0.1
- tp1_selector|tp1_micro_ws_unavailable | assessment=hold_loss_dominant | sample=668 | target_first=40 | adverse_first=110 | payoff_proxy=-0.037425
- tp1_selector|rising_missed_tp1_nxt_fast_tape_confirmation_required | assessment=hold_loss_dominant | sample=454 | target_first=30 | adverse_first=89 | payoff_proxy=-0.051322
- tp1_selector|rising_missed_tp1_lane_not_eligible | assessment=hold_loss_dominant | sample=290 | target_first=15 | adverse_first=100 | payoff_proxy=-0.174138
- latency_block|latency_state_danger | assessment=hold_loss_dominant | sample=116 | target_first=4 | adverse_first=103 | payoff_proxy=-0.576724
- tp1_selector|rising_missed_tp1_hard_negative_evidence | assessment=hold_loss_dominant | sample=65 | target_first=9 | adverse_first=30 | payoff_proxy=-0.143077
- rising_missed_tick_speed_entry_block|tick_acceleration_ratio_lt_1 | assessment=hold_loss_dominant | sample=40 | target_first=3 | adverse_first=21 | payoff_proxy=-0.27
- tp1_selector|rising_missed_tp1_ai_state_blocked | assessment=hold_loss_dominant | sample=15 | target_first=1 | adverse_first=6 | payoff_proxy=-0.193333
