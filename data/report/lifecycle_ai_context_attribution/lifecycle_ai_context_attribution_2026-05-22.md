# Lifecycle AI Context Attribution - 2026-05-22

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `3237` / `3237` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `3237` | `3237` | `0` | `0.9969` | `0` | `None` | `None` | `0.3478` | `observational_only_pending_outcome` |
