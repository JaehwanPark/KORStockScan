# Lifecycle AI Context Attribution - 2026-06-02

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `2937` / `2937` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `2937` | `2937` | `0` | `0.0783` | `0` | `None` | `None` | `-0.2952` | `observational_only_pending_outcome` |
