# Lifecycle AI Context Attribution - 2026-06-01

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `3175` / `3175` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `3175` | `3175` | `0` | `0.0945` | `0` | `None` | `None` | `-0.2838` | `observational_only_pending_outcome` |
