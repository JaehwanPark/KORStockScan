# Lifecycle AI Context Attribution - 2026-09-04

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `452` / `452` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `452` | `452` | `0` | `0.1128` | `0` | `None` | `None` | `-0.271` | `observational_only_pending_outcome` |
