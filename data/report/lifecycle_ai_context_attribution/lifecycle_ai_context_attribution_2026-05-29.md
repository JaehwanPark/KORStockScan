# Lifecycle AI Context Attribution - 2026-05-29

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `1636` / `1636` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `1636` | `1636` | `0` | `0.445` | `0` | `None` | `None` | `-0.0385` | `observational_only_pending_outcome` |
