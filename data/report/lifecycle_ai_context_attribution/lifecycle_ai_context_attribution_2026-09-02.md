# Lifecycle AI Context Attribution - 2026-09-02

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `465` / `465` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `465` | `465` | `0` | `None` | `0` | `None` | `None` | `0.0` | `observational_only_pending_outcome` |
