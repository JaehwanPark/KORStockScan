# Lifecycle AI Context Attribution - 2026-08-14

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `430` / `430` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `430` | `430` | `0` | `None` | `0` | `None` | `None` | `0.0` | `observational_only_pending_outcome` |
