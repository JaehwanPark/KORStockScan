# Lifecycle AI Context Attribution - 2026-05-27

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `2596` / `2596` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `2596` | `2596` | `0` | `0.0732` | `0` | `None` | `None` | `-0.2988` | `observational_only_pending_outcome` |
