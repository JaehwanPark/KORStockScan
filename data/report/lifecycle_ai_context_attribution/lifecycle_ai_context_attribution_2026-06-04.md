# Lifecycle AI Context Attribution - 2026-06-04

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `213` / `213` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `213` | `213` | `0` | `None` | `0` | `None` | `None` | `0.0` | `observational_only_pending_outcome` |
