# Lifecycle AI Context Attribution - 2026-05-26

- authority: `postclose_context_attribution_only`
- runtime_effect: `False`
- context eligible/applied/skipped: `3860` / `3860` / `0`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `entry` | `3860` | `3860` | `0` | `0.071` | `0` | `None` | `None` | `-0.3003` | `observational_only_pending_outcome` |
