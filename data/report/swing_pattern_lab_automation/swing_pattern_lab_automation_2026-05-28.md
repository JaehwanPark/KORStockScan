...
- `swing_pattern_lab_deepseek_entry_market_regime_block` route=`defer_evidence` family=`swing_market_regime_sensitivity` stage=`entry`
...
## Carryover Warnings
- swing_pattern_lab_deepseek_entry_gatekeeper_reject: carryover-only blocker (10 events); no selection-population blocker
- swing_pattern_lab_deepseek_entry_gap_block: carryover-only blocker (4 events); no selection-population blocker
- swing_pattern_lab_deepseek_entry_market_regime_block: carryover-only blocker (18 events); no selection-population blocker
