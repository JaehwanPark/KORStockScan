...
- observation_axis_status: `{'ready': 4, 'hold_sample': 5, 'instrumentation_gap': 1}`
...
- stale_missing_reason_counts_by_group: `{'exit': {'micro_missing': 4}}`
- stale_missing_reason_unique_record_counts_by_group: `{'exit': {'micro_missing': 3}}`
...
- orderbook_micro_reason_counts_by_group: `{'exit': {'micro_estimator_true_ofi_primary': 4}}`
- observer_missing_reason_counts_by_group: `{'exit': {'UNKNOWN': 4}}`
- source_quality_status_counts_by_group: `{'exit': {'UNKNOWN': 4}}`
- ws_quote_source_counts_by_group: `{'exit': {'UNKNOWN': 4}}`
- ws_quote_stale_counts_by_group: `{'exit': {'UNKNOWN': 4}}`
- entry_micro_state_counts: `{}`
- scale_in_micro_state_counts: `{}`
- exit_micro_state_counts: `{'bearish': 1, 'bullish': 3}`
...
| `swing_holding_mfe_mae_defer` | `holding` | `swing_holding_flow_defer` | 4 | `instrumentation_gap` |
| `swing_scale_in_avg_down_pyramid` | `scale_in` | `swing_pyramid_trigger` | 0 | `hold_sample` |
| `swing_exit_post_sell_attribution` | `exit` | `swing_trailing_stop_time_stop` | 19 | `ready` |
...
| `swing_exit_ofi_qi_smoothing` | `holding_exit` | `swing_exit_ofi_qi_smoothing` | 4 | `ready` |
