...
- policy_version: `scale_in_split_order_plan:2026-07-07:bcddaff8db4d`
...
- bucket=`unknown_strategy:stop_line_touch:normal` mode=`counterfactual_tick_band_selector` real=`4` sim=`0` offsets=`[0, 1]`
