# Lifecycle Decision Matrix - 2026-05-01

## Contract
- matrix_version: `lifecycle_decision_matrix_v1_2026-05-01`
...
| `scale_in` | 24 | 24 | -55.622 | 1.0 | `pass` | `NO_CHANGE` | False |
...
- summary: `{'flow_count': 1, 'complete_flow_count': 0, 'fallback_identity_count': 0, 'identity_missing_count': 0, 'identity_present_count': 24, 'identity_join_rate': 1.0, 'complete_flow_rate': 0.0, 'stage_identity': {'entry': {'source_row_count': 0, 'identity_missing_count': 0, 'identity_quality_counts': {}, 'identity_join_rate': 0.0}, 'submit': {'source_row_count': 0, 'identity_missing_count': 0, 'identity_quality_counts': {}, 'identity_join_rate': 0.0}, 'holding': {'source_row_count': 0, 'identity_missing_count': 0, 'identity_quality_counts': {}, 'identity_join_rate': 0.0}, 'scale_in': {'source_row_count': 24, 'identity_missing_count': 0, 'identity_quality_counts': {'candidate_id': 24}, 'identity_join_rate': 1.0}, 'exit': {'source_row_count': 0, 'identity_missing_count': 0, 'identity_quality_counts': {}, 'identity_join_rate': 0.0}}, 'incomplete_flow_reason_counts': {'missing_entry': 1, 'missing_submit': 1, 'missing_holding': 1, 'missing_exit': 1}, 'bucket_count': 1, 'runtime_candidate_count': 0, 'workorder_count': 1}`
...
- primary_decision_metric: `source_quality_adjusted_ev_pct`
- summary: `{'scale_in_rows': 24, 'bucket_count': 14, 'actionable_bucket_count': 14, 'runtime_candidate_count': 9, 'workorder_count': 10, 'arm_counts': {'PYRAMID': 8, 'AVG_DOWN': 16}}`

| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `ai_score_band` | `score_lt60` | 24 | 24 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `ai_score_source` | `ai_source_unknown` | 24 | 24 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `arm` | `AVG_DOWN` | 16 | 16 | -43.77 | -54.655 | 0.0 | `candidate_tighten_or_exclude` |
| `arm` | `PYRAMID` | 8 | 8 | -79.326 | -99.1 | 0.0 | `candidate_tighten_or_exclude` |
| `blocker_namespace` | `AVG_DOWN` | 16 | 16 | -43.77 | -54.655 | 0.0 | `candidate_tighten_or_exclude` |
| `blocker_namespace` | `PYRAMID` | 8 | 8 | -79.326 | -99.1 | 0.0 | `candidate_tighten_or_exclude` |
| `blocker_reason` | `🛑 하드스탑 도달 (-2.5%) [AI: 50]` | 24 | 24 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `held_bucket` | `held_lt020s` | 24 | 24 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `peak_profit_band` | `peak_lt_zero` | 24 | 24 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `price_guard_reason` | `price_guard_none` | 24 | 24 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `profit_band` | `profit_lt_neg070` | 24 | 24 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `qty_reason` | `qty_none` | 24 | 24 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `supply_pass_bucket` | `supply_pass_unknown` | 24 | 24 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `time_bucket` | `time_unknown` | 24 | 24 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
