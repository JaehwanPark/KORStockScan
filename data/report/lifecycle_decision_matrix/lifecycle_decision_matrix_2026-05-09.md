# Lifecycle Decision Matrix - 2026-05-09

## Contract
- matrix_version: `lifecycle_decision_matrix_v1_2026-05-09`
...
- scale_in_bucket_actionable_count: `15`
...
- incomplete_flow_reason_counts: `{'missing_entry': 13, 'missing_exit': 13, 'missing_submit': 12, 'missing_holding': 12}`
...
| `scale_in` | 66 | 33 | -55.622 | 1.0 | `pass` | `NO_CHANGE` | False |
...
- summary: `{'flow_count': 13, 'complete_flow_count': 0, 'fallback_identity_count': 0, 'identity_missing_count': 0, 'identity_present_count': 68, 'identity_join_rate': 1.0, 'complete_flow_rate': 0.0, 'stage_identity': {'entry': {'source_row_count': 0, 'identity_missing_count': 0, 'identity_quality_counts': {}, 'identity_join_rate': 0.0}, 'submit': {'source_row_count': 1, 'identity_missing_count': 0, 'identity_quality_counts': {'exact_sim_record_id': 1}, 'identity_join_rate': 1.0}, 'holding': {'source_row_count': 1, 'identity_missing_count': 0, 'identity_quality_counts': {'exact_sim_record_id': 1}, 'identity_join_rate': 1.0}, 'scale_in': {'source_row_count': 66, 'identity_missing_count': 0, 'identity_quality_counts': {'candidate_id': 66}, 'identity_join_rate': 1.0}, 'exit': {'source_row_count': 0, 'identity_missing_count': 0, 'identity_quality_counts': {}, 'identity_join_rate': 0.0}}, 'incomplete_flow_reason_counts': {'missing_entry': 13, 'missing_exit': 13, 'missing_submit': 12, 'missing_holding': 12}, 'bucket_count': 3, 'runtime_candidate_count': 0, 'workorder_count': 13}`
...
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:8cd4f96ab3` | 11 | 0 | None | `hold_sample` | `hold_sample_or_incomplete_flow` |
...
| `combo_submit_quality` | `source=scalp_sim_buy_order_assumed_filled|revalidation=ok_or_unflagged|quote_age=quote_age_unknown|liquidity=liquidity_unknown|liquidity_guard=liquidity_guard_unknown|overbought=overbought_unknown|latency=latency_unknown|fill=would_limit_fill_unknown|submitted=false` | 1 | 0 | None | `source_quality_workorder` |
...
| `would_limit_fill` | `would_limit_fill_unknown` | 1 | 0 | None | `source_quality_workorder` |
...
- primary_decision_metric: `source_quality_adjusted_ev_pct`
- summary: `{'scale_in_rows': 66, 'bucket_count': 27, 'actionable_bucket_count': 15, 'runtime_candidate_count': 10, 'workorder_count': 10, 'arm_counts': {'AVG_DOWN': 33, 'PYRAMID': 33}}`

| bucket_type | bucket_key | sample | joined | ev | avg_profit | win_rate | route |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `ai_score_band` | `score_lt60` | 33 | 33 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `ai_score_band` | `score_unknown` | 33 | 0 | None | None | None | `hold_sample` |
| `ai_score_source` | `ai_source_unknown` | 66 | 33 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `arm` | `AVG_DOWN` | 33 | 22 | -43.77 | -54.655 | 0.0 | `candidate_tighten_or_exclude` |
| `arm` | `PYRAMID` | 33 | 11 | -79.326 | -99.1 | 0.0 | `candidate_tighten_or_exclude` |
| `blocker_namespace` | `AVG_DOWN` | 22 | 22 | -43.77 | -54.655 | 0.0 | `candidate_tighten_or_exclude` |
| `blocker_namespace` | `PYRAMID` | 11 | 11 | -79.326 | -99.1 | 0.0 | `candidate_tighten_or_exclude` |
| `blocker_namespace` | `PRICE_GUARD` | 22 | 0 | None | None | None | `hold_sample` |
| `blocker_namespace` | `QTY_GUARD` | 11 | 0 | None | None | None | `hold_sample` |
| `blocker_reason` | `🛑 하드스탑 도달 (-2.5%) [AI: 50]` | 26 | 26 | -49.2402 | -61.4927 | 0.0 | `candidate_tighten_or_exclude` |
| `blocker_reason` | `market_closed_sell_block` | 7 | 7 | -79.326 | -99.1 | 0.0 | `candidate_tighten_or_exclude` |
| `blocker_reason` | `invalid_quote` | 11 | 0 | None | None | None | `hold_sample` |
| `blocker_reason` | `pyramid_evidence_insufficient:buy_pressure_ok,tick_accel_ok` | 11 | 0 | None | None | None | `hold_sample` |
| `blocker_reason` | `spread_bps>80.0` | 11 | 0 | None | None | None | `hold_sample` |
| `held_bucket` | `held_lt020s` | 33 | 33 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `held_bucket` | `held_unknown` | 33 | 0 | None | None | None | `hold_sample` |
| `peak_profit_band` | `peak_lt_zero` | 33 | 33 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `peak_profit_band` | `peak_unknown` | 33 | 0 | None | None | None | `hold_sample` |
| `price_guard_reason` | `price_guard_none` | 44 | 33 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `price_guard_reason` | `invalid_quote` | 11 | 0 | None | None | None | `hold_sample` |
| `profit_band` | `profit_lt_neg070` | 33 | 33 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `qty_reason` | `qty_none` | 55 | 33 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `supply_pass_bucket` | `supply_pass_unknown` | 66 | 33 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
| `time_bucket` | `time_unknown` | 66 | 33 | -55.622 | -69.47 | 0.0 | `candidate_tighten_or_exclude` |
...
- `scale_in_bucket_9`: `held_bucket` / `held_lt020s` -> `candidate_tighten_or_exclude`
- `scale_in_bucket_10`: `peak_profit_band` / `peak_lt_zero` -> `candidate_tighten_or_exclude`
- `scale_in_bucket_11`: `price_guard_reason` / `price_guard_none` -> `candidate_tighten_or_exclude`
- `scale_in_bucket_12`: `profit_band` / `profit_lt_neg070` -> `candidate_tighten_or_exclude`
...
- `scale_in_bucket_source_quality_8`: `blocker_reason` / `market_closed_sell_block` -> `scale_in_arm_bucket_needs_source_quality_or_threshold_cycle_confirmation`
- `scale_in_bucket_source_quality_9`: `held_bucket` / `held_lt020s` -> `scale_in_arm_bucket_needs_source_quality_or_threshold_cycle_confirmation`
- `scale_in_bucket_source_quality_10`: `peak_profit_band` / `peak_lt_zero` -> `scale_in_arm_bucket_needs_source_quality_or_threshold_cycle_confirmation`
