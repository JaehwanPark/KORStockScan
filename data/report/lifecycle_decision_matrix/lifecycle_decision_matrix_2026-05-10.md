# Lifecycle Decision Matrix - 2026-05-10

## Contract
- matrix_version: `lifecycle_decision_matrix_v1_2026-05-10`
...
- incomplete_flow_reason_counts: `{'missing_entry': 6, 'missing_submit': 6, 'missing_holding': 6, 'missing_exit': 6}`
...
- summary: `{'flow_count': 6, 'complete_flow_count': 0, 'fallback_identity_count': 0, 'identity_missing_count': 0, 'identity_present_count': 30, 'identity_join_rate': 1.0, 'complete_flow_rate': 0.0, 'stage_identity': {'entry': {'source_row_count': 0, 'identity_missing_count': 0, 'identity_quality_counts': {}, 'identity_join_rate': 0.0}, 'submit': {'source_row_count': 0, 'identity_missing_count': 0, 'identity_quality_counts': {}, 'identity_join_rate': 0.0}, 'holding': {'source_row_count': 0, 'identity_missing_count': 0, 'identity_quality_counts': {}, 'identity_join_rate': 0.0}, 'scale_in': {'source_row_count': 30, 'identity_missing_count': 0, 'identity_quality_counts': {'candidate_id': 30}, 'identity_join_rate': 1.0}, 'exit': {'source_row_count': 0, 'identity_missing_count': 0, 'identity_quality_counts': {}, 'identity_join_rate': 0.0}}, 'incomplete_flow_reason_counts': {'missing_entry': 6, 'missing_submit': 6, 'missing_holding': 6, 'missing_exit': 6}, 'bucket_count': 2, 'runtime_candidate_count': 0, 'workorder_count': 6}`
...
- primary_decision_metric: `source_quality_adjusted_ev_pct`
- summary: `{'scale_in_rows': 30, 'bucket_count': 27, 'actionable_bucket_count': 14, 'runtime_candidate_count': 9, 'workorder_count': 10, 'arm_counts': {'AVG_DOWN': 15, 'PYRAMID': 15}}`
...
| `blocker_namespace` | `PRICE_GUARD` | 10 | 0 | None | None | None | `hold_sample` |
| `blocker_namespace` | `QTY_GUARD` | 5 | 0 | None | None | None | `hold_sample` |
| `blocker_reason` | `🛑 하드스탑 도달 (-2.5%) [AI: 50]` | 12 | 12 | -49.696 | -62.0625 | 0.0 | `candidate_tighten_or_exclude` |
| `blocker_reason` | `market_closed_sell_block` | 3 | 3 | -79.326 | -99.1 | 0.0 | `hold_sample` |
