...
- holding_bucket_count/workorders: `31` / `10`
- exit_bucket_count/workorders: `67` / `10`
...
| `submit` | 215 | 199 | -0.6071 | 1.0 | `pass` | `NO_CHANGE` | False |
| `holding` | 215 | 199 | -0.7334 | 1.0 | `pass` | `EXIT` | False |
| `scale_in` | 22523 | 22489 | -0.4383 | 1.0 | `pass` | `NO_CHANGE` | False |
| `exit` | 951 | 759 | -0.5616 | 1.0 | `pass` | `EXIT` | False |
...
- summary: `{'flow_count': 12962, 'complete_flow_count': 0, 'incomplete_flow_count': 12962, 'fallback_identity_count': 0, 'identity_missing_count': 0, 'identity_present_count': 24454, 'identity_join_rate': 1.0, 'complete_flow_rate': 0.0, 'join_contract_blocked': True, 'bundle_ev_tuning_state': 'blocked_join_gap', 'top_incomplete_reason': 'missing_holding', 'stage_identity': {'entry': {'source_row_count': 550, 'identity_missing_count': 0, 'identity_quality_counts': {'candidate_id': 550}, 'identity_join_rate': 1.0}, 'submit': {'source_row_count': 215, 'identity_missing_count': 0, 'identity_quality_counts': {'candidate_id': 16, 'exact_sim_record_id': 199}, 'identity_join_rate': 1.0}, 'holding': {'source_row_count': 215, 'identity_missing_count': 0, 'identity_quality_counts': {'exact_sim_record_id': 215}, 'identity_join_rate': 1.0}, 'scale_in': {'source_row_count': 22523, 'identity_missing_count': 0, 'identity_quality_counts': {'exact_sim_record_id': 9881, 'candidate_id': 12642}, 'identity_join_rate': 1.0}, 'exit': {'source_row_count': 951, 'identity_missing_count': 0, 'identity_quality_counts': {'exact_sim_record_id': 759, 'candidate_id': 192}, 'identity_join_rate': 1.0}}, 'required_stage_source_counts': {'entry': 550, 'submit': 215, 'holding': 215, 'exit': 951}, 'incomplete_flow_reason_counts': {'missing_entry': 12412, 'missing_holding': 12762, 'missing_exit': 12570, 'candidate_id_only': 12762, 'missing_submit': 12747, 'sim_record_id_only': 200, 'postclose_exit_without_entry': 392, 'identity_namespace_mismatch': 1, 'join_contract_blocked': 1, 'entry_candidate_id_to_sim_record_id_bridge_missing': 1, 'entry_adm_candidate_id_missing': 1}, 'bucket_count': 69, 'runtime_candidate_count': 0, 'workorder_count': 20}`

| lifecycle_flow_bucket_id | sample | joined | ev | route | source_quality |
| --- | ---: | ---: | ---: | --- | --- |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:8cd4f96ab3` | 9692 | 9669 | -0.6697 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_missing_holding_holdin:7d607fe77a` | 2312 | 2303 | 0.6387 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_s:5f8bb8e981` | 85 | 85 | -0.6391 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_70p_source_wait:9f284741cf` | 49 | 49 | 1.643 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_s:bf81e4fab9` | 43 | 43 | -0.5128 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_66_69_source_wa:0dbddcc72e` | 21 | 21 | 1.1823 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_s:e81b5f597d` | 18 | 18 | -0.4633 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_60_62_source_sc:bfc859574f` | 101 | 9 | -0.0061 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_s:b3f591e69a` | 9 | 9 | -0.6078 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_63_65_source_wa:f8ff028ae0` | 7 | 7 | 2.6634 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_s:7ed5a2f0f0` | 7 | 7 | 0.3766 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_combo_entry_spot_score_score_70p_source_scal:ab1924a1fc` | 18 | 5 | 0.1916 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_s:f67c8c8c9f` | 5 | 5 | 2.2342 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_s:5814d62155` | 3 | 3 | -0.39 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_s:f87fa0c80c` | 3 | 3 | -0.6033 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_s:63baeaaeb7` | 3 | 3 | 1.0775 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_s:938f2788bd` | 3 | 3 | -1.2274 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_s:a1371ed802` | 3 | 3 | -1.102 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_s:71610cf3d7` | 2 | 2 | -0.47 | `hold_sample` | `join_contract_blocked` |
| `lifecycle_flow:combo_lifecycle_flow:entry_entry_missing_submit_submit_combo_submit_quality_s:b75dcb4fef` | 2 | 2 | -0.33 | `hold_sample` | `join_contract_blocked` |
...
- primary_decision_metric: `source_quality_adjusted_ev_pct`
- summary: `{'submit_rows': 215, 'bucket_count': 58, 'contract_gap_count': 0, 'workorder_count': 0, 'runtime_candidate_count': 0}`

| bucket_type | bucket_key | sample | joined | ev | route |
| --- | --- | ---: | ---: | ---: | --- |
| `actual_order_submitted` | `false` | 213 | 199 | -0.6071 | `keep_collecting` |
| `actual_order_submitted` | `true` | 2 | 0 | None | `keep_collecting` |
| `broker_order_forbidden` | `true` | 211 | 199 | -0.6071 | `keep_collecting` |
...
| `latency_reason` | `scalp_live_simulator` | 199 | 199 | -0.6071 | `keep_collecting` |
| `latency_reason` | `latency_reason_unknown` | 16 | 0 | None | `source_quality_workorder` |
| `latency_state` | `simulated` | 199 | 199 | -0.6071 | `keep_collecting` |
| `latency_state` | `latency_unknown` | 16 | 0 | None | `source_quality_workorder` |
| `liquidity_bucket` | `below_min_liquidity` | 176 | 175 | -0.6562 | `keep_collecting` |
| `liquidity_bucket` | `liquidity_ok` | 24 | 24 | -0.2497 | `keep_collecting` |
| `liquidity_bucket` | `liquidity_unknown` | 15 | 0 | None | `source_quality_workorder` |
| `liquidity_guard_action` | `would_block` | 175 | 175 | -0.6562 | `keep_collecting` |
| `liquidity_guard_action` | `would_pass` | 24 | 24 | -0.2497 | `keep_collecting` |
| `liquidity_guard_action` | `liquidity_guard_unknown` | 16 | 0 | None | `source_quality_workorder` |
| `overbought_bucket` | `overbought_unknown` | 195 | 192 | -0.5839 | `source_quality_workorder` |
| `overbought_bucket` | `overbought_normal` | 13 | 0 | None | `keep_collecting` |
| `overbought_bucket` | `overbought_ok` | 7 | 7 | -1.2449 | `keep_collecting` |
| `overbought_guard_action` | `would_pass` | 199 | 199 | -0.6071 | `keep_collecting` |
| `overbought_guard_action` | `overbought_guard_unknown` | 16 | 0 | None | `source_quality_workorder` |
| `price_below_bid_bucket` | `not_below_bid` | 134 | 134 | -0.5419 | `keep_collecting` |
| `price_below_bid_bucket` | `below_bid_20bps_plus` | 55 | 55 | -0.8194 | `keep_collecting` |
| `price_below_bid_bucket` | `price_below_bid_unknown` | 16 | 0 | None | `source_quality_workorder` |
...
| `price_resolution_bucket` | `defensive_order_price` | 73 | 73 | -0.824 | `keep_collecting` |
| `price_resolution_bucket` | `price_unknown` | 11 | 0 | None | `source_quality_workorder` |
| `price_resolution_bucket` | `price_resolution_unknown` | 3 | 3 | 0.1009 | `source_quality_workorder` |
...
- summary: `{'holding_rows': 215, 'source_row_count': 215, 'bucket_count': 31, 'joined_sample': 995, 'source_quality_adjusted_ev_pct': -0.7334, 'source_quality_gate': 'pass', 'unknown_reason_counts': {'not_applicable': 17, 'join_gap': 6, 'missing_source_field': 2}, 'workorder_count': 10, 'runtime_candidate_count': 0}`

| bucket_type | bucket_key | sample | joined | ev | route |
| --- | --- | ---: | ---: | ---: | --- |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=WAIT|profit=profit_lt_neg070|held=held_unknown` | 80 | 80 | -1.6773 | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=holding_action_unknown|profit=profit_lt_neg070|held=held_unknown` | 38 | 38 | -1.4253 | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=WAIT|profit=profit_pos150_pos300|held=held_unknown` | 19 | 19 | 0.3452 | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=WAIT|profit=profit_pos080_pos150|held=held_unknown` | 14 | 14 | 0.5753 | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=holding_action_unknown|profit=profit_pos150_pos300|held=held_unknown` | 11 | 11 | 0.4734 | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=holding_action_unknown|profit=profit_pos080_pos150|held=held_unknown` | 9 | 9 | 0.5918 | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=WAIT|profit=profit_neg010_pos080|held=held_unknown` | 8 | 8 | 0.1573 | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=WAIT|profit=profit_pos150_pos300_plus|held=held_unknown` | 7 | 7 | 2.2342 | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=holding_action_unknown|profit=profit_neg010_pos080|held=held_unknown` | 6 | 6 | -0.4498 | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=holding_action_unknown|profit=profit_pos150_pos300_plus|held=held_unknown` | 4 | 4 | 1.276 | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=BUY|profit=profit_lt_neg070|held=held_unknown` | 2 | 2 | 0.1671 | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_holding_started|action=WAIT|profit=profit_neg070_neg010|held=held_unknown` | 1 | 1 | -2.3877 | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_overnight_decision|action=holding_action_unknown|profit=profit_lt_neg070|held=held_600_1800s_plus` | 1 | 0 | None | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_overnight_decision|action=holding_action_unknown|profit=profit_neg010_pos080|held=held_600_1800s_plus` | 1 | 0 | None | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_overnight_decision|action=holding_action_unknown|profit=profit_neg070_neg010|held=held_600_1800s_plus` | 2 | 0 | None | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_overnight_decision|action=holding_action_unknown|profit=profit_pos080_pos150|held=held_600_1800s_plus` | 2 | 0 | None | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_overnight_decision|action=holding_action_unknown|profit=profit_pos150_pos300_plus|held=held_600_1800s_plus` | 3 | 0 | None | `source_quality_workorder` |
| `combo_holding_flow` | `source=scalp_sim_overnight_decision|action=holding_action_unknown|profit=profit_pos150_pos300|held=held_600_1800s_plus` | 7 | 0 | None | `source_quality_workorder` |
| `held_bucket` | `held_unknown` | 199 | 199 | -0.7334 | `source_quality_workorder` |
| `held_bucket` | `held_600_1800s_plus` | 16 | 0 | None | `hold_sample` |
| `holding_action` | `WAIT` | 129 | 129 | -0.8145 | `candidate_tighten_or_exclude` |
| `holding_action` | `holding_action_unknown` | 84 | 68 | -0.6062 | `source_quality_workorder` |
| `holding_action` | `BUY` | 2 | 2 | 0.1671 | `hold_sample` |
| `holding_source_stage` | `scalp_sim_holding_started` | 199 | 199 | -0.7334 | `candidate_tighten_or_exclude` |
...
- `holding_bucket_source_quality_3`: `combo_holding_flow` / `source=scalp_sim_holding_started|action=WAIT|profit=profit_pos150_pos300|held=held_unknown` -> `holding_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`
...
- `holding_bucket_source_quality_5`: `combo_holding_flow` / `source=scalp_sim_holding_started|action=holding_action_unknown|profit=profit_pos150_pos300|held=held_unknown` -> `holding_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`
...
- `holding_bucket_source_quality_7`: `combo_holding_flow` / `source=scalp_sim_holding_started|action=WAIT|profit=profit_neg010_pos080|held=held_unknown` -> `holding_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`
- `holding_bucket_source_quality_8`: `combo_holding_flow` / `source=scalp_sim_holding_started|action=WAIT|profit=profit_pos150_pos300_plus|held=held_unknown` -> `holding_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`
- `holding_bucket_source_quality_9`: `combo_holding_flow` / `source=scalp_sim_holding_started|action=holding_action_unknown|profit=profit_neg010_pos080|held=held_unknown` -> `holding_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`
...
- primary_decision_metric: `source_quality_adjusted_ev_pct`
- allowed_runtime_apply: `False`
- summary: `{'exit_rows': 951, 'source_row_count': 951, 'bucket_count': 67, 'joined_sample': 3795, 'source_quality_adjusted_ev_pct': -0.5616, 'source_quality_gate': 'pass', 'unknown_reason_counts': {'not_applicable': 18, 'join_gap': 8, 'missing_source_field': 1}, 'workorder_count': 10, 'runtime_candidate_count': 0}`

| bucket_type | bucket_key | sample | joined | ev | route |
| --- | --- | ---: | ---: | ---: | --- |
| `combo_exit_result` | `source=scalp_sim_partial_sell_order_assumed_filled|rule=scalp_sim_panic_lifecycle_partial_exit|outcome=outcome_unknown|profit=profit_lt_neg070` | 234 | 234 | -1.2014 | `source_quality_workorder` |
| `combo_exit_result` | `source=scalp_sim_partial_sell_order_assumed_filled|rule=scalp_sim_panic_lifecycle_partial_exit|outcome=outcome_unknown|profit=profit_neg070_neg010` | 212 | 212 | -0.4879 | `source_quality_workorder` |
| `combo_exit_result` | `source=scalp_sim_partial_sell_order_assumed_filled|rule=scalp_sim_panic_lifecycle_partial_exit|outcome=outcome_unknown|profit=profit_neg010_pos080` | 55 | 55 | 0.2545 | `source_quality_workorder` |
...
| `combo_exit_result` | `source=scalp_sim_partial_sell_order_assumed_filled|rule=scalp_sim_panic_lifecycle_partial_exit|outcome=outcome_unknown|profit=profit_pos080_pos150` | 12 | 12 | 1.0608 | `source_quality_workorder` |
| `combo_exit_result` | `source=scalp_sim_partial_sell_order_assumed_filled|rule=scalp_sim_panic_lifecycle_partial_exit|outcome=outcome_unknown|profit=profit_pos150_pos300` | 10 | 10 | 2.188 | `source_quality_workorder` |
...
| `combo_exit_result` | `source=scalp_sim_partial_sell_order_assumed_filled|rule=scalp_sim_panic_lifecycle_partial_exit|outcome=outcome_unknown|profit=profit_pos150_pos300_plus` | 4 | 4 | 3.3549 | `source_quality_workorder` |
...
- `exit_bucket_source_quality_1`: `combo_exit_result` / `source=scalp_sim_partial_sell_order_assumed_filled|rule=scalp_sim_panic_lifecycle_partial_exit|outcome=outcome_unknown|profit=profit_lt_neg070` -> `exit_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`
- `exit_bucket_source_quality_2`: `combo_exit_result` / `source=scalp_sim_partial_sell_order_assumed_filled|rule=scalp_sim_panic_lifecycle_partial_exit|outcome=outcome_unknown|profit=profit_neg070_neg010` -> `exit_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`
...
- `exit_bucket_source_quality_9`: `combo_exit_result` / `source=scalp_sim_partial_sell_order_assumed_filled|rule=scalp_sim_panic_lifecycle_partial_exit|outcome=outcome_unknown|profit=profit_pos080_pos150` -> `exit_stage_bucket_needs_source_quality_or_lifecycle_flow_confirmation`
...
- primary_decision_metric: `source_quality_adjusted_ev_pct`
- summary: `{'scale_in_rows': 22523, 'bucket_count': 1903, 'actionable_bucket_count': 207, 'runtime_candidate_count': 10, 'workorder_count': 10, 'arm_counts': {'PYRAMID': 2349, 'AVG_DOWN': 10294, 'arm_unknown': 9880}}`
...
| `ai_score_band` | `score_lt60` | 664 | 664 | -0.5086 | -0.5544 | 0.2154 | `candidate_tighten_or_exclude` |
| `ai_score_band` | `score_unknown` | 35 | 1 | 0.935 | 0.71 | 1.0 | `hold_sample` |
| `ai_score_source` | `ai_source_unknown` | 22523 | 22489 | -0.4383 | -0.488 | 0.2046 | `candidate_tighten_or_exclude` |
| `arm` | `AVG_DOWN` | 10294 | 10271 | -0.7101 | -0.8065 | 0.0 | `candidate_tighten_or_exclude` |
| `arm` | `arm_unknown` | 9880 | 9880 | -0.4107 | -0.4072 | 0.2344 | `candidate_tighten_or_exclude` |
| `arm` | `PYRAMID` | 2349 | 2338 | 0.6394 | 0.5698 | 0.9773 | `candidate_recovery_or_relax` |
| `blocker_namespace` | `blocker_namespace_unknown` | 9881 | 9881 | -0.4105 | -0.4071 | 0.2345 | `candidate_tighten_or_exclude` |
| `blocker_namespace` | `AVG_DOWN` | 7268 | 7245 | -0.8621 | -0.9692 | 0.0 | `candidate_tighten_or_exclude` |
| `blocker_namespace` | `AVG_DOWN_ONLY` | 3026 | 3026 | -0.3462 | -0.417 | 0.0 | `candidate_tighten_or_exclude` |
| `blocker_namespace` | `PYRAMID` | 2348 | 2337 | 0.6392 | 0.5697 | 0.9773 | `candidate_recovery_or_relax` |
...
| `blocker_reason` | `ok` | 160 | 160 | -1.7665 | -2.2049 | 0.0 | `candidate_tighten_or_exclude` |
