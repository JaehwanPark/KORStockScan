...
- as_of: `2026-09-11T15:28:02`
- latest_event_at: `2026-09-11T15:28:22`
- reasons: `portfolio stop-loss cluster observed; panic thresholds breached with market/microstructure confirmation; live market panic breadth risk_off advisory; recovery watch triggered by active sim/probe or post-sell rebound above sell`

## 입력 자원 계약

- memory_bounded_streaming: `true`
- scanned_row_count: `186790`
- retained_exit_event_count: `3708`
- full_event_list_materialized: `false`
- out_of_order_event_count: `0`
- unique_market_observation_count: `59366`
- duplicate_snapshot_skipped_count: `49619`

## 패닉 지표

- panic_decision_basis: `broker_confirmed_exit_identity_deduplicated`
- real_exit_provenance_required: `true`
- raw_exit_signal_count: `20`
- real_exit_count: `10`
...
- rolling_30m_stop_loss_count_sample: `4`
- rolling_30m_stop_loss_count_sample_ready: `true`
- panic_threshold_mode: `dynamic_quantile`
- panic_source_quality_blockers: `-`
- stop_loss_exit_ratio_pct: `40`
- avg_exit_profit_rate_pct: `-0.925`
- confirmation_eligible_exit_count: `10`
...
- active_avg_unrealized_profit_rate_pct: `-0.3155`
...
- market_panic_breadth_as_of: `2026-09-11T15:28:01+09:00`
...
- observation_id: `market-weakness-d74433f51dc6e2b7a721`
