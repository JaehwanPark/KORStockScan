# Cumulative Threshold Cycle Report - 2026-09-07

## 판정

- 상태: `report_only_review`
- runtime_change: `False`
- 기준 구간: `2026-06-05` ~ `2026-09-07`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| cumulative | 95 | 92908 | 514 | -0.1461 | 0.5447 | 0.4222 |
| rolling_5d | 5 | 1015 | 11 | 0.0036 | 0.7273 | 0.2727 |
| rolling_10d | 10 | 2429 | 29 | 0.1136 | 0.7586 | 0.2414 |
| rolling_20d | 20 | 11391 | 83 | -0.1133 | 0.6867 | 0.2892 |
...
| cumulative | sim | 3552 | -1.2954 | 0.2452 |
| cumulative | combined | 4066 | -1.1501 | 0.2831 |
| rolling_5d | real | 11 | 0.0036 | 0.7273 |
| rolling_5d | sim | 48 | -1.2929 | 0.2917 |
| rolling_5d | combined | 59 | -1.0512 | 0.3729 |
| rolling_10d | real | 29 | 0.1136 | 0.7586 |
| rolling_10d | sim | 116 | -1.0403 | 0.3707 |
| rolling_10d | combined | 145 | -0.8095 | 0.4483 |
| rolling_20d | real | 83 | -0.1133 | 0.6867 |
| rolling_20d | sim | 236 | -0.9655 | 0.3814 |
| rolling_20d | combined | 319 | -0.7438 | 0.4608 |
...
| rolling_5d | all_completed_valid | 11 | 0.0036 | -2.55 | 1.29 | 0.7273 | 0.2727 |
| rolling_5d | normal_only | 11 | 0.0036 | -2.55 | 1.29 | 0.7273 | 0.2727 |
| rolling_5d | initial_only | 9 | -0.1533 | -3.04 | 2.12 | 0.6667 | 0.3333 |
| rolling_5d | pyramid_activated | 1 | 0.19 | 0.19 | 0.19 | 1 | 0 |
| rolling_5d | reversal_add_activated | 1 | 1.23 | 1.23 | 1.23 | 1 | 0 |
| rolling_10d | all_completed_valid | 29 | 0.1136 | -3.04 | 1.29 | 0.7586 | 0.2414 |
| rolling_10d | normal_only | 29 | 0.1136 | -3.04 | 1.29 | 0.7586 | 0.2414 |
| rolling_10d | initial_only | 27 | 0.0694 | -3.04 | 1.29 | 0.7407 | 0.2593 |
...
| cumulative | soft_stop_micro_grace | holding_exit | 18504 | True | report_only_reference |
| cumulative | soft_stop_whipsaw_confirmation | holding_exit | 18504 | False | report_only_reference |
| cumulative | scalp_trailing_take_profit | holding_exit | 4731 | True | report_only_reference |
...
| rolling_5d | soft_stop_micro_grace | holding_exit | 382 | True | report_only_reference |
| rolling_5d | soft_stop_whipsaw_confirmation | holding_exit | 382 | False | report_only_reference |
...
| rolling_10d | soft_stop_micro_grace | holding_exit | 871 | True | report_only_reference |
| rolling_10d | soft_stop_whipsaw_confirmation | holding_exit | 871 | False | report_only_reference |
| rolling_10d | scalp_trailing_take_profit | holding_exit | 72 | True | report_only_reference |
...
| rolling_20d | soft_stop_micro_grace | holding_exit | 3187 | True | report_only_reference |
| rolling_20d | soft_stop_whipsaw_confirmation | holding_exit | 3187 | False | report_only_reference |
| rolling_20d | scalp_trailing_take_profit | holding_exit | 2075 | True | report_only_reference |
