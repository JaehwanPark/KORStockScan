...
| --- | ---: | ---: | ---: |
| `total_trades` | `4` | `2` | `-2.0` |
| `completed_trades` | `4` | `2` | `-2.0` |
| `open_trades` | `0` | `0` | `0.0` |
| `holding_events` | `0` | `0` | `0.0` |
| `all_rows` | `103` | `69` | `-34.0` |
| `entered_rows` | `4` | `2` | `-2.0` |
| `expired_rows` | `89` | `61` | `-28.0` |

## Performance Tuning
- status: `ok`
- remote_url: `https://songstockscan.ddns.net/api/performance-tuning?date=2026-04-09&since=09:00:00`
...
- remote_watch_items:
  - `label=보유 AI skip 비율, value=0.0%, target=20% ~ 60%`
  - `label=보유 AI skip WS age p95, value=0.00s, target=<= 1.50s`
  - `label=Gatekeeper 평가 p95, value=0ms, target=< 1200ms`
  - `label=Gatekeeper fast reuse 비율, value=0.0%, target=15% ~ 55%`
  - `label=Gatekeeper fast reuse WS age p95, value=0.00s, target=<= 2.00s`

## Post Sell Feedback
- status: `ok`
- remote_url: `https://songstockscan.ddns.net/api/post-sell-feedback?date=2026-04-09`
...
| metric | local | remote | delta(remote-local) |
| --- | ---: | ---: | ---: |
| `total_candidates` | `4` | `2` | `-2.0` |
| `evaluated_candidates` | `4` | `2` | `-2.0` |

## Entry Pipeline Flow
- status: `ok`
- remote_url: `https://songstockscan.ddns.net/api/entry-pipeline-flow?date=2026-04-09&since=09:00:00&top=10`
