...
while true; do
    ...
    export KORSTOCKSCAN_SCALPING_NORMAL_DEFENSIVE_BPS=50
    export KORSTOCKSCAN_SCALPING_CONDITIONAL_STRONG_DEFENSIVE_BPS=10
    export KORSTOCKSCAN_SCALPING_NORMAL_FAVORABLE_DEFENSIVE_BPS=35
    export KORSTOCKSCAN_SCALPING_NORMAL_WEAK_DEFENSIVE_BPS=65
