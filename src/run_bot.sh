...
while true; do
    ...
    export KORSTOCKSCAN_BEDROCK_NOVA_MICRO_SHADOW_ENABLED=true
    export KORSTOCKSCAN_BEDROCK_NOVA_MICRO_ROUTE_MODE=shadow
    export KORSTOCKSCAN_BEDROCK_NOVA_MICRO_MODEL_ID=apac.amazon.nova-micro-v1:0
    export KORSTOCKSCAN_BEDROCK_NOVA_MICRO_REGION=ap-northeast-2
    export KORSTOCKSCAN_BEDROCK_NOVA_MICRO_WORKERS=1
    export KORSTOCKSCAN_BEDROCK_NOVA_MICRO_QUEUE_MAX=200
    export KORSTOCKSCAN_BEDROCK_NOVA_MICRO_TIMEOUT_MS=5000
    export KORSTOCKSCAN_BEDROCK_NOVA_MICRO_SAMPLE_RATE=1.0
    export KORSTOCKSCAN_BEDROCK_NOVA_MICRO_PROMPT_CACHE_ENABLED=true
    export KORSTOCKSCAN_BEDROCK_NOVA_LITE_SHADOW_ENABLED=true
    export KORSTOCKSCAN_BEDROCK_NOVA_LITE_ROUTE_MODE=primary
    export KORSTOCKSCAN_BEDROCK_NOVA_LITE_PRIMARY_ENDPOINTS=entry_price,holding_flow
    ...
    export KORSTOCKSCAN_BEDROCK_NOVA_LITE_V2_SHADOW_ENABLED=true
    export KORSTOCKSCAN_BEDROCK_NOVA_LITE_V2_MODEL_ID=amazon.nova-2-lite-v1:0
