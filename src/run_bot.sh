...
disable_expired_dated_runtime_overrides() {
    ...
    local dated_override_specs=(
        ...
        "KORSTOCKSCAN_LIMIT_DOWN_SIM_POLICY_ENABLED:KORSTOCKSCAN_LIMIT_DOWN_SIM_POLICY_ACTIVE_DATE:"
        "KORSTOCKSCAN_LIMIT_DOWN_LIVE_POLICY_ENABLED:KORSTOCKSCAN_LIMIT_DOWN_LIVE_POLICY_ACTIVE_DATE:"
    )
...
reset_runtime_policy_env_before_handoff() {
    ...
    unset KORSTOCKSCAN_LIMIT_DOWN_SIM_POLICY_ENABLED
    unset KORSTOCKSCAN_LIMIT_DOWN_SIM_POLICY_ACTIVE_DATE
    unset KORSTOCKSCAN_LIMIT_DOWN_SIM_POLICY_FILE
    unset KORSTOCKSCAN_LIMIT_DOWN_SIM_POLICY_VERSION
    unset KORSTOCKSCAN_LIMIT_DOWN_SIM_POLICY_SOURCE_DATE
    unset KORSTOCKSCAN_LIMIT_DOWN_SIM_POLICY_SHA256
    unset KORSTOCKSCAN_LIMIT_DOWN_LIVE_POLICY_ENABLED
    unset KORSTOCKSCAN_LIMIT_DOWN_LIVE_POLICY_ACTIVE_DATE
    unset KORSTOCKSCAN_LIMIT_DOWN_LIVE_POLICY_FILE
    unset KORSTOCKSCAN_LIMIT_DOWN_LIVE_POLICY_VERSION
    unset KORSTOCKSCAN_LIMIT_DOWN_LIVE_POLICY_SOURCE_DATE
    unset KORSTOCKSCAN_LIMIT_DOWN_LIVE_POLICY_SHA256
}
