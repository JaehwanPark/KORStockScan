...
DATED_RUNTIME_AUTO_RENEW_SPECS=(
    ...
    "KORSTOCKSCAN_RISING_MISSED_TP1_SOURCE_GAP_RELIEF_ENABLED:KORSTOCKSCAN_RISING_MISSED_TP1_SELECTOR_ACTIVE_DATE"
    ...
    "KORSTOCKSCAN_LATENCY_TRUE_OFI_DIRECT_CANARY_RECHECK_ENABLED:KORSTOCKSCAN_LATENCY_TRUE_OFI_DIRECT_CANARY_RECHECK_ACTIVE_DATE"
...
record_enabled_dated_runtime_provenance() {
    ...
    export KORSTOCKSCAN_DATED_RUNTIME_AUTO_RENEW_POLICY_VERSION="dated_runtime_auto_renew_v1"
...
reset_runtime_policy_env_before_handoff() {
    ...
    unset KORSTOCKSCAN_EARLY_VOLATILITY_TP_ENABLED
    unset KORSTOCKSCAN_EARLY_VOLATILITY_TP_ACTIVE_DATE
    unset KORSTOCKSCAN_EARLY_VOLATILITY_TP_POLICY_FILE
    unset KORSTOCKSCAN_EARLY_VOLATILITY_TP_PREMARKET_ENABLED
    unset KORSTOCKSCAN_EARLY_VOLATILITY_TP_PREMARKET_ACTIVE_DATE
    unset KORSTOCKSCAN_EARLY_VOLATILITY_TP_PREMARKET_POLICY_FILE
    unset KORSTOCKSCAN_EARLY_VOLATILITY_TP_NXT_ENABLED
    unset KORSTOCKSCAN_EARLY_VOLATILITY_TP_NXT_ACTIVE_DATE
    unset KORSTOCKSCAN_EARLY_VOLATILITY_TP_NXT_POLICY_FILE
