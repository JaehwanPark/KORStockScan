"""Same-day authority gate for the Samsung midday one-share live service."""
...
AUTHORITY_SCHEMA = "samsung_midday_one_share_authority_v1"
...
def build_authority_artifact(
    ...
    return {
        ...
        "decision_authority": "explicit_user_directed_midday_one_share_live_start",
