"""Fixed, auditable policy for the Samsung afternoon one-share machine."""
...
class AfternoonOneSharePolicy:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            ...
            raise ValueError("invalid_afternoon_policy")

    def evaluate(self, bars: list[MinuteBar]) -> AfternoonSignal | None:
...
DEFAULT_POLICY = AfternoonOneSharePolicy()
