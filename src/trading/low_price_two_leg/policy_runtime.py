...
from src.trading.low_price_two_leg.profiles import (
    ...
    PROFILE_REVISION_20260910_EFFECTIVE_DATE,
    PROFILES_20260910_PRIOR,
    PROFILE_REVISION_20260911_EFFECTIVE_DATE,
    PROFILES_20260911_PRIOR,
)
...
PROFILE_REVISION_20260908_TRANSITION = {
    "effective_target_date": "2026-09-08",
    "source_date": "2026-09-07",
    "before_profile_count": 53,
    "after_profile_count": 56,
    "recommendation_count": 11,
    "source_recommendation_count": 13,
    "new_profile_count": 3,
    "logic_revision_count": 8,
    "approved_profile_ids": [
        "cj_cgv_late_morning",
    ...
    "evidence_canonical_sha256": "557d58771956bca4e0649feda1482e8faf0c6730efdc5e88549e3399bd2e8bc5",
    "source_report": "data/report/low_price_two_leg_expanded_candidate_research/low_price_two_leg_expanded_candidate_research_2026-09-07.json",
    "source_report_sha256": "6cb5b2293dbf01bdb9ed4c8c3bc1816ad7d1f5a5834972f92c5c7db27b4c3178",
...
PROFILE_REVISION_20260910_TRANSITION = {
    "effective_target_date": "2026-09-10",
    "source_date": "2026-09-09",
    "before_profile_count": 56,
    "after_profile_count": 59,
    "recommendation_count": 5,
    "source_recommendation_count": 7,
    "new_profile_count": 3,
    "logic_revision_count": 2,
    "approved_profile_ids": [
        "sk_telecom_morning",
    ...
    "evidence_canonical_sha256": "9fd7c9b681f8e3dca3ab47dd2e01c5e5bc31dbee740bd35873a02e98414b5389",
    "source_report": "data/report/low_price_two_leg_expanded_candidate_research/low_price_two_leg_expanded_candidate_research_2026-09-09.json",
    "source_report_sha256": "362b22217dd46da839ab9eb0795ee37e3e5aa438a1091532ea65ef4a906c16a5",
    "decision_authority": "explicit_user_20260909_2250_implementation_and_next_day_execution",
    "existing_order_effect": "none_preserve_prior_policy_custody",
}
PROFILE_REVISION_20260911_TRANSITION = {
    "effective_target_date": "2026-09-11",
    "source_date": "2026-09-10",
    "before_profile_count": 59,
    "after_profile_count": 61,
    "recommendation_count": 3,
    "source_recommendation_count": 5,
    "new_profile_count": 2,
    "logic_revision_count": 1,
    "approved_profile_ids": [
        "lotte_chemical_afternoon",
        "lotte_chemical_midday",
        "lx_semicon_morning",
    ],
    "runtime_active_profile_count": 58,
    "evidence_path": "docs/audit-reports/2026-09-10-low-price-recommendation-apply-evidence.json",
    "evidence_canonical_sha256": "4c46d6b7f4a72d38510230aac8c11cb900797412aa9506412e3ff428a09aff5b",
    "source_report": "data/report/low_price_two_leg_expanded_candidate_research/low_price_two_leg_expanded_candidate_research_2026-09-10.json",
...
PROFILE_20260908_BASELINE_POLICIES = {
    profile_id: _baseline_policy(profile_id, PROFILES_20260908_PRIOR)
    for profile_id in PROFILES_20260908_PRIOR
}
...
PROFILE_20260910_BASELINE_POLICIES = {
    profile_id: _baseline_policy(profile_id, PROFILES_20260910_PRIOR)
    for profile_id in PROFILES_20260910_PRIOR
}


PROFILE_20260911_BASELINE_POLICIES = {
    profile_id: _baseline_policy(profile_id, PROFILES_20260911_PRIOR)
    for profile_id in PROFILES_20260911_PRIOR
}
...
PROFILE_20260911_POLICY_BOUNDS = _policy_bounds(PROFILE_20260911_BASELINE_POLICIES)
PROFILE_20260910_POLICY_BOUNDS = _policy_bounds(PROFILE_20260910_BASELINE_POLICIES)
...
def baseline_policies_for_target_date(
    ...
    if target_date < PROFILE_REVISION_20260910_EFFECTIVE_DATE:
        return PROFILE_20260910_BASELINE_POLICIES
    if target_date < PROFILE_REVISION_20260911_EFFECTIVE_DATE:
        return PROFILE_20260911_BASELINE_POLICIES
...
def policy_bounds_for_target_date(target_date: date) -> dict[str, dict[str, float]]:
    ...
    if target_date < PROFILE_REVISION_20260910_EFFECTIVE_DATE:
        return PROFILE_20260910_POLICY_BOUNDS
    if target_date < PROFILE_REVISION_20260911_EFFECTIVE_DATE:
        return PROFILE_20260911_POLICY_BOUNDS
...
def profile_revision_transition(target_date: date) -> dict[str, Any] | None:
    ...
    if target_date < PROFILE_REVISION_20260911_EFFECTIVE_DATE:
        return dict(PROFILE_REVISION_20260910_TRANSITION)
    return dict(PROFILE_REVISION_20260911_TRANSITION)
    ...
    *,
    ...
    if source_baselines != target_baselines:
        if (
            ...
            <= source_date
            < PROFILE_REVISION_20260911_EFFECTIVE_DATE
            and effective_target_date >= PROFILE_REVISION_20260909_EFFECTIVE_DATE
        ):
            # Carry unrelated actual policy through every crossed revision,
            # including a prior candidate spanning more than one approved day.
            ...
            approved_ids = {
                ...
                if source_date
                < date.fromisoformat(transition["effective_target_date"])
                <= effective_target_date
                for profile_id in transition["approved_profile_ids"]
            }
            return {
                profile_id: dict(
                    baseline
