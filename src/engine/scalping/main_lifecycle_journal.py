...
PIPELINE_STAGE_MAP: dict[tuple[str, str], str] = {
    ...
    ("ENTRY_PIPELINE", "score_recovery_real_economics_observed"): "entry_decision",
    ...
    ("HOLDING_PIPELINE", "avg_down_shared_rebound_blocked"): "scale_in",
    ("HOLDING_PIPELINE", "avg_down_shared_rebound_signal"): "scale_in",
    ("HOLDING_PIPELINE", "avg_down_route_arbitration_observed"): "scale_in",
    ("HOLDING_PIPELINE", "pyramid_lifecycle_replay_observed"): "scale_in",
