...
from src.engine.automation.submit_drought_contract import finite_number
...
SUPPORTED_WAIT_MAX_SCORE = 74.999
...
def _policy_result(
    *,
    ...
    if economic_filter_passed:
        apply_block_reason = "legacy_entry_gate_diagnostic_only"
    return {
        "policy": policy,
        "threshold": threshold,
