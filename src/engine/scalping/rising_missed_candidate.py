"""Shared rising-candidate validation and historical execution attribution.

The retired scout entry and upgrade producers have no executable API here.
Normal BUY bridge and immutable receipt attribution retain their contracts.
"""
...
class RisingMissedCandidateDecision:
    allowed: bool
    reason: str
    forced_qty: int = 0
...
def _candidate_quantity_placeholder(
    *,
...
def _evaluate_rising_missed_candidate(
    ...
    *,
    ...
    forced_qty, sizing_fields = _candidate_quantity_placeholder(
    ...
    if not feature_enabled:
        return RisingMissedCandidateDecision(
            allowed=False,
    ...
    return RisingMissedCandidateDecision(
        allowed=True,
        reason="rising_missed_candidate_ready",
...
def evaluate_rising_missed_normal_buy_bridge(
    ...
    *,
    ...
    decision = _evaluate_rising_missed_candidate(
        stock,
        strategy=strategy,
        position_tag=position_tag,
