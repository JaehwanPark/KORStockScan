...
def build_report(
    ...
    *,
    ...
    return {**retired_status("scalping_pyramid_intraday_feedback"), "target_date": str(target_date), "calibration_candidates": []}
...
def main(argv: list[str] | None = None) -> int:
    import json
    from src.engine.lifecycle.retirement import retired_status
    print(json.dumps(retired_status("scalping_pyramid_intraday_feedback"), sort_keys=True))
    return 0
