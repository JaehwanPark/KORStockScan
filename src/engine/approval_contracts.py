...
_CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "entry_wait6579_score66_69_recovery_gate_v1": {
        "approval_contract_status": "archived",
        "approval_mode": "legacy_counterfactual_live_exception_removed",
        "approval_artifact_required": False,
        ...
        "runtime_scope": "archived_counterfactual_source_sim_handoff_only",
        "missing_components": ["archived_family_not_selectable_for_live_apply"],
    },
