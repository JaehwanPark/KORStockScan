...
_CONTRACTS: dict[str, dict[str, Any]] = {
    "swing_model_floor": {
        ...
        "approval_contract_status": "direct_family_publisher_missing",
    ...
    "scale_in_bucket_runtime_policy_v1": {
        ...
        "approval_artifact_consumer": None,
        "approval_contract_status": "retired_common_consumer",
        "preopen_env_ready": False,
        "runtime_guard_ready": True,
    ...
    "position_sizing_dynamic_formula": {
        "approval_contract_status": "dated_preopen_policy_guarded",
        "approval_mode": "retain_current_formula_with_flat10_fail_closed_fallback",
        "approval_artifact_required": True,
        "approval_artifact_template": "position_sizing_dynamic_formula_{date}.json",
        "approval_artifact_consumer": "position_sizing_allocator.dated_policy_loader",
        "preopen_env_ready": True,
        "runtime_guard_ready": True,
        "runtime_scope": "next_preopen_dated_policy_existing_formula_only",
        "missing_components": [],
    },
