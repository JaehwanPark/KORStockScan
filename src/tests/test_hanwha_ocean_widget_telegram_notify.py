...
def _event_payload(now: datetime) -> dict:
    ...
    return {
        ...
        "entry_event": {
            **common,
            "event_id": "042660:2026-08-05:ENTRY:100005",
            "event_type": "ENTRY",
            "status": "ACTIVE",
            "state": "ENTRY_READY",
            "signal_tier": "HIGH",
...
def test_admin_notifier_sends_entry_and_exit_once(tmp_path):
    ...
    payload["exit_event"] = {
        **payload["entry_event"],
        "event_id": "042660:2026-08-05:EXIT:101005",
        "event_type": "EXIT",
...
def test_admin_notifier_sends_each_distinct_same_day_entry_episode(tmp_path):
    ...
    payload["entry_event"] = {
        **payload["entry_event"],
        "event_id": "042660:2026-08-05:ENTRY:02:100505",
        "episode_sequence": 2,
...
def test_notifier_rejects_runtime_authority_and_retries_failure(tmp_path):
    ...
    retrying = HanwhaOceanWidgetTelegramNotifier(
...
def test_valid_exit_event_suppresses_unsent_entry_event(tmp_path):
    ...
    payload["exit_event"] = {
        **payload["entry_event"],
        "event_id": "042660:2026-08-05:EXIT:100005",
        "event_type": "EXIT",
        "reason": "hanwha_ocean_target_1pct_reached",
        "reference_exit_price": 68_900,
    }
