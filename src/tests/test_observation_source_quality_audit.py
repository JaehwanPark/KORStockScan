...
def test_observation_source_quality_reviews_explicit_stale_entry_and_candle_route_gaps(
    monkeypatch,
    tmp_path,
):
    monkeypatch.setattr(audit, "DATA_DIR", tmp_path)
    stale_entry = {
        "entry_order_flow_status": "unknown",
        "entry_context_quality": "stale",
        "entry_context_missing_features": "quote_freshness,order_flow_pressure",
        "actual_order_submitted": False,
        "broker_order_forbidden": True,
    }
    _write_events(
        ...
        [
            ...
            _event(
                "ai_holding_review",
                {
                    ...
                    "holding_context_source_quality_status": "blocked",
                    "holding_context_blockers": "['ai_preflight:candle_source_quality']",
                    "ai_result_source": "input_preflight_blocked",
                    "actual_order_submitted": False,
                    "broker_order_forbidden": True,
                },
    ...
    report = audit.build_observation_source_quality_audit("2026-08-14")
    ...
    for stage in (
        ...
        assert reviewed[stage]["entry_order_flow_status"] == (
            "reviewed_entry_order_flow_not_available"
        )
