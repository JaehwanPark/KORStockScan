...
@pytest.mark.parametrize("mode", ["micro_reversion_source_bundle", "micro_reversion_materialize", "micro_reversion_execute"])
def test_retired_r0_r3_modes_are_rejected_before_io(mode, tmp_path, monkeypatch):
