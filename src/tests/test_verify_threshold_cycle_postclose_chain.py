...
def test_swing_priority_handoff_does_not_require_retired_scalp_catalog(monkeypatch):
    monkeypatch.setattr(mod, "_iter_pipeline_event_fields", lambda _date: iter(()))
...
def test_swing_priority_handoff_preserves_selected_runtime_contract(monkeypatch):
    monkeypatch.setattr(
        mod,
        "_iter_pipeline_event_fields",
        lambda _date: iter(({"priority_policy_id": "swing-policy-1"},)),
    )
    policy = {
        "priority_policy_id": "swing-policy-1",
        "status": "active",
    ...
    status = mod._active_sim_priority_handoff_status(
        ...
        swing_catalog={
            ...
            "active_arm_priority_policies": [policy],
        },
        preopen_apply={
            ...
            "selected": [
                {
                    ...
                    "selected": True,
                    "active_arm_priority_policy_ids": ["swing-policy-1"],
                }
            ],
        },
        swing_sim_report={},
