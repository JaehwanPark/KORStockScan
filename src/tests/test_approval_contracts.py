...
def test_approval_contract_registry_marks_runtime_apply_bridge_contract_states():
    ...
    assert entry["approval_artifact_consumer"] == "threshold_cycle_preopen_apply.runtime_apply_bridge_metadata"
    assert entry["runtime_scope"] == "entry_dimension_provenance_only"
    assert entry["missing_components"] == ["not_complete_lifecycle_bucket", "not_live_apply_candidate"]
...
def test_annotate_approval_request_keeps_entry_bridge_metadata_not_live_ready():
    ...
    assert request["approval_artifact_consumer"] == "threshold_cycle_preopen_apply.runtime_apply_bridge_metadata"
