...
def test_build_report_creates_bounded_equal_baseline_without_real_outcome(monkeypatch, tmp_path):
    ...
    assert [item["price"] for item in orders] == [1000, 999]
    assert fields["entry_split_order_variant_id"] == "equal_50_50_offset_0_1tick"
        ...
        [
            {
                ...
                "entry_split_order_variant_id": "equal_50_50_offset_0_1tick",
...
def test_post_sell_candidate_preserves_entry_split_variant_metadata(monkeypatch, tmp_path):
    ...
    assert payload["entry_split_order_variant_id"] == "equal_50_50_offset_0_1tick"
...
def test_allocator_uses_runtime_default_for_missing_bucket_policy(monkeypatch, tmp_path):
    ...
    assert fields["entry_split_order_policy_mode"] == "runtime_default_equal_50_50_1tick"
    assert fields["entry_split_order_variant_id"] == "runtime_default_equal_50_50_offset_0_1tick"
