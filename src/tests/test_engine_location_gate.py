...
LEGACY_ENGINE_ROOT_PY_FILES = {
    ...
    "bedrock_nova_lite_shadow.py",
    "bedrock_nova_lite_v2_shadow.py",
    "bedrock_nova_provider.py",
    "bedrock_nova_shadow_runtime.py",
...
ALLOWED_ENGINE_ROOT_PY_FILES = (
    LEGACY_ENGINE_ROOT_PY_FILES
    | set(ENGINE_ROOT_EXCEPTIONS_WITH_OWNERSHIP_REASONS)
)
