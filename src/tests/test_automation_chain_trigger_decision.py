...
def test_deep_audit_specs_include_watching_score_smoothing_diagnostic():
    ...
    assert (
        "data/report/ai_watching_score_smoothing_diagnostic/ai_watching_score_smoothing_diagnostic_2026-06-02.json"
        in spec.output_paths
    )
    assert "data/pipeline_events" in spec.source_paths
    assert (
    ...
    assert (
        "data/report/threshold_cycle_postclose_verification/threshold_cycle_postclose_verification_2026-06-02.json"
        not in spec.source_paths
    )
