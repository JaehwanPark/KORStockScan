...
_COMPACT_FIELD_PRIORITY = (
    ...
    "microstructure_reaction_parent_context_id",
    "microstructure_reaction_evaluation_id",
    ...
    "microstructure_reaction_provider_delivery_status",
    "microstructure_reaction_context_reused",
    "microstructure_reaction_quote_threshold_setting_status",
...
def _project_fields_for_text(stage: str, fields: dict[str, str]) -> dict[str, str]:
    ...
    if stage in {
        ...
        selected["text_field_projection"] = (
            "strategy_owner_replay_identity_only_v1"
            if stage == "strategy_owner_replay_seed_observed"
            else "avg_down_replay_identity_only_v1"
        )
